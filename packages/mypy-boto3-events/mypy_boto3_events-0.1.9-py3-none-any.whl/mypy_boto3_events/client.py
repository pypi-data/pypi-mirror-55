...
class Client(BaseClient):
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **EventPattern** *(string) --*
              ...
              The event pattern. For more information, see `Event Patterns <https://docs.aws.amazon.com/eventbridge/latest/userguide/eventbridge-and-event-patterns.html>`__ in the *Amazon EventBridge User Guide* .
            ...
            - **Rules** *(list) --*
              ...
              - *(dict) --*
                ...
                - **EventPattern** *(string) --*
                  ...
                  The event pattern of the rule. For more information, see `Event Patterns <https://docs.aws.amazon.com/eventbridge/latest/userguide/eventbridge-and-event-patterns.html>`__ in the *Amazon EventBridge User Guide* .
    ...
    def put_targets(
        ...
        * The default event bus of another AWS account
        ...
        If another AWS account is in the same Region and has granted you permission (using ``PutPermission`` ), you can send events to that account. Set that account's event bus as a target of the rules in your account. To send the matched events to the other account, specify that account's event bus as the ``Arn`` value when you run ``PutTargets`` . If your account sends events to another account, your account is charged for each sent event. Each event sent to another account is charged as a custom event. The account receiving the event isn't charged. For more information, see `Amazon EventBridge Pricing <https://aws.amazon.com/eventbridge/pricing/>`__ .
