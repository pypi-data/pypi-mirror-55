...
class Client(BaseClient):
    ...
    def get_lexicon(self, Name: str) -> Dict[str, Any]:
        """
        Returns the content of the specified pronunciation lexicon stored in an AWS Region. For more information, see `Managing Lexicons <https://docs.aws.amazon.com/polly/latest/dg/managing-lexicons.html>`__ .
    ...
    def list_lexicons(self, NextToken: str = None) -> Dict[str, Any]:
        """
        Returns a list of pronunciation lexicons stored in an AWS Region. For more information, see `Managing Lexicons <https://docs.aws.amazon.com/polly/latest/dg/managing-lexicons.html>`__ .
    ...
    def synthesize_speech(
        ...
        **Request Syntax**
        ...
        :param TextType:
          ...
          Specifies whether the input text is plain text or SSML. The default value is plain text. For more information, see `Using SSML <https://docs.aws.amazon.com/polly/latest/dg/ssml.html>`__ .

        :type VoiceId: string
        :param VoiceId: **[REQUIRED]**

          Voice ID to use for the synthesis. You can get a list of available voice IDs by calling the `DescribeVoices <https://docs.aws.amazon.com/polly/latest/dg/API_DescribeVoices.html>`__ operation.
