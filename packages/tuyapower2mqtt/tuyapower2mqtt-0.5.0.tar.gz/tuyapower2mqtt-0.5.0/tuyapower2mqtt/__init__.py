...
import logging
logging.basicConfig(filename='srv/homeassistant/bin/activate python /srv/homeassistant/lib/python3.7/site-packages/tuyapower2mqtt/tuyapower2mqtt.log', filemode='w', level=logging.DEBUG)
