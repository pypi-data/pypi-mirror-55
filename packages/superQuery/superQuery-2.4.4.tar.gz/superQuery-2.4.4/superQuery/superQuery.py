...
class Client(object):
    ...
    def __init__(self, usernameDriveAuth=None):
        ...
        self._username = os.getenv("SUPERQUERY_USERNAME") if os.getenv("SUPERQUERY_USERNAME") else usernameDriveAuth
        self._password = os.getenv("SUPERQUERY_PASSWORD") if os.getenv("SUPERQUERY_PASSWORD") else None
