...
class Client(object):
    ...
    def __init__(self, usernameDriveAuth=None):
        ...
        self._username = os.getenv("SUPERQUERY_USERNAME") if os.getenv("SUPERQUERY_USERNAME") is not None else usernameDriveAuth
        self._password = os.getenv("SUPERQUERY_PASSWORD") if os.getenv("SUPERQUERY_PASSWORD") is not None else None
