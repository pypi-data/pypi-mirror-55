...
class Client(BaseClient):
    ...
    def delete_typed_link_facet(
        ...
        """
        Deletes a  TypedLinkFacet . For more information, see `Typed Links <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__ .
    ...
    def get_typed_link_facet_information(
        ...
        """
        Returns the identity attribute order for a specific  TypedLinkFacet . For more information, see `Typed Links <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__ .
    ...
    def list_typed_link_facet_names(
        ...
        """
        Returns a paginated list of ``TypedLink`` facet names for a particular schema. For more information, see `Typed Links <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__ .
    ...
    def update_typed_link_facet(
        ...
        """
        Updates a  TypedLinkFacet . For more information, see `Typed Links <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__ .
