...
pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, bool>
...
all_of(_ExecutionPolicy&& __exec, _ForwardIterator __first, _ForwardIterator __last, _Pred __pred)
{
    return !std::any_of(std::forward<_ExecutionPolicy>(__exec), __first, __last,
                        pstl::__internal::__not_pred<_Pred>(__pred));
}
...
find_if_not(_ExecutionPolicy&& __exec, _ForwardIterator __first, _ForwardIterator __last, _Predicate __pred)
{
    return std::find_if(std::forward<_ExecutionPolicy>(__exec), __first, __last,
                        pstl::__internal::__not_pred<_Predicate>(__pred));
}
...
{
    return std::find_if(std::forward<_ExecutionPolicy>(__exec), __first, __last,
                        pstl::__internal::__equal_value<_Tp>(__value));
}

// [alg.find.end]
template <class _ExecutionPolicy, class _ForwardIterator1, class _ForwardIterator2, class _BinaryPredicate>
pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, _ForwardIterator1>
        ...
        const _Tp& __new_value)
{
    std::replace_if(std::forward<_ExecutionPolicy>(__exec), __first, __last,
                    pstl::__internal::__equal_value<_Tp>(__old_value), __new_value);
}
...
{
    return std::copy_if(std::forward<_ExecutionPolicy>(__exec), __first, __last, __result,
                        pstl::__internal::__not_equal_value<_Tp>(__value));
}
...
{
    return std::unique(std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__pstl_equal());
}
...
pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, _BidirectionalIterator>
...
pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, std::pair<_ForwardIterator1, _ForwardIterator2>>
...
{
    std::sort(std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__pstl_less());
}
...
{
    std::stable_sort(std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__pstl_less());
}
...
{
    std::partial_sort(std::forward<_ExecutionPolicy>(__exec), __first, __middle, __last, pstl::__internal::__pstl_less());
}

// [partial.sort.copy]

template <class _ExecutionPolicy, class _ForwardIterator, class _RandomAccessIterator, class _Compare>
pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, _RandomAccessIterator>
...
is_sorted_until(_ExecutionPolicy&& __exec, _ForwardIterator __first, _ForwardIterator __last, _Compare __comp)
{
    ...
    const _ForwardIterator __res = __internal::__pattern_adjacent_find(
        std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__reorder_pred<_Compare>(__comp),
        __internal::__is_parallelization_preferred<_ExecutionPolicy, _ForwardIterator>(__exec),
        __internal::__is_vectorization_preferred<_ExecutionPolicy, _ForwardIterator>(__exec), /*first_semantic*/ false);
...
{
    return is_sorted_until(std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__pstl_less());
}
...
{
    return std::is_sorted(std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__pstl_less());
}
...
{
    std::inplace_merge(std::forward<_ExecutionPolicy>(__exec), __first, __middle, __last, pstl::__internal::__pstl_less());
}
                         ...
                         _ForwardIterator2 __first2, _ForwardIterator2 __last2, _ForwardIterator __result)
{
    return std::set_symmetric_difference(std::forward<_ExecutionPolicy>(__exec), __first1, __last1, __first2, __last2,
                                         __result, pstl::__internal::__pstl_less());
}
...
{
    return std::is_heap_until(std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__pstl_less());
}
...
{
    return std::is_heap(std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__pstl_less());
}
...
{
    return std::min_element(std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__pstl_less());
}
...
max_element(_ExecutionPolicy&& __exec, _ForwardIterator __first, _ForwardIterator __last, _Compare __comp)
{
    return min_element(std::forward<_ExecutionPolicy>(__exec), __first, __last,
                       pstl::__internal::__reorder_pred<_Compare>(__comp));
}
...
max_element(_ExecutionPolicy&& __exec, _ForwardIterator __first, _ForwardIterator __last)
{
    ...
    return std::min_element(std::forward<_ExecutionPolicy>(__exec), __first, __last,
                            pstl::__internal::__reorder_pred<pstl::__internal::__pstl_less>(pstl::__internal::__pstl_less()));
}

template <class _ExecutionPolicy, class _ForwardIterator, class _Compare>
pstl::__internal::__enable_if_execution_policy<_ExecutionPolicy, std::pair<_ForwardIterator, _ForwardIterator>>
...
{
    return std::minmax_element(std::forward<_ExecutionPolicy>(__exec), __first, __last, pstl::__internal::__pstl_less());
}
...
nth_element(_ExecutionPolicy&& __exec, _RandomAccessIterator __first, _RandomAccessIterator __nth,
            _RandomAccessIterator __last)
{
    std::nth_element(std::forward<_ExecutionPolicy>(__exec), __first, __nth, __last, pstl::__internal::__pstl_less());
}
