...
class ServiceResource(Boto3ServiceResource):
    def Event(self, id: str) -> mypy_boto3_cloudformation_scope.Event:
        """
    ...
    def Stack(self, name: str) -> mypy_boto3_cloudformation_scope.Stack:
        """
...
class StackResource(Boto3ServiceResource):
    ...
    def load(self) -> None:
        """
        Calls :py:meth:`CloudFormation.Client.describe_stack_resource` to update the attributes of the StackResource resource. Note that the load and reload methods are the same method and can be used interchangeably.
...
class stacks(ResourceCollection):
    @classmethod
    def all(cls) -> List[mypy_boto3_cloudformation_scope.Stack]:
        """
    ...
    ) -> List[mypy_boto3_cloudformation_scope.Stack]:
        """
    ...
    @classmethod
    def limit(cls, count: int = None) -> List[mypy_boto3_cloudformation_scope.Stack]:
        """
...
class events(ResourceCollection):
    @classmethod
    def all(cls) -> List[mypy_boto3_cloudformation_scope.Event]:
        """
    ...
    ) -> List[mypy_boto3_cloudformation_scope.Event]:
        """
    ...
    @classmethod
    def limit(cls, count: int = None) -> List[mypy_boto3_cloudformation_scope.Event]:
        """
...
class resource_summaries(ResourceCollection):
    @classmethod
    def all(cls) -> List[mypy_boto3_cloudformation_scope.StackResourceSummary]:
        """
    ...
    def filter(
        cls, NextToken: str = None
    ) -> List[mypy_boto3_cloudformation_scope.StackResourceSummary]:
        """
