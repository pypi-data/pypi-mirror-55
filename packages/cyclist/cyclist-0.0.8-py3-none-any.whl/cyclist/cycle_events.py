...
def upsample(cycle1,cycle2):
        '''returns an upscaled cycle 1 linearly interpolated to cycle 2'''
        x = np.linspace(0,len(cycle1),len(cycle2))
        d = np.interp(x,list(range(0,len(cycle1))),cycle1)
        return(d)
