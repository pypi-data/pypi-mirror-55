...
class Client(BaseClient):
    ...
    def create_auto_scaling_group(
        ...
        **Request Syntax**
        ...
        :param LaunchTemplate:
          ...
          For more information, see `LaunchTemplateSpecification <https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_LaunchTemplateSpecification.html>`__ in the *Amazon EC2 Auto Scaling API Reference* .
        ...
        :param MixedInstancesPolicy:
          ...
          For more information, see `MixedInstancesPolicy <https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_MixedInstancesPolicy.html>`__ in the *Amazon EC2 Auto Scaling API Reference* and `Auto Scaling Groups with Multiple Instance Types and Purchase Options <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-purchase-options.html>`__ in the *Amazon EC2 Auto Scaling User Guide* .
        ...
        :param HealthCheckGracePeriod:
          ...
          For more information, see `Health Check Grace Period <https://docs.aws.amazon.com/autoscaling/ec2/userguide/healthcheck.html#health-check-grace-period>`__ in the *Amazon EC2 Auto Scaling User Guide* .
    ...
    def create_launch_configuration(
        ...
        **Request Syntax**
        ...
        :param UserData:
          ...
          The Base64-encoded user data to make available to the launched EC2 instances. For more information, see `Instance Metadata and User Data <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-metadata.html>`__ in the *Amazon EC2 User Guide for Linux Instances* .
          ...
          - *(dict) --*
            ...
            - **Ebs** *(dict) --*
              ...
              - **Iops** *(integer) --*
                ...
                The number of I/O operations per second (IOPS) to provision for the volume. The maximum ratio of IOPS to volume size (in GiB) is 50:1. For more information, see `Amazon EBS Volume Types <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html>`__ in the *Amazon EC2 User Guide for Linux Instances* .
              ...
              - **Encrypted** *(boolean) --*
                ...
                .. note::
                  ...
                  Enabling `encryption by default <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html#encryption-by-default>`__ results in all EBS volumes being encrypted with the AWS managed CMK or a customer managed CMK, whether or not the snapshot was encrypted.
        ...
        :param PlacementTenancy:
          ...
          For more information, see `Instance Placement Tenancy <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html#as-vpc-tenancy>`__ in the *Amazon EC2 Auto Scaling User Guide* .
            ...
            - **LaunchConfigurations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **SecurityGroups** *(list) --*
                  ...
                  For more information, see `Security Groups for Your VPC <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_SecurityGroups.html>`__ in the *Amazon Virtual Private Cloud User Guide* .
                ...
                - **UserData** *(string) --*
                  ...
                  For more information, see `Instance Metadata and User Data <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-metadata.html>`__ in the *Amazon EC2 User Guide for Linux Instances* .
                ...
                - **BlockDeviceMappings** *(list) --*
                  ...
                  For more information, see `Block Device Mapping <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/block-device-mapping-concepts.html>`__ in the *Amazon EC2 User Guide for Linux Instances* .
                ...
                - **InstanceMonitoring** *(dict) --*
                  ...
                  For more information, see `Configure Monitoring for Auto Scaling Instances <https://docs.aws.amazon.com/autoscaling/latest/userguide/as-instance-monitoring.html#enable-as-instance-metrics>`__ in the *Amazon EC2 Auto Scaling User Guide* .
                ...
                - **SpotPrice** *(string) --*
                  ...
                  For more information, see `Launching Spot Instances in Your Auto Scaling Group <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-launch-spot-instances.html>`__ in the *Amazon EC2 Auto Scaling User Guide* .
                ...
                - **EbsOptimized** *(boolean) --*
                  ...
                  For more information, see `Amazon EBS-Optimized Instances <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSOptimized.html>`__ in the *Amazon EC2 User Guide for Linux Instances* .
    ...
    def put_scaling_policy(
        ...
        For more information about using scaling policies to scale your Auto Scaling group automatically, see `Dynamic Scaling <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-scale-based-on-demand.html>`__ in the *Amazon EC2 Auto Scaling User Guide* .
        ...
        **Request Syntax**
        ...
        :param Cooldown:
          ...
          Valid only if the policy type is ``SimpleScaling`` . For more information, see `Scaling Cooldowns <https://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html>`__ in the *Amazon EC2 Auto Scaling User Guide* .
    ...
    def update_auto_scaling_group(
        ...
        **Request Syntax**
        ...
        :param DefaultCooldown:
          ...
          Cooldown periods are not supported for target tracking scaling policies, step scaling policies, or scheduled scaling. For more information, see `Scaling Cooldowns <https://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html>`__ in the *Amazon EC2 Auto Scaling User Guide* .
