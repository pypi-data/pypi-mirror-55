...
class Model(object):
    ...
    def register(workspace, model_path, model_name, tags=None, properties=None, description=None,
        ...
        :param model_framework: The framework of the registered model. Using the system-supported constants
                from the azureml.core.models.Framework allows for simplified deployment for some popular frameworks.
        :type model_framework: str
    ...
    def update(self, tags=None, description=None, sample_input_dataset=None, sample_output_dataset=None,
        ...
        :type description: str
        :param sample_input_dataset: Replace sample input dataset for the registered model
        :type sample_input_dataset: TabularDataset | FileDataset
        :param sample_output_dataset: Replace sample output dataset for the registered model
        :type sample_output_dataset: TabularDataset | FileDataset
        :param resource_configuration: Replace resource configuration to run the registered model
        :type resource_configuration: azureml.core.resource_configuration.ResourceConfiguration
        :raises: azureml.exceptions.WebserviceException
        """
    ...
    def deploy(workspace, name, models, inference_config=None, deployment_config=None, deployment_target=None,
        ...
        if deployment_config._webservice_type._webservice_type in (MIR_WEBSERVICE_TYPE, AKS_ENDPOINT_TYPE):
