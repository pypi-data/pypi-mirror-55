...
"""Contains functionality for managing the configuration of experiment runs in Azure Machine Learning service.
...
class RunConfiguration(_AbstractRunConfigElement):
    ...
    def load(path, name=None):
        ...
        :param path: A user selected root directory for run configurations. Typically this is the Git Repository
            ...
            loaded from .azureml or aml_config sub directory.
        :type path: str
