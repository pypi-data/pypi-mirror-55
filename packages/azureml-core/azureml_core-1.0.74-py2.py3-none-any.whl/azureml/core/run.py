...
"""Contains functionality for managing experiment metrics and artifacts in Azure Machine Learning service."""
...
class Run(_RunBase):
    ...
    * `How to manage runs <https://docs.microsoft.com/azure/machine-learning/service/how-to-manage-runs>`_
    ...
    def register_model(self, model_name, model_path=None, tags=None, properties=None, model_framework=None,
        ...
        :type datasets: builtin.list[tuple[str, [azureml.core.dataset.Dataset
            or azureml.data.dataset_snapshot.DatasetSnapshot]]]
        :param sample_input_dataset: Optional, Sample input dataset for the registered model
        :type sample_input_dataset: azureml.core.dataset.Dataset
        :param sample_output_dataset: Optional, Sample output dataset for the registered model
        :type sample_output_dataset: azureml.core.dataset.Dataset
