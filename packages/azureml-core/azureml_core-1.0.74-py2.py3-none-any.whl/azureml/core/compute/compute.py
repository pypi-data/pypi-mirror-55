...
# ---------------------------------------------------------
"""Contains the abstract parent and configuration classes for compute targets in Azure Machine Learning service."""
...
class ComputeTarget(ABC):
    """Abstract parent class for all compute targets managed by Azure Machine Learning service.
