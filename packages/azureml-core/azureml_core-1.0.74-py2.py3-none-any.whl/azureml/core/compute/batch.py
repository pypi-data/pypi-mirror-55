...
# ---------------------------------------------------------
"""Contains functionality for managing Batch compute targets in Azure Machine Learning service."""
...
class BatchCompute(ComputeTarget):
    """Manages a Batch compute target in Azure Machine Learning service.
