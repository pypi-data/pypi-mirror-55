...
# ---------------------------------------------------------
"""Contains functionality for managing Databricks compute targets in Azure Machine Learning service."""
...
class DatabricksCompute(ComputeTarget):
    """Manages a Databricks compute target in Azure Machine Learning service.
