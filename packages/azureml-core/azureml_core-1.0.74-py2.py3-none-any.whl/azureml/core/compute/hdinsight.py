...
# ---------------------------------------------------------
"""Contains functionality for managing HDInsight Cluster compute targets in Azure Machine Learning service."""
...
class HDInsightCompute(ComputeTarget):
    """Manages an HDInsight cluster compute target in Azure Machine Learning service.
