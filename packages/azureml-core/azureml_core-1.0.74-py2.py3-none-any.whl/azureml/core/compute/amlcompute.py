...
# ---------------------------------------------------------
"""Contains functionality for managing Azure Machine Learning compute targets in Azure Machine Learning service."""
...
class AmlCompute(ComputeTarget):
    """Manages an Azure Machine Learning compute in Azure Machine Learning service.
    ...
    def delete(self):
        ...
        .. remarks::
            ...
            If this object was created through Azure Machine Learning service,
