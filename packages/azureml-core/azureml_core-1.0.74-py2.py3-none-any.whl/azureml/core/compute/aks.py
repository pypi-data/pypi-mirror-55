...
# ---------------------------------------------------------
"""Contains functionality for managing Azure Kubernetes Service compute targets in Azure Machine Learning service."""
...
class AksCompute(ComputeTarget):
    """Manages an Azure Kubernetes Service compute target in Azure Machine Learning service.
    ...
    def provisioning_configuration(agent_count=None, vm_size=None, ssl_cname=None, ssl_cert_pem_file=None,
        ...
        :param load_balancer_type: The load balancer type of AKS cluster.
