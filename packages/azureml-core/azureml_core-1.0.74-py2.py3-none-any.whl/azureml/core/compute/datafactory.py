...
# ---------------------------------------------------------
"""Contains functionality for managing Datafactory compute targets in Azure Machine Learning service."""
...
class DataFactoryCompute(ComputeTarget):
    """Manages a DataFactory compute target in Azure Machine Learning service.
    ...
    :param name: The name of the of the DataFactoryCompute object to retrieve.
    :type name: str
    """
