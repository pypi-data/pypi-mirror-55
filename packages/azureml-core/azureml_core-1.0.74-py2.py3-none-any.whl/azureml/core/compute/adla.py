...
# ---------------------------------------------------------
"""Contains functionality for managing Azure Data Lake Analytics compute targets in Azure Machine Learning service."""
...
class AdlaCompute(ComputeTarget):
    """Manages an Azure Data Lake Analytics compute target in Azure Machine Learning service.
