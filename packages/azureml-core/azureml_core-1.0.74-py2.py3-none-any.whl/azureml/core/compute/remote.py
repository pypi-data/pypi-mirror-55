...
# ---------------------------------------------------------
"""Contains functionality for managing remote compute targets in Azure Machine Learning service."""
...
class RemoteCompute(ComputeTarget):
    """Manages a remote compute target for use in Azure Machine Learning service.
