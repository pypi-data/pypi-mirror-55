...
from azureml._model_management._constants import ACI_WEBSERVICE_TYPE, AKS_WEBSERVICE_TYPE, \
    IOT_WEBSERVICE_TYPE, AKS_ENDPOINT_TYPE, MIR_WEBSERVICE_TYPE
...
class Webservice(ABC):
    """
    Defines base functionality for deploying models as web service endpoints in Azure Machine Learning service.
