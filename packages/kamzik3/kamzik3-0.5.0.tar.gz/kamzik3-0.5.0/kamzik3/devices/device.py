...
class Device(Subject, YamlSerializable):
    ...
    def __init__(self, device_id=None, config=None):
        ...
        self.push_commands_max = self.config.get("push_commands_max", inf)
        # Size of command buffer used in push
        self.push_buffer_size = self.config.get("push_buffer_size", 2 ** 16)
    ...
    def attach_attribute_callback(self, attribute, callback, max_update_rate=None, key_filter=None):
        ...
        try:
            ...
            attribute.attach_callback(callback, max_update_rate, key_filter)
    ...
    def _set(self, attribute, value):
        ...
        if attribute_object.with_set_function:
