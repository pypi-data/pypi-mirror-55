...
BUILTIN_TEMPLATES = {
    'clean-one-column': {
        ...
        'description': 'General purpose style, clean appearence with one column.',
        'tested': True
    },
    'documentation': {
        'css': [
        ...
        'description': 'Clean style with two column produced for the journal Documentation.',
        'tested': False
    }
}
...
class EruditPS2HTML(Converter):
    ...
    def transform(self, custom_templates=None, pagedjs_support=False):
        ...
        if pagedjs_support is True:
            ...
            script = ET.Element('script', src='https://unpkg.com/pagedjs@0.1.28/dist/paged.polyfill.js')
            head = html.find('head')
            head.append(stylesheet)
            head.append(script)
