...
class TestEruditPS2EruditAticle(unittest.TestCase):
    ...
    def test_refbiblio_last(self):
        ...
        last_citation_expected = b'<refbiblio xmlns:mml="http://www.w3.org/1998/Math/MathML" xmlns:xlink="http://www.w3.org/1999/xlink" id="rb61"><idpublic scheme="doi">10.2307/1389517</idpublic>Zhao, S. (1991). Metatheory, metamethod, meta-data-analysis&#160;: what, why, and how? <marquage typemarq="italique">Sociological Perspectives, 34</marquage>, 377-390.\n        </refbiblio>'
