...
class HTTP3 (HTTP2):
    ...
    def get (self, url, headers = {}, allow_push = True):
        return HTTP3Response (h3requests.get ('{}{}'.format (self.endpoint, url), headers = headers, allow_push = allow_push))

    def post (self, url, data, headers = {}, allow_push = True):
        return HTTP3Response (h3requests.post ('{}{}'.format (self.endpoint, url), self.urlencode (data, False), headers = headers, allow_push = allow_push))
