...
class HTTP3 (HTTP2):
    ...
    def get (self, url):
        return HTTP3Response (h3requests.get ('{}{}'.format (self.endpoint, url)))

    def post (self, url, data):
        return HTTP3Response (h3requests.post ('{}{}'.format (self.endpoint, url), self.urlencode (data, False)))
