...
class ListAssessmentRunAgents(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Inspector.Client.list_assessment_run_agents`.
...
class ListAssessmentTargets(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Inspector.Client.list_assessment_targets`.
...
class ListAssessmentTemplates(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Inspector.Client.list_assessment_templates`.
...
class ListEventSubscriptions(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Inspector.Client.list_event_subscriptions`.
...
class ListExclusions(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Inspector.Client.list_exclusions`.
...
class ListRulesPackages(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Inspector.Client.list_rules_packages`.
