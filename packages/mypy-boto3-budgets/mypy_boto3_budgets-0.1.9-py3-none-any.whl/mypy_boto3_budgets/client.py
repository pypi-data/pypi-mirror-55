...
class Client(BaseClient):
    ...
    def create_budget(
        ...
        .. warning::
          ...
          Only one of ``BudgetLimit`` or ``PlannedBudgetLimits`` can be present in the syntax at one time. Use the syntax that matches your case. The Request Syntax section shows the ``BudgetLimit`` syntax. For ``PlannedBudgetLimits`` , see the `Examples <https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_CreateBudget.html#API_CreateBudget_Examples>`__ section.
    ...
    def describe_budget(
        ...
        .. warning::
          ...
          The Request Syntax section shows the ``BudgetLimit`` syntax. For ``PlannedBudgetLimits`` , see the `Examples <https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudget.html#API_DescribeBudget_Examples>`__ section.
    ...
    def describe_budgets(
        ...
        .. warning::
          ...
          The Request Syntax section shows the ``BudgetLimit`` syntax. For ``PlannedBudgetLimits`` , see the `Examples <https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_DescribeBudgets.html#API_DescribeBudgets_Examples>`__ section.
