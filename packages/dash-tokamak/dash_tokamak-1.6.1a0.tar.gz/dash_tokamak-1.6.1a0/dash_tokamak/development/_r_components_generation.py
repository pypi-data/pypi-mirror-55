...
def generate_js_metadata(pkg_data, project_shortname):
    ...
    information required by the dash_tokamak package for R.
...
def write_js_metadata(pkg_data, project_shortname, has_wildcards):
    ...
    dependencies as required by dash_tokamak.

    Parameters
    ----------
    project_shortname = hyphenated string, e.g. dash_tokamak-html-components
...
def generate_rpkg(
    ...
    # supply the JavaScript dependencies to the dash_tokamak package.
...
# dash_tokamak-generate-components, while also enforcing
