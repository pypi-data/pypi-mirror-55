...
_re_index_scripts_id = re.compile(r'src=".*dash_tokamak[-_]renderer.*"')
...
class Dash(object):
    ...
    def layout(self, value):
        if not isinstance(value, Component) and not isinstance(
            ...
            raise exceptions.NoLayoutException(
                "Layout must be a dash_tokamak component "
                "or a function that returns "
                "a dash_tokamak component."
            )
    ...
    def _generate_scripts_html(self):
        ...
        # before every other script. However, the dash_tokamak renderer bundle
    ...
    def index(self, *args, **kwargs):  # pylint: disable=unused-argument
        ...
        checks = (
            ...
            (_re_index_scripts_id.search(index), "dash_tokamak-renderer"),
    ...
    def interpolate_index(
        ...
        :Example:
            ...
            class MyDash(dash_tokamak.Dash):
        ...
        :param config: Configs needed by dash_tokamak-renderer.
        ...
        for args, obj, name in [
            ...
            if not isinstance(args, (list, tuple)):
                raise exceptions.IncorrectTypeException(
                    ...
                    "a list or tuple of `dash_tokamak.dependencies.{}`s.".format(
    ...
    def _validate_callback_output(output_value, output):
        ...
        def _raise_invalid(
            ...
            dash_tokamak components, strings, dictionaries, numbers, None,
            or lists of those.
            """
                ).format(
                    output=repr(output),
    ...
    def clientside_callback(
        ...
        it takes a
        `dash_tokamak.dependencies.ClientsideFunction(namespace, function_name)`
    ...
    def _serve_default_favicon():
        return flask.Response(
            pkgutil.get_data("dash_tokamak", "favicon.ico"),
