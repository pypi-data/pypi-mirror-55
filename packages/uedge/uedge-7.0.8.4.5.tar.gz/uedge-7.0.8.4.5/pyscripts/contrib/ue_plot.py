...
def ot(Y,s=None,ax=False,line='-',marker='o',color='k',linewidth=2,markersize=8,xlabel="Distance along IT [m]",ylabel=False,title="OT profile",xlim=False,ylim=False,yaxis="lin"):
...
def mp(Y,s=None,ax=False,line='-',marker='o',color='k',linewidth=2,markersize=8,xlabel="Distance midplane [m]",ylabel=False,title="Midplane profile",xlim=False,ylim=False,yaxis="lin"):
