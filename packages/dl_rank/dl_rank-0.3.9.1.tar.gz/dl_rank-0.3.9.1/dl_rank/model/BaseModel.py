...
class baseModel(metaclass=ABCMeta):
    ...
    def build_embedding(params, num_shards):
        ...
        for feature in feature_list:
            ...
            feature_initializer = f_param['initializer'] if 'initializer' in f_param else dict()
...
def get_initializer(name=None, param=None):
    ...
    if name=='tf.keras.initializers.TruncatedNormal':
        return tf.keras.initializers.TruncatedNormal(**param)
    elif name=='tf.keras.initializers.he_normal':
        return tf.keras.initializers.he_normal(**param)
    elif name=='tf.keras.initializers.he_uniform':
        return tf.keras.initializers.he_uniform(**param)
    elif name=='tf.keras.initializers.GlorotNormal':
        return tf.keras.initializers.GlorotNormal(**param)
    elif name=='tf.contrib.layers.xavier_initializer':
