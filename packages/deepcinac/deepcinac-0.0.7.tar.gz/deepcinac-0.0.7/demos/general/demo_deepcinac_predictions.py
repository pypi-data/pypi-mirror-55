...
root_path = '/home/deepcinac'

# path to calcium imaging data
data_path = os.path.join(root_path, "demos/data")
...
# cells)
weights_file_name = os.path.join(root_path, "model/cinac_weights_v2.h5")
json_file_name = os.path.join(root_path, "model/cinac_model_v2.json")
