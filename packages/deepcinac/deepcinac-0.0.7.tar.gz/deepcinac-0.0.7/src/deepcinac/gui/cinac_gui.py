...
class ChoiceRawFormatFrame(tk.Frame):
    ...
    def create_buttons(self):
        ...
        self.load_config_button["text"] = "Load config"
        ...
        self.save_config_button["text"] = "Save config"
...
if __name__ == '__main__':
    path_data = '/media/julien/Not_today/hne_not_today/data'

    # print(f'platform: {platform}')
    root = Tk()
    root.title(f"Options")

    app = ChoiceFormatFrame(master=root, default_path=path_data)
    app.mainloop()
    # root.destroy()
