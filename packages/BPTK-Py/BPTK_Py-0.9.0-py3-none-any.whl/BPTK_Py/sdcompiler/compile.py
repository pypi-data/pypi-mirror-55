...
try:
    ...
    from .plugins import StockExpressions,ExpandArrays, sortEntities,FindComplexFunctions
    standalone = False
...
def compile_xmile(src, dest, target):
    ...
    IR = FindComplexFunctions(sortEntities(ExpandArrays(StockExpressions(parse_xmile(src)))))
