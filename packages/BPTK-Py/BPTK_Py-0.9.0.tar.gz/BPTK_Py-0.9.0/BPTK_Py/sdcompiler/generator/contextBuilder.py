...
def generate(IR, template, parseExpression):
    ...
    :param parseExpression: Function that parses to the specific target language
    :return:
    """
    ...
    ## Fill template
    output = template.render(stocks=context["stocks"],specs=IR["specs"],flows=context["flows"],converters=context["converters"],gfs=context["gfs"],constants=context["constants"])
    return output
