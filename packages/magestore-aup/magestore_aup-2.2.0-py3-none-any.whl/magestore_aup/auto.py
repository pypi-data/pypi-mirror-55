...
def get_previous_newest_release_tag_names(repo_info):
    ...
    try:
        ...
        nearly_newest_tag = [t for t in newest_tag if t.split('.')[0] == prefix_tag_name and t != repo_info.get('tag_name')]
...
def get_almost_newest_release_by_tag_name(repo_info):
    ...
    try:
        ...
        _logger.error(e)
        return get_almost_newest_release_by_tag_name(repo_info)
    return False
