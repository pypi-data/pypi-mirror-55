...
class JustClient(BaseClient):
    ...
    def __init__(self, public_key, secret_key, sql_web_app_url=None):
        """
        初始化函数
        :param public_key: 公钥
        :param secret_key: 秘钥
        ...
        """
        super(JustClient, self).__init__(public_key, secret_key, sql_web_app_url)
    ...
    def execute_query(self, sql):
        ...
        return ResultSet(json_result, sql_id, self._session, self._default_sql_web_app_url)
