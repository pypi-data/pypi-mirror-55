...
class ServiceResource(Boto3ServiceResource):
    stacks: mypy_boto3_opsworks_scope.stacks
    # pylint: disable=arguments-differ
    def Layer(self, id: str = None) -> mypy_boto3_opsworks_scope.Layer:
        pass

    # pylint: disable=arguments-differ
    def Stack(self, id: str = None) -> mypy_boto3_opsworks_scope.Stack:
        pass
...
class Stack(Boto3ServiceResource):
    ...
    agent_version: str
    id: str
    layers: mypy_boto3_opsworks_scope.layers
    # pylint: disable=arguments-differ
    def create_layer(
        self,
        Type: str,
