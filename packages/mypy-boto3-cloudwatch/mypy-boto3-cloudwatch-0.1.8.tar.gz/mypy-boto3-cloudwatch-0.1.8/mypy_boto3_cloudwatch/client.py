...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def delete_dashboards(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def disable_alarm_actions(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def enable_alarm_actions(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_metric_widget_image(self) -> None:
        pass
