...
import mypy_boto3_cloudwatch.service_resource as mypy_boto3_cloudwatch_scope


class ServiceResource(Boto3ServiceResource):
    def Alarm(self, name: str) -> mypy_boto3_cloudwatch_scope.Alarm:
        """
    ...
    def Metric(self, namespace: str, name: str) -> mypy_boto3_cloudwatch_scope.Metric:
        """
...
class Metric(Boto3ServiceResource):
    ...
    ) -> mypy_boto3_cloudwatch_scope.Alarm:
        """
...
class alarms(ResourceCollection):
    @classmethod
    def all(cls) -> List[mypy_boto3_cloudwatch_scope.Alarm]:
        """
    ...
    def filter(
        ...
        MaxRecords: int = None,
        NextToken: str = None,
    ) -> List[mypy_boto3_cloudwatch_scope.Alarm]:
        """
    ...
    @classmethod
    def limit(cls, count: int = None) -> List[mypy_boto3_cloudwatch_scope.Alarm]:
        """
    ...
    @classmethod
    def page_size(cls, count: int = None) -> List[mypy_boto3_cloudwatch_scope.Alarm]:
        """
...
class metrics(ResourceCollection):
    @classmethod
    def all(cls) -> List[mypy_boto3_cloudwatch_scope.Metric]:
        """
    ...
    def filter(
        ...
        Dimensions: List[Any] = None,
        NextToken: str = None,
    ) -> List[mypy_boto3_cloudwatch_scope.Metric]:
        """
    ...
    @classmethod
    def limit(cls, count: int = None) -> List[mypy_boto3_cloudwatch_scope.Metric]:
        """
    ...
    @classmethod
    def page_size(cls, count: int = None) -> List[mypy_boto3_cloudwatch_scope.Metric]:
        """
