...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def describe_listener_certificates(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_listeners(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def describe_rules(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_ssl_policies(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def describe_target_group_attributes(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_target_groups(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def set_ip_address_type(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def set_security_groups(self) -> None:
        pass
