...
def tesseract(image, lang='eng', psm='3', oem='3', out='stdout', dpi=70, config_var=None, output_format=None, tessdata_dir=None, os_temp=False, temp_folder=None, decode_output=True):
    ...
    try:
        ...
        args = [temp_image_file_path, out, '--tessdata-dir', tessdata_dir, '-l', lang, '--dpi', dpi, '--psm', psm, '--oem', oem]
...
def image_to_text(image, osd=True, aps=True, sparse=False, oem='3', lang='eng', out='stdout', dpi=70, tessdata_dir=None, os_temp=False):
    """
    Parameters
    ----------
    image : PIL.Image
