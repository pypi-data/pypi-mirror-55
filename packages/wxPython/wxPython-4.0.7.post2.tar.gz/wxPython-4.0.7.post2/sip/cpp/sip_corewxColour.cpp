...
sipVariableDef variables_wxColour[] = {
    ...
    {PropertyVariable, sipName_green, &methods_wxColour[9], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_red, &methods_wxColour[14], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_RGBA, &methods_wxColour[8], &methods_wxColour[17], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_RGB, &methods_wxColour[7], &methods_wxColour[16], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Pixel, &methods_wxColour[6], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
