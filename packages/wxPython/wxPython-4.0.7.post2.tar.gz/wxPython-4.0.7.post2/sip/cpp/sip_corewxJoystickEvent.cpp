...
static sipEncodedTypeDef supers_wxJoystickEvent[] = {{140, 255, 1}};
...
sipVariableDef variables_wxJoystickEvent[] = {
    {PropertyVariable, sipName_ZPosition, &methods_wxJoystickEvent[8], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Position, &methods_wxJoystickEvent[7], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Joystick, &methods_wxJoystickEvent[6], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ButtonState, &methods_wxJoystickEvent[5], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
