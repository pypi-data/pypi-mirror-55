...
static PyObject *meth_wxSizer_SetVirtualSizeHints(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Sizer, sipName_SetVirtualSizeHints, SIP_NULLPTR);
...
static PyMethodDef methods_wxSizer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetVirtualSizeHints), SIP_MLMETH_CAST(meth_wxSizer_SetVirtualSizeHints), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSizer_SetVirtualSizeHints)},
...
sipVariableDef variables_wxSizer[] = {
    ...
    {PropertyVariable, sipName_MinSize, &methods_wxSizer[15], &methods_wxSizer[35], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ItemCount, &methods_wxSizer[14], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ContainingWindow, &methods_wxSizer[11], &methods_wxSizer[32], SIP_NULLPTR, SIP_NULLPTR},
