...
static PyObject *meth_wxRichTextObject_DrawBorder(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "J9J8J9J1|i", sipType_wxDC, &dc, sipType_wxRichTextBuffer, &buffer, sipType_wxTextAttrBorders, &attr, sipType_wxRect, &rect, &rectState, &flags))
        {
            bool sipRes;
...
static sipEncodedTypeDef supers_wxRichTextObject[] = {{41, 0, 1}};
