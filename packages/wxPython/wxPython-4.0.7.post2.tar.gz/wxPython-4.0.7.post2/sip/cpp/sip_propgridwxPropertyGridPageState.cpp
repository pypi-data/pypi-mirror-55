...
static PyObject *meth_wxPropertyGridPageState_GetPropertyByLabel(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ1|J8", &sipSelf, sipType_wxPropertyGridPageState, &sipCpp, sipType_wxString,&name, &nameState, sipType_wxPGProperty, &parent))
        {
             ::wxPGProperty*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_PropertyGridPageState, sipName_GetPropertyByLabel, SIP_NULLPTR);
...
static PyMethodDef methods_wxPropertyGridPageState[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetColumnMinWidth), SIP_MLMETH_CAST(meth_wxPropertyGridPageState_GetColumnMinWidth), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGridPageState_GetColumnMinWidth)},
    ...
    {SIP_MLNAME_CAST(sipName_GetPropertyByLabel), SIP_MLMETH_CAST(meth_wxPropertyGridPageState_GetPropertyByLabel), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxPropertyGridPageState_GetPropertyByLabel)},
...
sipVariableDef variables_wxPropertyGridPageState[] = {
    {PropertyVariable, sipName_VirtualWidth, &methods_wxPropertyGridPageState[44], &methods_wxPropertyGridPageState[55], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_VirtualHeight, &methods_wxPropertyGridPageState[43], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selection, &methods_wxPropertyGridPageState[42], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    ...
    {PropertyVariable, sipName_ColumnCount, &methods_wxPropertyGridPageState[33], &methods_wxPropertyGridPageState[53], SIP_NULLPTR, SIP_NULLPTR},
