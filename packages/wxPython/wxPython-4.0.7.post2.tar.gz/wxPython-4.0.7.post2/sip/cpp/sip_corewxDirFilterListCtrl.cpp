...
sipwxDirFilterListCtrl::sipwxDirFilterListCtrl( ::wxGenericDirCtrl*parent,const  ::wxWindowID id,const  ::wxPoint& pos,const  ::wxSize& size,long style):  ::wxDirFilterListCtrl(parent,id,pos,size,style), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
uint sipwxDirFilterListCtrl::GetCount() const
{
    ...
    extern uint sipVH__core_136(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxString sipwxDirFilterListCtrl::GetString(uint n) const
{
    ...
    extern  ::wxString sipVH__core_137(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_137(sipGILState, 0, sipPySelf, sipMeth, n);
}
...
void sipwxDirFilterListCtrl::SetString(uint n,const  ::wxString& string)
{
    ...
    extern void sipVH__core_138(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,const  ::wxString&);

    sipVH__core_138(sipGILState, 0, sipPySelf, sipMeth, n, string);
}
...
int sipwxDirFilterListCtrl::FindString(const  ::wxString& string,bool caseSensitive) const
{
    ...
    extern int sipVH__core_139(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&,bool);

    return sipVH__core_139(sipGILState, 0, sipPySelf, sipMeth, string, caseSensitive);
}
...
void sipwxDirFilterListCtrl::SetSelection(int n)
{
    ...
    sipVH__core_98(sipGILState, 0, sipPySelf, sipMeth, n);
}
...
static sipEncodedTypeDef supers_wxDirFilterListCtrl[] = {{55, 255, 1}};
