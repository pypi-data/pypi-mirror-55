...
static PyObject *meth_wxEvent_GetEventUserData(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_Event, sipName_GetEventUserData, SIP_NULLPTR);
...
sipVariableDef variables_wxEvent[] = {
    {PropertyVariable, sipName_Timestamp, &methods_wxEvent[7], &methods_wxEvent[13], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Skipped, &methods_wxEvent[6], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Id, &methods_wxEvent[5], &methods_wxEvent[12], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_EventType, &methods_wxEvent[3], &methods_wxEvent[11], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_EventObject, &methods_wxEvent[2], &methods_wxEvent[10], SIP_NULLPTR, SIP_NULLPTR},
};
