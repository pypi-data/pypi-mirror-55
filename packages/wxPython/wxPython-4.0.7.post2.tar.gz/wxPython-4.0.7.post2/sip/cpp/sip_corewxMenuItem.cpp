...
static PyObject *meth_wxMenuItem_GetLabel(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MenuItem, sipName_GetLabel, SIP_NULLPTR);
...
static PyObject *meth_wxMenuItem_GetName(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MenuItem, sipName_GetName, SIP_NULLPTR);
...
static PyObject *meth_wxMenuItem_GetText(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MenuItem, sipName_GetText, SIP_NULLPTR);
...
static PyObject *meth_wxMenuItem_SetText(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ1", &sipSelf, sipType_wxMenuItem, &sipCpp, sipType_wxString,&text, &textState))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MenuItem, sipName_SetText, SIP_NULLPTR);
...
static PyObject *meth_wxMenuItem_GetLabelFromText(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_MenuItem, sipName_GetLabelFromText, SIP_NULLPTR);
...
static PyMethodDef methods_wxMenuItem[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetLabelFromText), SIP_MLMETH_CAST(meth_wxMenuItem_GetLabelFromText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMenuItem_GetLabelFromText)},
    ...
    {SIP_MLNAME_CAST(sipName_SetText), SIP_MLMETH_CAST(meth_wxMenuItem_SetText), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxMenuItem_SetText)},
...
sipVariableDef variables_wxMenuItem[] = {
    {PropertyVariable, sipName_Enabled, &methods_wxMenuItem[24], &methods_wxMenuItem[1], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TextColour, &methods_wxMenuItem[20], &methods_wxMenuItem[40], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Text, &methods_wxMenuItem[19], &methods_wxMenuItem[39], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SubMenu, &methods_wxMenuItem[18], &methods_wxMenuItem[38], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Name, &methods_wxMenuItem[17], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Menu, &methods_wxMenuItem[16], &methods_wxMenuItem[37], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MarginWidth, &methods_wxMenuItem[15], &methods_wxMenuItem[36], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Label, &methods_wxMenuItem[12], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    ...
    {PropertyVariable, sipName_ItemLabel, &methods_wxMenuItem[9], &methods_wxMenuItem[35], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Id, &methods_wxMenuItem[8], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Help, &methods_wxMenuItem[7], &methods_wxMenuItem[34], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Font, &methods_wxMenuItem[6], &methods_wxMenuItem[33], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DisabledBitmap, &methods_wxMenuItem[5], &methods_wxMenuItem[32], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Bitmap, &methods_wxMenuItem[4], &methods_wxMenuItem[30], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_BackgroundColour, &methods_wxMenuItem[3], &methods_wxMenuItem[29], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Accel, &methods_wxMenuItem[2], &methods_wxMenuItem[28], SIP_NULLPTR, SIP_NULLPTR},
};
