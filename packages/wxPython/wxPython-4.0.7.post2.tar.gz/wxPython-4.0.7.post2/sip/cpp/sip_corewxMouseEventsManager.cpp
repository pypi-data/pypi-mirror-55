...
void sipwxMouseEventsManager::MouseClickCancelled(int item)
{
    ...
    sipVH__core_98(sipGILState, 0, sipPySelf, sipMeth, item);
}
...
void sipwxMouseEventsManager::MouseDragEnd(int item,const  ::wxPoint& pos)
{
    ...
    extern void sipVH__core_218(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxPoint&);

    sipVH__core_218(sipGILState, 0, sipPySelf, sipMeth, item, pos);
}
...
bool sipwxMouseEventsManager::MouseDragBegin(int item,const  ::wxPoint& pos)
{
    ...
    extern bool sipVH__core_217(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,const  ::wxPoint&);

    return sipVH__core_217(sipGILState, 0, sipPySelf, sipMeth, item, pos);
}
...
bool sipwxMouseEventsManager::MouseClicked(int item)
{
    ...
    return sipVH__core_132(sipGILState, 0, sipPySelf, sipMeth, item);
}
...
int sipwxMouseEventsManager::MouseHitTest(const  ::wxPoint& pos)
{
    ...
    extern int sipVH__core_216(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPoint&);

    return sipVH__core_216(sipGILState, 0, sipPySelf, sipMeth, pos);
}
...
static sipEncodedTypeDef supers_wxMouseEventsManager[] = {{147, 255, 1}};
