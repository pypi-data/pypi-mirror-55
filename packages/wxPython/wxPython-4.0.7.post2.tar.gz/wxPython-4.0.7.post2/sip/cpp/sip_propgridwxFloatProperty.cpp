...
static PyObject *meth_wxFloatProperty_DoGetAttribute(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ1", &sipSelf, sipType_wxFloatProperty, &sipCpp, sipType_wxString,&name, &nameState))
        {
             ::wxPGVariant*sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FloatProperty, sipName_DoGetAttribute, SIP_NULLPTR);
...
static PyObject *meth_wxFloatProperty_DoValidation(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "J8J8|i", sipType_wxPGProperty, &property, sipType_wxPGValidationInfo, &pValidationInfo, &mode))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FloatProperty, sipName_DoValidation, SIP_NULLPTR);
...
static PyMethodDef methods_wxFloatProperty[] = {
    {SIP_MLNAME_CAST(sipName_DoGetAttribute), SIP_MLMETH_CAST(meth_wxFloatProperty_DoGetAttribute), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFloatProperty_DoGetAttribute)},
    ...
    {SIP_MLNAME_CAST(sipName_DoValidation), SIP_MLMETH_CAST(meth_wxFloatProperty_DoValidation), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFloatProperty_DoValidation)},
