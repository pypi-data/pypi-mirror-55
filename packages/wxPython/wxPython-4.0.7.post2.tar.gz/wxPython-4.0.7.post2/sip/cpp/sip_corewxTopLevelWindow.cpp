...
sipVariableDef variables_wxTopLevelWindow[] = {
    {PropertyVariable, sipName_MacMetalAppearance, &methods_wxTopLevelWindow[47], &methods_wxTopLevelWindow[50], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_OSXModified, &methods_wxTopLevelWindow[52], &methods_wxTopLevelWindow[53], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TmpDefaultItem, &methods_wxTopLevelWindow[34], &methods_wxTopLevelWindow[69], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Title, &methods_wxTopLevelWindow[33], &methods_wxTopLevelWindow[68], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Icon, &methods_wxTopLevelWindow[30], &methods_wxTopLevelWindow[62], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DefaultItem, &methods_wxTopLevelWindow[28], &methods_wxTopLevelWindow[61], SIP_NULLPTR, SIP_NULLPTR},
};
