...
public:
     ...
     */
protected:
    bool AdjustPagebreak(int*,const  ::wxArrayInt&,int) const SIP_OVERRIDE;
...
sipVariableDef variables_wxHtmlContainerCell[] = {
    {PropertyVariable, sipName_BackgroundColour, &methods_wxHtmlContainerCell[4], &methods_wxHtmlContainerCell[13], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_AlignVer, &methods_wxHtmlContainerCell[3], &methods_wxHtmlContainerCell[12], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_AlignHor, &methods_wxHtmlContainerCell[2], &methods_wxHtmlContainerCell[11], SIP_NULLPTR, SIP_NULLPTR},
};
