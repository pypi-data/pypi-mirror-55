...
static sipEnumMemberDef enummembers_wxConfigBase[] = {
    {sipName_Type_Boolean, static_cast<int>( ::wxConfigBase::Type_Boolean), 84},
    {sipName_Type_Float, static_cast<int>( ::wxConfigBase::Type_Float), 84},
    {sipName_Type_Integer, static_cast<int>( ::wxConfigBase::Type_Integer), 84},
    {sipName_Type_String, static_cast<int>( ::wxConfigBase::Type_String), 84},
    {sipName_Type_Unknown, static_cast<int>( ::wxConfigBase::Type_Unknown), 84},
};
