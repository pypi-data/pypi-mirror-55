...
uint sipwxDataViewListModel::GetChildren(const  ::wxDataViewItem& item, ::wxDataViewItemArray& children) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[9]),sipPySelf,sipName_DataViewListModel,sipName_GetChildren);
...
uint sipwxDataViewListModel::GetColumnCount() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[10]),sipPySelf,sipName_DataViewListModel,sipName_GetColumnCount);
 ...
 ::wxString sipwxDataViewListModel::GetColumnType(uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[11]),sipPySelf,sipName_DataViewListModel,sipName_GetColumnType);
