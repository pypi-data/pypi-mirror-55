...
static PyObject *meth_wxPGCell_GetData(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_wxPGCell, &sipCpp))
        {
            ...
            return sipConvertFromType(const_cast< ::wxPGCellData *>(sipRes),sipType_wxPGCellData,SIP_NULLPTR);
        }
    }
...
static sipEncodedTypeDef supers_wxPGCell[] = {{19, 0, 1}};
...
sipVariableDef variables_wxPGCell[] = {
    {PropertyVariable, sipName_Text, &methods_wxPGCell[5], &methods_wxPGCell[12], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Font, &methods_wxPGCell[4], &methods_wxPGCell[11], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FgCol, &methods_wxPGCell[3], &methods_wxPGCell[10], SIP_NULLPTR, SIP_NULLPTR},
