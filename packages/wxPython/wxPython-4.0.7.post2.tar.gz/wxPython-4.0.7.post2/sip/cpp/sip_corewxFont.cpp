...
static sipEncodedTypeDef supers_wxFont[] = {{204, 255, 1}};
...
sipVariableDef variables_wxFont[] = {
    {PropertyVariable, sipName_Weight, &methods_wxFont[15], &methods_wxFont[43], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Style, &methods_wxFont[13], &methods_wxFont[39], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PixelSize, &methods_wxFont[10], &methods_wxFont[36], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PointSize, &methods_wxFont[11], &methods_wxFont[37], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_NativeFontInfoUserDesc, &methods_wxFont[8], &methods_wxFont[35], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_NativeFontInfoDesc, &methods_wxFont[7], &methods_wxFont[34], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Family, &methods_wxFont[4], &methods_wxFont[33], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FaceName, &methods_wxFont[3], &methods_wxFont[32], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Encoding, &methods_wxFont[2], &methods_wxFont[31], SIP_NULLPTR, SIP_NULLPTR},
};
