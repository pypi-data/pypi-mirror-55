...
public:
     ...
     */
protected:
    bool LoadImageCache( ::wxDC&,bool,const  ::wxSize&) SIP_OVERRIDE;
...
bool sipwxRichTextImage::LoadImageCache( ::wxDC& dc,bool resetCache,const  ::wxSize& parentSize)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,SIP_NULLPTR,sipName_LoadImageCache);
...
static PyObject *meth_wxRichTextImage_LoadImageCache(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ9|bJ1", &sipSelf, sipType_wxRichTextImage, &sipCpp, sipType_wxDC, &dc, &resetCache, sipType_wxSize, &parentSize, &parentSizeState))
        {
            bool sipRes;
...
sipVariableDef variables_wxRichTextImage[] = {
    {PropertyVariable, sipName_XMLNodeName, &methods_wxRichTextImage[11], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PropertiesMenuLabel, &methods_wxRichTextImage[9], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_OriginalImageSize, &methods_wxRichTextImage[8], &methods_wxRichTextImage[19], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_NaturalSize, &methods_wxRichTextImage[7], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ImageCache, &methods_wxRichTextImage[6], &methods_wxRichTextImage[18], SIP_NULLPTR, SIP_NULLPTR},
