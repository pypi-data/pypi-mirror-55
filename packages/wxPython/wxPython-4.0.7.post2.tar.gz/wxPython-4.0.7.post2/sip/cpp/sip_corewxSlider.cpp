...
static PyObject *meth_wxSlider_SetTickFreq(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Bi", &sipSelf, sipType_wxSlider, &sipCpp, &n))
        {
            PyErr_Clear();
...
static sipEncodedTypeDef supers_wxSlider[] = {{89, 255, 1}};
