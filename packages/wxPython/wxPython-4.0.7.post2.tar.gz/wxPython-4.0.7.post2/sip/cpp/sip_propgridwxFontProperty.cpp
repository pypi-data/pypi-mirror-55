...
static PyObject *meth_wxFontProperty_OnEvent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ8J8J9", &sipSelf, sipType_wxFontProperty, &sipCpp, sipType_wxPropertyGrid, &propgrid, sipType_wxWindow, &wnd_primary, sipType_wxEvent, &event))
        {
            bool sipRes;
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_FontProperty, sipName_OnEvent, SIP_NULLPTR);
...
static PyMethodDef methods_wxFontProperty[] = {
    ...
    {SIP_MLNAME_CAST(sipName_OnEvent), SIP_MLMETH_CAST(meth_wxFontProperty_OnEvent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxFontProperty_OnEvent)},
