...
void sipwxToolbook::SetImageList( ::wxImageList*imageList)
{
    ...
    extern void sipVH__core_140(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxImageList*);

    sipVH__core_140(sipGILState, 0, sipPySelf, sipMeth, imageList);
}
...
int sipwxToolbook::GetPageImage(size_t nPage) const
{
    ...
    extern int sipVH__core_130(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t);

    return sipVH__core_130(sipGILState, 0, sipPySelf, sipMeth, nPage);
}
...
bool sipwxToolbook::SetPageImage(size_t page,int image)
{
    ...
    extern bool sipVH__core_141(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t,int);

    return sipVH__core_141(sipGILState, 0, sipPySelf, sipMeth, page, image);
}
 ...
 ::wxString sipwxToolbook::GetPageText(size_t nPage) const
{
    ...
    extern  ::wxString sipVH__core_142(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t);
...
bool sipwxToolbook::SetPageText(size_t page,const  ::wxString& text)
{
    ...
    extern bool sipVH__core_143(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t,const  ::wxString&);

    return sipVH__core_143(sipGILState, 0, sipPySelf, sipMeth, page, text);
}
...
int sipwxToolbook::SetSelection(size_t page)
{
    ...
    return sipVH__core_130(sipGILState, 0, sipPySelf, sipMeth, page);
}
...
bool sipwxToolbook::AddPage( ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    ...
    extern bool sipVH__core_144(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*,const  ::wxString&,bool,int);

    return sipVH__core_144(sipGILState, 0, sipPySelf, sipMeth, page, text, select, imageId);
}
...
bool sipwxToolbook::DeletePage(size_t page)
{
    ...
    extern bool sipVH__core_145(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t);
...
bool sipwxToolbook::InsertPage(size_t index, ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    ...
    extern bool sipVH__core_146(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t, ::wxWindow*,const  ::wxString&,bool,int);

    return sipVH__core_146(sipGILState, 0, sipPySelf, sipMeth, index, page, text, select, imageId);
}
...
size_t sipwxToolbook::GetPageCount() const
{
    ...
    extern size_t sipVH__core_62(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_62(sipGILState, 0, sipPySelf, sipMeth);
}
...
void sipwxToolbook::SetPageSize(const  ::wxSize& size)
{
    ...
    extern void sipVH__core_147(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxSize&);

    sipVH__core_147(sipGILState, 0, sipPySelf, sipMeth, size);
}
...
int sipwxToolbook::HitTest(const  ::wxPoint& pt,long*flags) const
{
    ...
    extern int sipVH__core_148(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPoint&,long*);

    return sipVH__core_148(sipGILState, 0, sipPySelf, sipMeth, pt, flags);
}
...
static sipEncodedTypeDef supers_wxToolbook[] = {{37, 255, 1}};
...
sipVariableDef variables_wxToolbook[] = {
    {PropertyVariable, sipName_ToolBar, &methods_wxToolbook[30], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
