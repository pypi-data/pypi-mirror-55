...
int sipwxHeaderCtrlSimple::GetBestFittingWidth(uint idx) const
{
    ...
    extern int sipVH__core_157(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_157(sipGILState, 0, sipPySelf, sipMeth, idx);
}
...
const  ::wxHeaderColumn& sipwxHeaderCtrlSimple::GetColumn(uint idx) const
{
    ...
    extern const  ::wxHeaderColumn& sipVH__core_152(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    return sipVH__core_152(sipGILState, 0, sipPySelf, sipMeth, idx);
}
...
void sipwxHeaderCtrlSimple::UpdateColumnVisibility(uint idx,bool show)
{
    ...
    extern void sipVH__core_153(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,bool);

    sipVH__core_153(sipGILState, 0, sipPySelf, sipMeth, idx, show);
}
...
void sipwxHeaderCtrlSimple::UpdateColumnsOrder(const  ::wxArrayInt& order)
{
    ...
    extern void sipVH__core_154(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxArrayInt&);

    sipVH__core_154(sipGILState, 0, sipPySelf, sipMeth, order);
}
...
bool sipwxHeaderCtrlSimple::UpdateColumnWidthToFit(uint idx,int widthTitle)
{
    ...
    extern bool sipVH__core_155(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint,int);

    return sipVH__core_155(sipGILState, 0, sipPySelf, sipMeth, idx, widthTitle);
}
...
void sipwxHeaderCtrlSimple::OnColumnCountChanging(uint count)
{
    ...
    extern void sipVH__core_156(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, uint);

    sipVH__core_156(sipGILState, 0, sipPySelf, sipMeth, count);
}
...
static sipEncodedTypeDef supers_wxHeaderCtrlSimple[] = {{232, 255, 1}};
