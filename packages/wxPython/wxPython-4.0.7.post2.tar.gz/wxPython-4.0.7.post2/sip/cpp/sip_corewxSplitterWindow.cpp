...
static PyObject *meth_wxSplitterWindow_SetSashSize(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Bi", &sipSelf, sipType_wxSplitterWindow, &sipCpp, &size))
        {
            PyErr_Clear();
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_SplitterWindow, sipName_SetSashSize, SIP_NULLPTR);
...
static PyMethodDef methods_wxSplitterWindow[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetSashSize), SIP_MLMETH_CAST(meth_wxSplitterWindow_SetSashSize), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxSplitterWindow_SetSashSize)},
...
sipVariableDef variables_wxSplitterWindow[] = {
    ...
    {PropertyVariable, sipName_SplitMode, &methods_wxSplitterWindow[30], &methods_wxSplitterWindow[52], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SashSize, &methods_wxSplitterWindow[29], &methods_wxSplitterWindow[51], SIP_NULLPTR, SIP_NULLPTR},
