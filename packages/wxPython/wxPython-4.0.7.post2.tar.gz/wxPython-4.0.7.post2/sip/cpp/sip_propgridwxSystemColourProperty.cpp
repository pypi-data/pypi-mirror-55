 ...
 ::wxColour sipwxSystemColourProperty::GetColour(int index) const
{
    ...
    extern  ::wxColour sipVH__propgrid_74(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int);
 ...
 ::wxString sipwxSystemColourProperty::ColourToString(const  ::wxColour& col,int index,int argFlags) const
{
    ...
    extern  ::wxString sipVH__propgrid_73(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxColour&,int,int);

    return sipVH__propgrid_73(sipGILState, 0, sipPySelf, sipMeth, col, index, argFlags);
}
