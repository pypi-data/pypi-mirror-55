...
static sipEncodedTypeDef supers_wxHelpEvent[] = {{77, 255, 1}};
...
static sipEnumMemberDef enummembers_wxHelpEvent[] = {
    {sipName_Origin_HelpButton, static_cast<int>( ::wxHelpEvent::Origin_HelpButton), 239},
    {sipName_Origin_Keyboard, static_cast<int>( ::wxHelpEvent::Origin_Keyboard), 239},
    {sipName_Origin_Unknown, static_cast<int>( ::wxHelpEvent::Origin_Unknown), 239},
};
