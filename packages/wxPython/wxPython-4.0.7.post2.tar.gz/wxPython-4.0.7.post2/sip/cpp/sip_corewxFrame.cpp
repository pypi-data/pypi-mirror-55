 ...
 ::wxToolBar* sipwxFrame::OnCreateToolBar(long style, ::wxWindowID id,const  ::wxString& name)
{
    ...
    extern  ::wxToolBar* sipVH__core_176(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long, ::wxWindowID,const  ::wxString&);

    return sipVH__core_176(sipGILState, 0, sipPySelf, sipMeth, style, id, name);
}
 ...
 ::wxStatusBar* sipwxFrame::OnCreateStatusBar(int number,long style, ::wxWindowID id,const  ::wxString& name)
{
    ...
    extern  ::wxStatusBar* sipVH__core_175(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,long, ::wxWindowID,const  ::wxString&);

    return sipVH__core_175(sipGILState, 0, sipPySelf, sipMeth, number, style, id, name);
}
...
void sipwxFrame::RemoveChild( ::wxWindowBase*child)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,SIP_NULLPTR,sipName_RemoveChild);
...
void sipwxFrame::AddChild( ::wxWindowBase*child)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,SIP_NULLPTR,sipName_AddChild);
...
bool sipwxFrame::AcceptsFocus() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[7]),sipPySelf,SIP_NULLPTR,sipName_AcceptsFocus);
...
bool sipwxFrame::AcceptsFocusFromKeyboard() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[8]),sipPySelf,SIP_NULLPTR,sipName_AcceptsFocusFromKeyboard);
...
bool sipwxFrame::AcceptsFocusRecursively() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[9]),sipPySelf,SIP_NULLPTR,sipName_AcceptsFocusRecursively);
...
void sipwxFrame::SetCanFocus(bool canFocus)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[10],sipPySelf,SIP_NULLPTR,sipName_SetCanFocus);
...
sipVariableDef variables_wxFrame[] = {
    {PropertyVariable, sipName_ToolBar, &methods_wxFrame[31], &methods_wxFrame[52], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_StatusBarPane, &methods_wxFrame[30], &methods_wxFrame[49], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_StatusBar, &methods_wxFrame[29], &methods_wxFrame[48], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MenuBar, &methods_wxFrame[28], &methods_wxFrame[47], SIP_NULLPTR, SIP_NULLPTR},
};
