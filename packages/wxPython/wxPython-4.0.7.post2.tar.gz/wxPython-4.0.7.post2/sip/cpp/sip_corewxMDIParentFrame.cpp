 ...
 ::wxMDIClientWindow* sipwxMDIParentFrame::OnCreateClient()
{
    ...
    extern  ::wxMDIClientWindow* sipVH__core_180(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_180(sipGILState, 0, sipPySelf, sipMeth);
}
...
static sipEncodedTypeDef supers_wxMDIParentFrame[] = {{199, 255, 1}};
