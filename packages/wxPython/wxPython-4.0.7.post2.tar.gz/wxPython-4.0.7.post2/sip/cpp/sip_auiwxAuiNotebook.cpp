...
sipVariableDef variables_wxAuiNotebook[] = {
    {PropertyVariable, sipName_TabCtrlHeight, &methods_wxAuiNotebook[41], &methods_wxAuiNotebook[65], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selection, &methods_wxAuiNotebook[40], &methods_wxAuiNotebook[64], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PageCount, &methods_wxAuiNotebook[35], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CurrentPage, &methods_wxAuiNotebook[28], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ArtProvider, &methods_wxAuiNotebook[25], &methods_wxAuiNotebook[54], SIP_NULLPTR, SIP_NULLPTR},
};
