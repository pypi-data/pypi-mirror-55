...
sipVariableDef variables_wxRibbonBar[] = {
    {PropertyVariable, sipName_PageCount, &methods_wxRibbonBar[34], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ActivePage, &methods_wxRibbonBar[27], &methods_wxRibbonBar[51], SIP_NULLPTR, SIP_NULLPTR},
};
