...
sipVariableDef variables_wxDataViewCtrl[] = {
    {PropertyVariable, sipName_SortingColumn, &methods_wxDataViewCtrl[53], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selections, &methods_wxDataViewCtrl[52], &methods_wxDataViewCtrl[82], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selection, &methods_wxDataViewCtrl[51], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedItemsCount, &methods_wxDataViewCtrl[50], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Model, &methods_wxDataViewCtrl[49], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Indent, &methods_wxDataViewCtrl[46], &methods_wxDataViewCtrl[80], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ExpanderColumn, &methods_wxDataViewCtrl[45], &methods_wxDataViewCtrl[79], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CurrentItem, &methods_wxDataViewCtrl[42], &methods_wxDataViewCtrl[78], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CurrentColumn, &methods_wxDataViewCtrl[41], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ColumnCount, &methods_wxDataViewCtrl[39], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
