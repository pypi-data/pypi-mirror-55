...
bool sipwxPrinter::Setup( ::wxWindow*parent)
{
    ...
    extern bool sipVH__core_124(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_124(sipGILState, 0, sipPySelf, sipMeth, parent);
}
...
void sipwxPrinter::ReportError( ::wxWindow*parent, ::wxPrintout*printout,const  ::wxString& message)
{
    ...
    extern void sipVH__core_208(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxPrintout*,const  ::wxString&);

    sipVH__core_208(sipGILState, 0, sipPySelf, sipMeth, parent, printout, message);
}
 ...
 ::wxDC* sipwxPrinter::PrintDialog( ::wxWindow*parent)
{
    ...
    extern  ::wxDC* sipVH__core_207(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*);

    return sipVH__core_207(sipGILState, 0, sipPySelf, sipMeth, parent);
}
...
bool sipwxPrinter::Print( ::wxWindow*parent, ::wxPrintout*printout,bool prompt)
{
    ...
    extern bool sipVH__core_206(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxPrintout*,bool);

    return sipVH__core_206(sipGILState, 0, sipPySelf, sipMeth, parent, printout, prompt);
}
 ...
 ::wxPrintDialogData& sipwxPrinter::GetPrintDialogData() const
{
    ...
    extern  ::wxPrintDialogData& sipVH__core_205(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxPrintAbortDialog* sipwxPrinter::CreateAbortWindow( ::wxWindow*parent, ::wxPrintout*printout)
{
    ...
    extern  ::wxPrintAbortDialog* sipVH__core_204(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*, ::wxPrintout*);

    return sipVH__core_204(sipGILState, 0, sipPySelf, sipMeth, parent, printout);
}
