...
static sipEncodedTypeDef supers_wxGridCellAttr[] = {{4, 0, 0}, {21, 0, 1}};
...
sipVariableDef variables_wxGridCellAttr[] = {
    {PropertyVariable, sipName_TextColour, &methods_wxGridCellAttr[11], &methods_wxGridCellAttr[34], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Overflow, &methods_wxGridCellAttr[8], &methods_wxGridCellAttr[30], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Kind, &methods_wxGridCellAttr[6], &methods_wxGridCellAttr[29], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Font, &methods_wxGridCellAttr[5], &methods_wxGridCellAttr[28], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_BackgroundColour, &methods_wxGridCellAttr[3], &methods_wxGridCellAttr[25], SIP_NULLPTR, SIP_NULLPTR},
};
