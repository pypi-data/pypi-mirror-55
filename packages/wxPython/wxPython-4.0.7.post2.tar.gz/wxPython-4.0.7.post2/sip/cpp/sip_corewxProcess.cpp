...
void sipwxProcess::OnTerminate(int pid,int status)
{
    ...
    sipVH__core_118(sipGILState, 0, sipPySelf, sipMeth, pid, status);
}
...
static sipEncodedTypeDef supers_wxProcess[] = {{147, 255, 1}};
...
sipVariableDef variables_wxProcess[] = {
    {PropertyVariable, sipName_Pid, &methods_wxProcess[6], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_OutputStream, &methods_wxProcess[5], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_InputStream, &methods_wxProcess[4], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ErrorStream, &methods_wxProcess[3], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
