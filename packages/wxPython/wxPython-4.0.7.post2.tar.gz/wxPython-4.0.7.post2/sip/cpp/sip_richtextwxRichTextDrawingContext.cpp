...
static sipEncodedTypeDef supers_wxRichTextDrawingContext[] = {{41, 0, 1}};
...
sipVariableDef variables_wxRichTextDrawingContext[] = {
    {PropertyVariable, sipName_VirtualAttributesEnabled, &methods_wxRichTextDrawingContext[3], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
