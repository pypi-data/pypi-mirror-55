...
static sipEncodedTypeDef supers_wxKeyEvent[] = {{140, 255, 0}, {278, 255, 1}};
...
sipVariableDef variables_wxKeyEvent[] = {
    {PropertyVariable, sipName_UnicodeKey, &methods_wxKeyEvent[6], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_RawKeyFlags, &methods_wxKeyEvent[5], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_RawKeyCode, &methods_wxKeyEvent[4], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Position, &methods_wxKeyEvent[3], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_KeyCode, &methods_wxKeyEvent[2], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
