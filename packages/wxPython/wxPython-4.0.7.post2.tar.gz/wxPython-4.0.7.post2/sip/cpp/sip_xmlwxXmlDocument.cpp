...
sipVariableDef variables_wxXmlDocument[] = {
    {PropertyVariable, sipName_Version, &methods_wxXmlDocument[7], &methods_wxXmlDocument[14], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Root, &methods_wxXmlDocument[6], &methods_wxXmlDocument[13], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FileEncoding, &methods_wxXmlDocument[4], &methods_wxXmlDocument[12], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DocumentNode, &methods_wxXmlDocument[3], &methods_wxXmlDocument[11], SIP_NULLPTR, SIP_NULLPTR},
};
