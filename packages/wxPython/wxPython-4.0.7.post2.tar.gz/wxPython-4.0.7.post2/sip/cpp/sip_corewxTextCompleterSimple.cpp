...
void sipwxTextCompleterSimple::GetCompletions(const  ::wxString& prefix, ::wxArrayString& res)
{
    ...
    extern void sipVH__core_149(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxString&, ::wxArrayString&);

    sipVH__core_149(sipGILState, 0, sipPySelf, sipMeth, prefix, res);
}
