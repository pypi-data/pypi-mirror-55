...
sipwxGenericDirCtrl::sipwxGenericDirCtrl( ::wxWindow*parent,const  ::wxWindowID id,const  ::wxString& dir,const  ::wxPoint& pos,const  ::wxSize& size,long style,const  ::wxString& filter,int defaultFilter,const  ::wxString& name):  ::wxGenericDirCtrl(parent,id,dir,pos,size,style,filter,defaultFilter,name), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
static sipEncodedTypeDef supers_wxGenericDirCtrl[] = {{89, 255, 1}};
