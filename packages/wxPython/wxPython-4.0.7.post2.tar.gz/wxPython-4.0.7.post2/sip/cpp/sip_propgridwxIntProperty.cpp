...
static PyObject *meth_wxIntProperty_DoValidation(PyObject *, PyObject *sipArgs, PyObject *sipKwds)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_IntProperty, sipName_DoValidation, SIP_NULLPTR);
...
static PyMethodDef methods_wxIntProperty[] = {
    ...
    {SIP_MLNAME_CAST(sipName_DoValidation), SIP_MLMETH_CAST(meth_wxIntProperty_DoValidation), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxIntProperty_DoValidation)},
