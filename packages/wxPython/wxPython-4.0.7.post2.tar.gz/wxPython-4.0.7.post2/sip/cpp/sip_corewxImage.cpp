...
sipVariableDef variables_wxImage[] = {
    {PropertyVariable, sipName_Type, &methods_wxImage[39], &methods_wxImage[74], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MaskRed, &methods_wxImage[31], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MaskGreen, &methods_wxImage[30], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_MaskBlue, &methods_wxImage[29], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Height, &methods_wxImage[26], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Width, &methods_wxImage[40], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
