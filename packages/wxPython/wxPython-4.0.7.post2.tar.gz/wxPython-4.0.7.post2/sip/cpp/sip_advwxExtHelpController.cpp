...
bool sipwxExtHelpController::Initialize(const  ::wxString& dir)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[1],sipPySelf,SIP_NULLPTR,sipName_Initialize);
...
bool sipwxExtHelpController::DisplayBlock(long blockNo)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[2],sipPySelf,SIP_NULLPTR,sipName_DisplayBlock);
...
bool sipwxExtHelpController::DisplayContents()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[3],sipPySelf,SIP_NULLPTR,sipName_DisplayContents);
...
bool sipwxExtHelpController::DisplayContextPopup(int contextId)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[4],sipPySelf,SIP_NULLPTR,sipName_DisplayContextPopup);
...
bool sipwxExtHelpController::DisplaySection(int sectionNo)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[6],sipPySelf,SIP_NULLPTR,sipName_DisplaySection);
...
bool sipwxExtHelpController::DisplayTextPopup(const  ::wxString& text,const  ::wxPoint& pos)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[7],sipPySelf,SIP_NULLPTR,sipName_DisplayTextPopup);
 ...
 ::wxFrame* sipwxExtHelpController::GetFrameParameters( ::wxSize*size, ::wxPoint*pos,bool*newFrameEachTime)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[8],sipPySelf,SIP_NULLPTR,sipName_GetFrameParameters);
 ...
 ::wxWindow* sipwxExtHelpController::GetParentWindow() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[9]),sipPySelf,SIP_NULLPTR,sipName_GetParentWindow);
...
static sipEncodedTypeDef supers_wxExtHelpController[] = {{25, 0, 1}};
