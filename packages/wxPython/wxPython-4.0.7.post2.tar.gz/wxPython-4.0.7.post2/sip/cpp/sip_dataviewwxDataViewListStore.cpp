...
protected:
    ...
    void GetValueByRow( ::wxDVCVariant&,uint,uint) const SIP_OVERRIDE;
...
bool sipwxDataViewListStore::SetValueByRow(const  ::wxDVCVariant& value,uint row,uint col)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[0],sipPySelf,SIP_NULLPTR,sipName_SetValueByRow);
...
void sipwxDataViewListStore::GetValueByRow( ::wxDVCVariant& value,uint row,uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[1]),sipPySelf,SIP_NULLPTR,sipName_GetValueByRow);
...
uint sipwxDataViewListStore::GetRow(const  ::wxDataViewItem& item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[2]),sipPySelf,SIP_NULLPTR,sipName_GetRow);
...
uint sipwxDataViewListStore::GetCount() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[3]),sipPySelf,SIP_NULLPTR,sipName_GetCount);
...
bool sipwxDataViewListStore::IsEnabledByRow(uint row,uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[4]),sipPySelf,SIP_NULLPTR,sipName_IsEnabledByRow);
...
bool sipwxDataViewListStore::GetAttrByRow(uint row,uint col, ::wxDataViewItemAttr& attr) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[5]),sipPySelf,SIP_NULLPTR,sipName_GetAttrByRow);
...
int sipwxDataViewListStore::Compare(const  ::wxDataViewItem& item1,const  ::wxDataViewItem& item2,uint column,bool ascending) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[6]),sipPySelf,SIP_NULLPTR,sipName_Compare);
...
bool sipwxDataViewListStore::GetAttr(const  ::wxDataViewItem& item,uint col, ::wxDataViewItemAttr& attr) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[7]),sipPySelf,SIP_NULLPTR,sipName_GetAttr);
...
bool sipwxDataViewListStore::IsEnabled(const  ::wxDataViewItem& item,uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[8]),sipPySelf,SIP_NULLPTR,sipName_IsEnabled);
...
uint sipwxDataViewListStore::GetChildren(const  ::wxDataViewItem& item, ::wxDataViewItemArray& children) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[9]),sipPySelf,SIP_NULLPTR,sipName_GetChildren);
...
uint sipwxDataViewListStore::GetColumnCount() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[10]),sipPySelf,SIP_NULLPTR,sipName_GetColumnCount);
 ...
 ::wxString sipwxDataViewListStore::GetColumnType(uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[11]),sipPySelf,SIP_NULLPTR,sipName_GetColumnType);
 ...
 ::wxDataViewItem sipwxDataViewListStore::GetParent(const  ::wxDataViewItem& item) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[12]),sipPySelf,SIP_NULLPTR,sipName_GetParent);
...
void sipwxDataViewListStore::GetValue( ::wxDVCVariant& variant,const  ::wxDataViewItem& item,uint col) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[13]),sipPySelf,SIP_NULLPTR,sipName_GetValue);
