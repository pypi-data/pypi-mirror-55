...
void sipwxClipboard::UsePrimarySelection(bool primary)
{
    ...
    sipVH__core_84(sipGILState, 0, sipPySelf, sipMeth, primary);
}
...
bool sipwxClipboard::SetData( ::wxDataObject*data)
{
    ...
    extern bool sipVH__core_81(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDataObject*);

    return sipVH__core_81(sipGILState, 0, sipPySelf, sipMeth, data);
}
...
bool sipwxClipboard::IsSupported(const  ::wxDataFormat& format)
{
    ...
    extern bool sipVH__core_83(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxDataFormat&);

    return sipVH__core_83(sipGILState, 0, sipPySelf, sipMeth, format);
}
...
bool sipwxClipboard::GetData( ::wxDataObject& data)
{
    ...
    extern bool sipVH__core_82(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDataObject&);

    return sipVH__core_82(sipGILState, 0, sipPySelf, sipMeth, data);
}
