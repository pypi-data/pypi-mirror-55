...
bool sipwxFileSystemWatcher::RemoveTree(const  ::wxFileName& path)
{
    ...
    extern bool sipVH__core_226(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFileName&);

    return sipVH__core_226(sipGILState, 0, sipPySelf, sipMeth, path);
}
...
bool sipwxFileSystemWatcher::AddTree(const  ::wxFileName& path,int events,const  ::wxString& filter)
{
    ...
    extern bool sipVH__core_225(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFileName&,int,const  ::wxString&);

    return sipVH__core_225(sipGILState, 0, sipPySelf, sipMeth, path, events, filter);
}
...
bool sipwxFileSystemWatcher::Add(const  ::wxFileName& path,int events)
{
    ...
    extern bool sipVH__core_224(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxFileName&,int);

    return sipVH__core_224(sipGILState, 0, sipPySelf, sipMeth, path, events);
}
...
static sipEncodedTypeDef supers_wxFileSystemWatcher[] = {{147, 255, 1}};
