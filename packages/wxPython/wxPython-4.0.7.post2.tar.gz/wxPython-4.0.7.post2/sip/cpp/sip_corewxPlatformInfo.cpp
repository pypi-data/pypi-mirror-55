...
static PyObject *meth_wxPlatformInfo_SetOSVersion(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Bii", &sipSelf, sipType_wxPlatformInfo, &sipCpp, &major, &minor))
        {
            PyErr_Clear();
...
sipVariableDef variables_wxPlatformInfo[] = {
    {PropertyVariable, sipName_ToolkitMinorVersion, &methods_wxPlatformInfo[21], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ToolkitMajorVersion, &methods_wxPlatformInfo[20], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PortIdShortName, &methods_wxPlatformInfo[19], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PortIdName, &methods_wxPlatformInfo[18], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PortId, &methods_wxPlatformInfo[17], &methods_wxPlatformInfo[31], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_OperatingSystemIdName, &methods_wxPlatformInfo[16], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_OperatingSystemId, &methods_wxPlatformInfo[15], &methods_wxPlatformInfo[30], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_OperatingSystemFamilyName, &methods_wxPlatformInfo[14], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_OperatingSystemDescription, &methods_wxPlatformInfo[12], &methods_wxPlatformInfo[29], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_OSMinorVersion, &methods_wxPlatformInfo[11], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_OSMajorVersion, &methods_wxPlatformInfo[10], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_LinuxDistributionInfo, &methods_wxPlatformInfo[9], &methods_wxPlatformInfo[27], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_EndiannessName, &methods_wxPlatformInfo[8], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Endianness, &methods_wxPlatformInfo[7], &methods_wxPlatformInfo[26], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_DesktopEnvironment, &methods_wxPlatformInfo[6], &methods_wxPlatformInfo[25], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Architecture, &methods_wxPlatformInfo[5], &methods_wxPlatformInfo[24], SIP_NULLPTR, SIP_NULLPTR},
