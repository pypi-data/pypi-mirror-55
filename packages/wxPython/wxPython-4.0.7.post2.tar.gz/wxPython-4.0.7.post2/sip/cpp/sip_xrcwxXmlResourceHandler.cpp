...
sipVariableDef variables_wxXmlResourceHandler[] = {
    {PropertyVariable, sipName_Style, &methods_wxXmlResourceHandler[34], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Size, &methods_wxXmlResourceHandler[33], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Resource, &methods_wxXmlResourceHandler[32], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Position, &methods_wxXmlResourceHandler[31], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ParentAsWindow, &methods_wxXmlResourceHandler[30], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Parent, &methods_wxXmlResourceHandler[29], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
