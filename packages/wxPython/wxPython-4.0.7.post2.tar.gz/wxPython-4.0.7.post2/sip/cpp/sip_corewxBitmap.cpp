...
static sipEncodedTypeDef supers_wxBitmap[] = {{204, 255, 1}};
...
sipVariableDef variables_wxBitmap[] = {
    {PropertyVariable, sipName_Width, &methods_wxBitmap[17], &methods_wxBitmap[29], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Size, &methods_wxBitmap[15], &methods_wxBitmap[28], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Palette, &methods_wxBitmap[14], &methods_wxBitmap[27], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Mask, &methods_wxBitmap[13], &methods_wxBitmap[25], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Height, &methods_wxBitmap[12], &methods_wxBitmap[24], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Handle, &methods_wxBitmap[11], &methods_wxBitmap[23], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Depth, &methods_wxBitmap[10], &methods_wxBitmap[22], SIP_NULLPTR, SIP_NULLPTR},
};
