...
void sipwxCommandProcessor::Store( ::wxCommand*command)
{
    ...
    extern void sipVH__core_223(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxCommand*);

    sipVH__core_223(sipGILState, 0, sipPySelf, sipMeth, command);
}
...
bool sipwxCommandProcessor::Submit( ::wxCommand*command,bool storeIt)
{
    ...
    extern bool sipVH__core_222(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxCommand*,bool);

    return sipVH__core_222(sipGILState, 0, sipPySelf, sipMeth, command, storeIt);
}
