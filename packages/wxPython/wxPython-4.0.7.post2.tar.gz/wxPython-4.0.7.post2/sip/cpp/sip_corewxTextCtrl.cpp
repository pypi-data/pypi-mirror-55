...
static sipEncodedTypeDef supers_wxTextCtrl[] = {{89, 255, 0}, {525, 255, 1}};
...
sipVariableDef variables_wxTextCtrl[] = {
    ...
    {PropertyVariable, sipName_DefaultStyle, &methods_wxTextCtrl[26], &methods_wxTextCtrl[54], SIP_NULLPTR, SIP_NULLPTR},
};
