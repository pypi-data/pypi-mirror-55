...
bool sipwxGUIEventLoop::YieldFor(long eventsToProcess)
{
    ...
    extern bool sipVH__core_101(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, long);

    return sipVH__core_101(sipGILState, 0, sipPySelf, sipMeth, eventsToProcess);
}
...
void sipwxGUIEventLoop::Exit(int rc)
{
    ...
    sipVH__core_98(sipGILState, 0, sipPySelf, sipMeth, rc);
}
...
int sipwxGUIEventLoop::DispatchTimeout(unsigned long timeout)
{
    ...
    extern int sipVH__core_99(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, unsigned long);

    return sipVH__core_99(sipGILState, 0, sipPySelf, sipMeth, timeout);
}
...
void sipwxGUIEventLoop::WakeUpIdle()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[9],sipPySelf,SIP_NULLPTR,sipName_WakeUpIdle);
...
bool sipwxGUIEventLoop::ProcessIdle()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[10],sipPySelf,SIP_NULLPTR,sipName_ProcessIdle);
...
bool sipwxGUIEventLoop::IsYielding() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[11]),sipPySelf,SIP_NULLPTR,sipName_IsYielding);
...
bool sipwxGUIEventLoop::IsEventAllowedInsideYield( ::wxEventCategory cat) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[12]),sipPySelf,SIP_NULLPTR,sipName_IsEventAllowedInsideYield);

    if (!sipMeth)
        return  ::wxGUIEventLoop::IsEventAllowedInsideYield(cat);

    extern bool sipVH__core_100(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxEventCategory);

    return sipVH__core_100(sipGILState, 0, sipPySelf, sipMeth, cat);
}
...
void sipwxGUIEventLoop::OnExit()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[13],sipPySelf,SIP_NULLPTR,sipName_OnExit);
...
static sipEncodedTypeDef supers_wxGUIEventLoop[] = {{145, 255, 1}};
