...
static PyObject *meth_wxToolBar_GetToolByPos(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Bi", &sipSelf, sipType_wxToolBar, &sipCpp, &pos))
        {
            ...
            return sipConvertFromType(const_cast< ::wxToolBarToolBase *>(sipRes),sipType_wxToolBarToolBase,SIP_NULLPTR);
        }
    }
...
static sipEncodedTypeDef supers_wxToolBar[] = {{89, 255, 1}};
...
sipVariableDef variables_wxToolBar[] = {
    {PropertyVariable, sipName_ToolsCount, &methods_wxToolBar[50], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ToolSize, &methods_wxToolBar[48], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ToolSeparation, &methods_wxToolBar[46], &methods_wxToolBar[75], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ToolPacking, &methods_wxToolBar[44], &methods_wxToolBar[74], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ToolBitmapSize, &methods_wxToolBar[39], &methods_wxToolBar[69], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Margins, &methods_wxToolBar[38], &methods_wxToolBar[68], SIP_NULLPTR, SIP_NULLPTR},
};
