...
sipVariableDef variables_wxColourData[] = {
    {PropertyVariable, sipName_Colour, &methods_wxColourData[2], &methods_wxColourData[5], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ChooseFull, &methods_wxColourData[1], &methods_wxColourData[4], SIP_NULLPTR, SIP_NULLPTR},
};
