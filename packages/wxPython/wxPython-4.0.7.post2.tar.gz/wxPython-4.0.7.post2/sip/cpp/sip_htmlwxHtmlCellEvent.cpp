 ...
 ::wxEventCategory sipwxHtmlCellEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__html_54(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxEvent* sipwxHtmlCellEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__html_53(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__html_53(sipGILState, 0, sipPySelf, sipMeth);
}
