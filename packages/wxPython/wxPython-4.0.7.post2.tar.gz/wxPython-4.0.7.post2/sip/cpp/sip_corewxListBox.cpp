...
static sipEncodedTypeDef supers_wxListBox[] = {{89, 255, 0}, {269, 255, 1}};
...
sipVariableDef variables_wxListBox[] = {
    {PropertyVariable, sipName_Selections, &methods_wxListBox[30], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Selection, &methods_wxListBox[29], &methods_wxListBox[50], SIP_NULLPTR, SIP_NULLPTR},
