...
static sipEncodedTypeDef supers_wxFileDialog[] = {{120, 255, 1}};
...
sipVariableDef variables_wxFileDialog[] = {
    {PropertyVariable, sipName_Wildcard, &methods_wxFileDialog[34], &methods_wxFileDialog[50], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Paths, &methods_wxFileDialog[32], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Path, &methods_wxFileDialog[31], &methods_wxFileDialog[48], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Message, &methods_wxFileDialog[30], &methods_wxFileDialog[47], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_FilterIndex, &methods_wxFileDialog[28], &methods_wxFileDialog[46], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Filenames, &methods_wxFileDialog[27], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Filename, &methods_wxFileDialog[26], &methods_wxFileDialog[45], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ExtraControl, &methods_wxFileDialog[25], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Directory, &methods_wxFileDialog[24], &methods_wxFileDialog[44], SIP_NULLPTR, SIP_NULLPTR},
