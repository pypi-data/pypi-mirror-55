...
bool sipwxTimer::Start(int milliseconds,bool oneShot)
{
    ...
    extern bool sipVH__core_109(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, int,bool);

    return sipVH__core_109(sipGILState, 0, sipPySelf, sipMeth, milliseconds, oneShot);
}
...
static sipEncodedTypeDef supers_wxTimer[] = {{147, 255, 1}};
