...
void sipwxComboCtrl::DoShowPopup(const  ::wxRect& rect,int flags)
{
    ...
    extern void sipVH__core_171(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxRect&,int);

    sipVH__core_171(sipGILState, 0, sipPySelf, sipMeth, rect, flags);
}
...
void sipwxComboCtrl::DoSetPopupControl( ::wxComboPopup*popup)
{
    ...
    extern void sipVH__core_170(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxComboPopup*);

    sipVH__core_170(sipGILState, 0, sipPySelf, sipMeth, popup);
}
...
bool sipwxComboCtrl::AnimateShow(const  ::wxRect& rect,int flags)
{
    ...
    extern bool sipVH__core_169(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxRect&,int);

    return sipVH__core_169(sipGILState, 0, sipPySelf, sipMeth, rect, flags);
}
...
void sipwxComboCtrl::HidePopup(bool generateEvent)
{
    ...
    sipVH__core_84(sipGILState, 0, sipPySelf, sipMeth, generateEvent);
}
...
bool sipwxComboCtrl::IsKeyPopupToggle(const  ::wxKeyEvent& event) const
{
    ...
    extern bool sipVH__core_168(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxKeyEvent&);

    return sipVH__core_168(sipGILState, 0, sipPySelf, sipMeth, event);
}
...
static PyObject *meth_wxComboCtrl_GetTextIndent(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboCtrl, sipName_GetTextIndent, SIP_NULLPTR);
...
static PyObject *meth_wxComboCtrl_SetTextIndent(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Bi", &sipSelf, sipType_wxComboCtrl, &sipCpp, &indent))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_ComboCtrl, sipName_SetTextIndent, SIP_NULLPTR);
...
static sipEncodedTypeDef supers_wxComboCtrl[] = {{89, 255, 0}, {525, 255, 1}};
...
static PyMethodDef methods_wxComboCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SetTextIndent), SIP_MLMETH_CAST(meth_wxComboCtrl_SetTextIndent), METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxComboCtrl_SetTextIndent)},
...
sipVariableDef variables_wxComboCtrl[] = {
    {PropertyVariable, sipName_Value, &methods_wxComboCtrl[49], &methods_wxComboCtrl[86], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TextRect, &methods_wxComboCtrl[47], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_TextIndent, &methods_wxComboCtrl[46], &methods_wxComboCtrl[84], SIP_NULLPTR, SIP_NULLPTR},
    ...
    {PropertyVariable, sipName_InsertionPoint, &methods_wxComboCtrl[39], &methods_wxComboCtrl[73], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Hint, &methods_wxComboCtrl[38], &methods_wxComboCtrl[72], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CustomPaintWidth, &methods_wxComboCtrl[34], &methods_wxComboCtrl[71], SIP_NULLPTR, SIP_NULLPTR},
