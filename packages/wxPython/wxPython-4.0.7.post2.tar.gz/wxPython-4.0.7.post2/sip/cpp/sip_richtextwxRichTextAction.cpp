...
static PyObject *meth_wxRichTextAction_UpdateAppearance(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Bl|bJ0J0b", &sipSelf, sipType_wxRichTextAction, &sipCpp, &caretPosition, &sendUpdateEvent, sipType_wxArrayInt,&optimizationLineCharPositions, &optimizationLineCharPositionsState, sipType_wxArrayInt,&optimizationLineYPositions, &optimizationLineYPositionsState, &isDoCmd))
        {
            PyErr_Clear();
...
static PyObject *meth_wxRichTextAction_CalculateRefreshOptimizations(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BJ1J1", &sipSelf, sipType_wxRichTextAction, &sipCpp, sipType_wxArrayInt,&optimizationLineCharPositions, &optimizationLineCharPositionsState, sipType_wxArrayInt,&optimizationLineYPositions, &optimizationLineYPositionsState))
        {
            PyErr_Clear();
...
static sipEncodedTypeDef supers_wxRichTextAction[] = {{41, 0, 1}};
