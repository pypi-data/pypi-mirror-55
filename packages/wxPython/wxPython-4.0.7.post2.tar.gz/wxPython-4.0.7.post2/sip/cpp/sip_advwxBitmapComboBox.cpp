...
static PyObject *meth_wxBitmapComboBox_SetString(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "BuJ1", &sipSelf, sipType_wxBitmapComboBox, &sipCpp, &n, sipType_wxString,&s, &sState))
        {
            PyErr_Clear();
...
static sipEncodedTypeDef supers_wxBitmapComboBox[] = {{13, 0, 0}, {52, 0, 0}, {30, 0, 1}};
...
sipVariableDef variables_wxBitmapComboBox[] = {
    {PropertyVariable, sipName_BitmapSize, &methods_wxBitmapComboBox[21], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
