...
sipVariableDef variables_wxWebView[] = {
    {PropertyVariable, sipName_ZoomType, &methods_wxWebView[36], &methods_wxWebView[63], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_Zoom, &methods_wxWebView[35], &methods_wxWebView[62], SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedText, &methods_wxWebView[33], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_SelectedSource, &methods_wxWebView[32], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PageText, &methods_wxWebView[31], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_PageSource, &methods_wxWebView[30], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_NativeBackend, &methods_wxWebView[29], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_ForwardHistory, &methods_wxWebView[27], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CurrentURL, &methods_wxWebView[26], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_CurrentTitle, &methods_wxWebView[25], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {PropertyVariable, sipName_BackwardHistory, &methods_wxWebView[22], SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
