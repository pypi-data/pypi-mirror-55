...
void sipwxBitmapDataObject::SetBitmap(const  ::wxBitmap& bitmap)
{
    ...
    extern void sipVH__core_70(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxBitmap&);

    sipVH__core_70(sipGILState, 0, sipPySelf, sipMeth, bitmap);
}
 ...
 ::wxBitmap sipwxBitmapDataObject::GetBitmap() const
{
    ...
    extern  ::wxBitmap sipVH__core_69(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_69(sipGILState, 0, sipPySelf, sipMeth);
}
...
bool sipwxBitmapDataObject::SetData(const  ::wxDataFormat& format,size_t len,const void*buf)
{
    ...
    extern bool sipVH__core_68(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxDataFormat&,size_t,const void*);

    return sipVH__core_68(sipGILState, 0, sipPySelf, sipMeth, format, len, buf);
}
 ...
 ::wxDataFormat sipwxBitmapDataObject::GetPreferredFormat( ::wxDataObject::Direction dir) const
{
    ...
    extern  ::wxDataFormat sipVH__core_57(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDataObject::Direction);

    return sipVH__core_57(sipGILState, 0, sipPySelf, sipMeth, dir);
}
...
size_t sipwxBitmapDataObject::GetFormatCount( ::wxDataObject::Direction dir) const
{
    ...
    extern size_t sipVH__core_56(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDataObject::Direction);

    return sipVH__core_56(sipGILState, 0, sipPySelf, sipMeth, dir);
}
...
void sipwxBitmapDataObject::GetAllFormats( ::wxDataFormat*formats, ::wxDataObject::Direction dir) const
{
    ...
    extern void sipVH__core_53(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxDataFormat*, ::wxDataObject::Direction);

    sipVH__core_53(sipGILState, 0, sipPySelf, sipMeth, formats, dir);
}
...
bool sipwxBitmapDataObject::GetDataHere(void*buf) const
{
    ...
    extern bool sipVH__core_65(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, void*);

    return sipVH__core_65(sipGILState, 0, sipPySelf, sipMeth, buf);
}
...
bool sipwxBitmapDataObject::SetData(size_t len,const void*buf)
{
    ...
    extern bool sipVH__core_64(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, size_t,const void*);

    return sipVH__core_64(sipGILState, 0, sipPySelf, sipMeth, len, buf);
}
...
static sipEncodedTypeDef supers_wxBitmapDataObject[] = {{106, 255, 1}};
