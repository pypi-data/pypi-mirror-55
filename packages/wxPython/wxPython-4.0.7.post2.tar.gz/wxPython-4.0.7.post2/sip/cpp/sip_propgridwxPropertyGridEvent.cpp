 ...
 ::wxEventCategory sipwxPropertyGridEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__propgrid_56(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxEvent* sipwxPropertyGridEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__propgrid_55(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__propgrid_55(sipGILState, 0, sipPySelf, sipMeth);
}
...
static PyObject *meth_wxPropertyGridEvent_SetValidationFailureBehavior(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "Bc", &sipSelf, sipType_wxPropertyGridEvent, &sipCpp, &flags))
        {
            PyErr_Clear();
