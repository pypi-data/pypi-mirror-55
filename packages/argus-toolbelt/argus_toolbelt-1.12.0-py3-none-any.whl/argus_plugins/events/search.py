...
def search(start: date_or_relative, end: date_or_relative,
           ...
           event_match_properties: bool = True,
    ...
    :param event_match_properties: Exact match of properties specified at the top level
    ...
    events = find_aggregated_events(
        ...
        eventMatchProperties=event_match_properties,
        **parameters
    )["data"]
