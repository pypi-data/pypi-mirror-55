...
class Request(models.Model):
    ...
    get_params = models.CharField(max_length=512, blank=True, default="")
    post_params = jsonfield.JSONField(blank=True, null=True, default="{}")
    ...
    def from_http_request(self, request, response=None, commit=True):
        ...
        # Save get and post params
        self.get_params = "&".join([f"{k}={v}" for k, v in request.GET.items()])[:500]
        try:
