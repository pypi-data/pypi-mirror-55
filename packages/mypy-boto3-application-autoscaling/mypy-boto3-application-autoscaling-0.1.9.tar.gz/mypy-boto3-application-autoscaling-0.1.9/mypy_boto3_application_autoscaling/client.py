...
class Client(BaseClient):
    ...
    def delete_scaling_policy(
        ...
        For more information, see `Delete a Step Scaling Policy <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-step-scaling-policies.html#delete-step-scaling-policy>`__ and `Delete a Target Tracking Scaling Policy <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-target-tracking.html#delete-target-tracking-policy>`__ in the *Application Auto Scaling User Guide* .
    ...
    def delete_scheduled_action(
        ...
        For more information, see `Delete a Scheduled Action <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-scheduled-scaling.html#delete-scheduled-action>`__ in the *Application Auto Scaling User Guide* .
              ...
              - *(dict) --*
                ...
                - **Schedule** *(string) --*
                  ...
                  * Cron expressions - "``cron(*fields* )`` "
                  ...
                  For more information about cron expressions, see `Cron Expressions <https://docs.aws.amazon.com/AmazonCloudWatch/latest/events/ScheduledEvents.html#CronExpressions>`__ in the *Amazon CloudWatch Events User Guide* .
    ...
    def put_scaling_policy(
        ...
        Learn more about how to work with scaling policies in the `Application Auto Scaling User Guide <https://docs.aws.amazon.com/autoscaling/application/userguide/what-is-application-auto-scaling.html>`__ .
        ...
        **Request Syntax**
        ...
        :param PolicyType:
          ...
          For more information, see `Target Tracking Scaling Policies <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-target-tracking.html>`__ and `Step Scaling Policies <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-step-scaling-policies.html>`__ in the *Application Auto Scaling User Guide* .
    ...
    def put_scheduled_action(
        ...
        Learn more about how to work with scheduled actions in the `Application Auto Scaling User Guide <https://docs.aws.amazon.com/autoscaling/application/userguide/what-is-application-auto-scaling.html>`__ .
        ...
        **Request Syntax**
        ...
        :param SuspendedState:
          ...
          * For ``ScheduledScalingSuspended`` , while a suspension is in effect, all scaling activities that involve scheduled actions are suspended.
          ...
          For more information, see `Suspend and Resume Application Auto Scaling <https://docs.aws.amazon.com/autoscaling/application/userguide/application-auto-scaling-suspend-resume-scaling.html>`__ in the *Application Auto Scaling User Guide* .
