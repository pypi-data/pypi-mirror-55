...
# Module information
name			=	"Polycephaly"
__version__		=	( '2019', '11', 'a1' )	# See https://packaging.python.org/guides/distributing-packages-using-setuptools/#standards-compliance-for-interoperability
	...
	setuptools.setup(
		...
		command_options					=	{
												'build_sphinx'	:	{
																		...
																		'source_dir'	:	( 'setup.py', os.path.join( 'docs', 'source', ) ),
