...
*percache* requires Python 3. Install with ``pip install percache``. It has no
dependencies outside the standard library.

.. image:: https://builds.sr.ht/~obensonne/percache.svg?search=0.4.3
   :target: https://builds.sr.ht/~obensonne/percache?search=0.4.3
...
- Update docs due to project migration to `sourcehut`_.
- Discontinue Python 2 support.

.. _sourcehut: https://hg.sr.ht/~obensonne/percache
