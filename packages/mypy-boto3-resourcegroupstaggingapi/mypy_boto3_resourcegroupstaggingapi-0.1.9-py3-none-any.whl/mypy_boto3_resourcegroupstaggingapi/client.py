...
class Client(BaseClient):
    ...
    def tag_resources(
        ...
        * Not all resources can have tags. For a list of resources that support tagging, see `Supported Resources <http://docs.aws.amazon.com/ARG/latest/userguide/supported-resources.html>`__ in the *AWS Resource Groups User Guide* .
