...
class Ui_HemisphereDialog(object):
    def setupUi(self, HemisphereDialog):
        ...
        self.hemisphere2 = QtWidgets.QWidget(HemisphereDialog)
        self.hemisphere2.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.hemisphere2.sizePolicy().hasHeightForWidth())
        self.hemisphere2.setSizePolicy(sizePolicy)
        self.hemisphere2.setMinimumSize(QtCore.QSize(0, 270))
        self.hemisphere2.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.hemisphere2.setSizeIncrement(QtCore.QSize(10, 10))
        self.hemisphere2.setBaseSize(QtCore.QSize(10, 10))
        self.hemisphere2.setAutoFillBackground(True)
        self.hemisphere2.setStyleSheet("")
        self.hemisphere2.setObjectName("hemisphere2")
        self.horizontalLayout_2.addWidget(self.hemisphere2)
