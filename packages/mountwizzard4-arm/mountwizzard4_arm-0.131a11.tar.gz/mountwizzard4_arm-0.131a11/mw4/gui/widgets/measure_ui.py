...
class Ui_MeasureDialog(object):
    def setupUi(self, MeasureDialog):
        ...
        self.checkSaveCSV = QtWidgets.QCheckBox(self.timeGroup)
        self.checkSaveCSV.setObjectName("checkSaveCSV")
        self.gridLayout_2.addWidget(self.checkSaveCSV, 1, 0, 1, 1)
    ...
    def retranslateUi(self, MeasureDialog):
        ...
        self.checkSaveCSV.setText(_translate("MeasureDialog", "Save measures as CSV"))
