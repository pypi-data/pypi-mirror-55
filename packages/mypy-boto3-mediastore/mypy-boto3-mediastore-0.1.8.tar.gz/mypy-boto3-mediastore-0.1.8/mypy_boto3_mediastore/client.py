...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def delete_container_policy(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def delete_cors_policy(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def describe_container(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_container_policy(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_cors_policy(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def put_container_policy(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def start_access_logging(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def stop_access_logging(self) -> None:
        pass
