...
def find_fix(proc_region, ori_bam_path, out_bam_path, ref_fa_path, annot_bed, annot_exon,
             small_exon_size=80, flank_len=20, ignore_strand=True,
...
def run_multiprocess(
    ...
    small_exon_size=80, flank_len=20, ignore_strand=True, nprocess=1,
    ...
    con_args = (
        ...
        small_exon_size, flank_len, ignore_strand,
