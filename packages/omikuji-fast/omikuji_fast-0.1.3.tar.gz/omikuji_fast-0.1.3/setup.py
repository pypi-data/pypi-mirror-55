...
def build_native(spec):
    ...
    spec.add_cffi_module(
        module_path="omikuji_fast._libomikuji_fast",
        dylib=lambda: build.find_dylib("omikuji_fast", in_path="target/release"),
        header_filename=lambda: build.find_header(
            "omikuji_fast.h", in_path="target/include"
        ),
...
setup(
    ...
    python_requires=">=3.5",
    url="https://github.com/tomtung/omikuji_fast",
    license="MIT",
    packages=["omikuji_fast"],
