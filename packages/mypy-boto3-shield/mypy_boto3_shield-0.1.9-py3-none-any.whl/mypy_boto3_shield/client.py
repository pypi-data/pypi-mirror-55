...
class Client(BaseClient):
    ...
    def create_subscription(
        ...
        To use the services of the DRT, you must be subscribed to the `Business Support plan <https://aws.amazon.com/premiumsupport/business-support/>`__ or the `Enterprise Support plan <https://aws.amazon.com/premiumsupport/enterprise-support/>`__ .
