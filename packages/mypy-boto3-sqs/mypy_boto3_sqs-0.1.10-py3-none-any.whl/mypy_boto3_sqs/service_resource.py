...
import mypy_boto3_sqs.service_resource as mypy_boto3_sqs_scope


class ServiceResource(Boto3ServiceResource):
    def Message(
        self, queue_url: str, receipt_handle: str
    ) -> mypy_boto3_sqs_scope.Message:
        """
    ...
    def Queue(self, url: str) -> mypy_boto3_sqs_scope.Queue:
        """
...
class Queue(Boto3ServiceResource):
    ...
    ) -> List[mypy_boto3_sqs_scope.Message]:
        """
...
class queues(ResourceCollection):
    @classmethod
    def all(cls) -> List[mypy_boto3_sqs_scope.Queue]:
        """
    ...
    @classmethod
    def filter(cls, QueueNamePrefix: str = None) -> List[mypy_boto3_sqs_scope.Queue]:
        """
    ...
    @classmethod
    def limit(cls, count: int = None) -> List[mypy_boto3_sqs_scope.Queue]:
        """
    ...
    @classmethod
    def page_size(cls, count: int = None) -> List[mypy_boto3_sqs_scope.Queue]:
        """
...
class dead_letter_source_queues(ResourceCollection):
    ...
    @classmethod
    def filter(cls) -> List[mypy_boto3_sqs_scope.Queue]:
        """
        Creates an iterable of all Queue resources in the collection filtered by kwargs passed to method.
