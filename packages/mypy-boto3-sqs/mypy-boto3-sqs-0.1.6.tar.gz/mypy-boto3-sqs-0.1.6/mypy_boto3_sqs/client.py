...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def change_message_visibility(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_queue_attributes(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_queue_url(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_dead_letter_source_queues(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def list_queue_tags(self) -> None:
        pass
