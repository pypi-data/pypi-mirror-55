...
class ServiceResource(Boto3ServiceResource):
    queues: mypy_boto3_sqs_scope.queues
    ...
    # pylint: disable=arguments-differ
    def Queue(self, url: str = None) -> mypy_boto3_sqs_scope.Queue:
        pass
...
class Queue(Boto3ServiceResource):
    attributes: Dict[str, Any]
    url: str
    dead_letter_source_queues: mypy_boto3_sqs_scope.dead_letter_source_queues
    # pylint: disable=arguments-differ
