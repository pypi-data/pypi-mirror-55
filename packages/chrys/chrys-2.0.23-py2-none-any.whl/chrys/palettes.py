...
from chrys.data.bokeh_palettes import BOKEH_PALETTES_DATA, BOKEH_PALETTES, \
    BOKEH_PALETTES_DOCS_DATA, BOKEH_PALETTES_DOCS, BOKEH_CATEGORY_10, BOKEH_CATEGORY_20, \
    ...
    BOKEH_PU_OR, BOKEH_BR_BG, BOKEH_PR_GN, BOKEH_PI_YG, BOKEH_RD_BU, BOKEH_RD_GY, BOKEH_RD_YL_BU, \
    BOKEH_SPECTRAL, BOKEH_RD_YL_GN, BOKEH_INFERNO, BOKEH_MAGMA, BOKEH_PLASMA, BOKEH_VIRIDIS
from chrys.data.vega_palettes import VEGA_PALETTES_DATA, VEGA_PALETTES, VEGA_PALETTES_DOCS_DATA, \
    VEGA_PALETTES_DOCS, VEGA_CATEGORY_10, VEGA_CATEGORY_20, VEGA_CATEGORY_20_B, \
    VEGA_CATEGORY_20_C, VEGA_TABLEAU_10, VEGA_TABLEAU_20, VEGA_ACCENT, VEGA_DARK_2, VEGA_PAIRED, \
    VEGA_PASTEL_1, VEGA_PASTEL_2, VEGA_SET_1, VEGA_SET_2, VEGA_SET_3, VEGA_BLUES, VEGA_GREENS, \
    VEGA_GREYS, VEGA_ORANGES, VEGA_PURPLES, VEGA_REDS, VEGA_BLUE_GREEN, VEGA_BLUE_PURPLE, \
    VEGA_GREEN_BLUE, VEGA_ORANGE_RED, VEGA_PURPLE_BLUE, VEGA_PURPLE_BLUE_GREEN, VEGA_PURPLE_RED, \
    VEGA_RED_PURPLE, VEGA_YELLOW_GREEN, VEGA_YELLOW_ORANGE_BROWN, VEGA_YELLOW_ORANGE_RED, \
    VEGA_BLUE_ORANGE, VEGA_BROWN_BLUE_GREEN, VEGA_PURPLE_GREEN, VEGA_PURPLE_ORANGE, VEGA_RED_BLUE, \
    VEGA_RED_GREY, VEGA_YELLOW_GREEN_BLUE, VEGA_RED_YELLOW_BLUE, VEGA_RED_YELLOW_GREEN, \
    VEGA_PINK_YELLOW_GREEN, VEGA_SPECTRAL, VEGA_VIRIDIS, VEGA_MAGMA, VEGA_INFERNO, VEGA_PLASMA, \
    VEGA_RAINBOW, VEGA_SINEBOW, VEGA_BROWNS, VEGA_TEAL_BLUES, VEGA_TEALS, VEGA_WARM_GREYS, \
    VEGA_GOLD_GREEN, VEGA_GOLD_ORANGE, VEGA_GOLD_RED, VEGA_LIGHT_GREY_RED, VEGA_LIGHT_GREY_TEAL, \
    VEGA_LIGHT_MULTI, VEGA_LIGHT_ORANGE, VEGA_LIGHT_TEAL_BLUE, VEGA_DARK_BLUE, VEGA_DARK_GOLD, \
    VEGA_DARK_GREEN, VEGA_DARK_MULTI, VEGA_DARK_RED
...
def _get_docs_palette(name):
    ...
    if vendor == BOKEH:
        return BOKEH_PALETTES_DOCS_DATA[name]
    elif vendor == VEGA:
        return VEGA_PALETTES_DOCS_DATA[name]
    else:
        raise ValueError('Vendor "{}" not recognized'.format(vendor))
