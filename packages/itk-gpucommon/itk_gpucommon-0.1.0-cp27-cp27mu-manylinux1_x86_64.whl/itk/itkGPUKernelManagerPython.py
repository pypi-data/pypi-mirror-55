...
class itkGPUKernelManager(ITKCommonBasePython.itkLightObject):
    ...
    def LoadProgramFromFile(self, *args):
        """
    ...
    def LoadProgramFromString(self, *args):
        """
    ...
    def CreateKernel(self, kernelName):
    ...
    def GetKernelWorkGroupInfo(self, kernelIdx, paramName, value):
    ...
    def GetDeviceInfo(self, paramName, argSize, argValue):
    ...
    def SetKernelArg(self, kernelIdx, argIdx, argSize, argVal):
    ...
    def SetKernelArgWithChar(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithUChar(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithShort(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithUShort(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithInt(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithUInt(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithLongLong(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithULongLong(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithFloat(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithDouble(self, kernelIdx, argIdx, argVal):
    ...
    def SetKernelArgWithImage(self, kernelIdx, argIdx, manager):
    ...
    def LaunchKernel(self, kernelIdx, dim, globalWorkSize, localWorkSize):
    ...
    def LaunchKernel1D(self, kernelIdx, globalWorkSize, localWorkSize):
    ...
    def LaunchKernel2D(self, kernelIdx, globalWorkSizeX, globalWorkSizeY, localWorkSizeX, localWorkSizeY):
    ...
    def LaunchKernel3D(self, kernelIdx, globalWorkSizeX, globalWorkSizeY, globalWorkSizeZ, localWorkSizeX, localWorkSizeY, localWorkSizeZ):
...
def itkGPUKernelManager___New_orig__():
    """itkGPUKernelManager___New_orig__() -> itkGPUKernelManager_Pointer"""
    return _itkGPUKernelManagerPython.itkGPUKernelManager___New_orig__()

def itkGPUKernelManager_cast(obj):
