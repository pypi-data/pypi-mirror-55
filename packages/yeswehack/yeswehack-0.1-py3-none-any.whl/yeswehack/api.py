...
class YesWeHack(YwhApiObject):
    ...
    _attrs = [
        ...
        # Attr(name="verify", type_=bool, default=False),
        Attr(name="lazy", type_=bool, default=True),
        # Attr(name="headers", type_=dict, default={}),
    ...
    def __init__(self, verify=False, headers={}, totp_code=None, **kwargs):
        """
        Initialize YesWeHack api Client

        :param str username: If supplied set the username for login
        :param str password: If supplied set the password for login
        :param str api_url: api endpoint
        :param bool lazy: Minimize api call
        """
        logging.basicConfig()
    ...
    def _login(self, totp_code=None):
        ...
        :param str username: user to login
...
class Log(YwhApiObject):
    ...
    def __init__(self, ywh_api, lazy=False, **kwargs):
        if "author" in kwargs:  # Some old report don't have author field
