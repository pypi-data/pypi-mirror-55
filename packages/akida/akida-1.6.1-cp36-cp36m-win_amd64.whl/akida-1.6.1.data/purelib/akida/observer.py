...
class Observer(object):
    '''
    Container attached to a ``Layer`` that allows to retrieve output spikes and
    potentials.
    ...
    def __init__(self, layer):
        ...
        self._id = layer.register_observer(observer)
        self._spikes = {}
        self._potentials = {}
    ...
    @property
    def layer(self):
        """Get a reference to the layer this object is attached to.
