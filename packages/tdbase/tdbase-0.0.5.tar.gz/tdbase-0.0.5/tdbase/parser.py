...
#                    prevLine = li
    ...
    def match_record_directive(self):
        self.lookaheadType()
        ...
        directive = nodes.NodeRecordDirective(preComments, self.lines[self.currentLineIdx], self.parser)
        self.currentLineIdx += 1
    ...
    def matchRecord(self):
        ...
        while self.match_record_directive():    # note that the function does the look-ahead
            record.directives.append(self.match)
