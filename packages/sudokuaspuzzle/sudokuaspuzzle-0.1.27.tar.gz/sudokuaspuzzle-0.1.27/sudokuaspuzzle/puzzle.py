...
class APuzzle():
    def __init__(self,  puzzle_string=None,
        ...
        if trigger_refresh:
            ...
            sys.exit(-1)
            #self.trigger_refresh = self.dummy_method
    ...
    # def set_cells_from_history(self):
        # """ Set the cell value based on what position is in history.

        # Check the puzzle for duplicates and trigger refresh of board.
        # """
        # for acounter in range(self.history_position):
            # amove = self.history[acounter]
            # the_cell = amove[0]
