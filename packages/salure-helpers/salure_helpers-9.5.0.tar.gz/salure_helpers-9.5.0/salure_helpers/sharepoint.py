...
class UploadFilesToSharepoint():
    ...
    def upload_files(self, filename):
        ...
        url = f'https://graph.microsoft.com/v1.0/sites/{self.site},{self.siteid}/drives/{driveid}/root:/UploadFiles/{filename}:/createUploadSession'
        headers = {'Authorization': f'Bearer {access_token}'}
