...
class Client(BaseClient):
    ...
    def create_activation(
        ...
        """
        Registers your on-premises server or virtual machine with Amazon EC2 so that you can manage these resources using Run Command. An on-premises server or virtual machine that has been registered with EC2 is called a managed instance. For more information about activations, see `Setting Up AWS Systems Manager for Hybrid Environments <http://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-managedinstances.html>`__ .
    ...
    def create_ops_item(
        ...
        """
        Creates a new OpsItem. You must have permission in AWS Identity and Access Management (IAM) to create a new OpsItem. For more information, see `Getting Started with OpsCenter <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html>`__ in the *AWS Systems Manager User Guide* .

        Operations engineers and IT professionals use OpsCenter to view, investigate, and remediate operational issues impacting the performance and health of their AWS resources. For more information, see `AWS Systems Manager OpsCenter <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html>`__ in the *AWS Systems Manager User Guide* .
        ...
        **Request Syntax**
        ...
        :param OperationalData:
          ...
          Use the ``/aws/resources`` key in OperationalData to specify a related resource in the request. Use the ``/aws/automations`` key in OperationalData to associate an Automation runbook with the OpsItem. To view AWS CLI example commands that use these keys, see `Creating OpsItems Manually <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-creating-OpsItems.html#OpsCenter-manually-create-OpsItems>`__ in the *AWS Systems Manager User Guide* .
        ...
        :param Tags:
          ...
          Optional metadata that you assign to a resource. You can restrict access to OpsItems by using an inline IAM policy that specifies tags. For more information, see `Getting Started with OpsCenter <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html#OpsCenter-getting-started-user-permissions>`__ in the *AWS Systems Manager User Guide* .
    ...
    def create_resource_data_sync(
        ...
        By default, data is not encrypted in Amazon S3. We strongly recommend that you enable encryption in Amazon S3 to ensure secure data storage. We also recommend that you secure access to the Amazon S3 bucket by creating a restrictive bucket policy. For more information, see `Configuring Resource Data Sync for Inventory <http://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-inventory-datasync.html>`__ in the *AWS Systems Manager User Guide* .
            ...
            - **InventoryDeletions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DeletionSummary** *(dict) --*
                  ...
                  Information about the delete operation. For more information about this summary, see `Understanding the Delete Inventory Summary <http://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-inventory-custom.html#sysman-inventory-delete>`__ in the *AWS Systems Manager User Guide* .
              ...
              - **RunCommand** *(dict) --*
                ...
                - **NotificationConfig** *(dict) --*
                  ...
                  - **NotificationEvents** *(list) --*
                    ...
                    The different events for which you can receive notifications. These events include the following: All (events), InProgress, Success, TimedOut, Cancelled, Failed. To learn more about these events, see `Configuring Amazon SNS Notifications for AWS Systems Manager <http://docs.aws.amazon.com/systems-manager/latest/userguide/monitoring-sns-notifications.html>`__ in the *AWS Systems Manager User Guide* .
          ...
          - *(dict) --*
            ...
            - **OpsItem** *(dict) --*
              ...
              - **Status** *(string) --*
                ...
                The OpsItem status. Status can be ``Open`` , ``In Progress`` , or ``Resolved`` . For more information, see `Editing OpsItem Details <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-working-with-OpsItems-editing-details.html>`__ in the *AWS Systems Manager User Guide* .
              ...
              - *(dict) --*
                ...
                - **Policies** *(list) --*
                  ...
                  Information about the policies assigned to a parameter.
                   ...
                   `Working with Parameter Policies <https://docs.aws.amazon.com/systems-manager/latest/userguide/parameter-store-policies.html>`__ in the *AWS Systems Manager User Guide* .
        ...
        **Request Syntax**
        ...
        :param Tier:
          ...
          * More than 10,000 parameters already exist in your AWS account in the current Region.
          ...
          For more information about configuring the default tier option, see `Specifying a Default Parameter Tier <http://docs.aws.amazon.com/systems-manager/latest/userguide/ps-default-tier.html>`__ in the *AWS Systems Manager User Guide* .
        ...
        :param Policies:
          ...
          All existing policies are preserved until you send new policies or an empty policy. For more information about parameter policies, see `Working with Parameter Policies <http://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-paramstore-su-policies.html>`__ .
    ...
    def register_target_with_maintenance_window(
        ...
        **Request Syntax**
        ...
        :param Targets: **[REQUIRED]**
          ...
          For more information about these examples formats, including the best use case for each one, see `Examples: Register Targets with a Maintenance Window <https://docs.aws.amazon.com/systems-manager/latest/userguide/mw-cli-tutorial-targets-examples.html>`__ in the *AWS Systems Manager User Guide* .
    ...
    def register_task_with_maintenance_window(
        ...
        **Request Syntax**
        ...
        :param ServiceRoleArn:
          ...
          * `Service-Linked Role Permissions for Systems Manager <http://docs.aws.amazon.com/systems-manager/latest/userguide/using-service-linked-roles.html#slr-permissions>`__

          * `Should I Use a Service-Linked Role or a Custom Service Role to Run Maintenance Window Tasks? <http://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-maintenance-permissions.html#maintenance-window-tasks-service-role>`__
    ...
    def start_automation_execution(
        ...
        **Request Syntax**
        ...
        :param TargetLocations:
          ...
          A location is a combination of AWS Regions and/or AWS accounts where you want to run the Automation. Use this action to start an Automation in multiple Regions and multiple accounts. For more information, see `Executing Automations in Multiple AWS Regions and Accounts <http://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-automation-multiple-accounts-and-regions.html>`__ in the *AWS Systems Manager User Guide* .
    ...
    def update_ops_item(
        ...
        """
        Edit or change an OpsItem. You must have permission in AWS Identity and Access Management (IAM) to update an OpsItem. For more information, see `Getting Started with OpsCenter <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html>`__ in the *AWS Systems Manager User Guide* .
