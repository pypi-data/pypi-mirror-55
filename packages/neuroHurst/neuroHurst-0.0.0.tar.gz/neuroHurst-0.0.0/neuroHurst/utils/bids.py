...
def collect_data(layout: BIDSLayout, subject_id: str, other_format: str = None):
    from niworkflows.utils.bids import collect_data
    #TODO: modify this to deal with non bids layouts (csv for starters)
    return collect_data(layout, subject_id)
...
class BIDSPlusDataGrabber(BIDSDataGrabber):
    ...
    def _run_interface(self, runtime):
        ...
        if not bids_dict['t1w'] and self._require_funcs:
