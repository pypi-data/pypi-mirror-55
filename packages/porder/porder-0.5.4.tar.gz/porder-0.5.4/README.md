...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.3530041.svg)](https://doi.org/10.5281/zenodo.3530041)
...
```
Samapriya Roy. (2019, November 6). samapriya/porder: porder: Simple CLI for Planet ordersV2 API (Version 0.5.4). Zenodo.
http://doi.org/10.5281/zenodo.3530041
```
