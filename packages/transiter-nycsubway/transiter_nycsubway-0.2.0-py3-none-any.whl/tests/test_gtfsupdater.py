...
class TestNycSubwayGtfsCleaner(unittest.TestCase):
    ...
    def test_fix_route_ids_5x(self):
        ...
        response = gtfsrealtimeparser.fix_route_ids(self.feed_update, trip)
    ...
    def test_delete_old_scheduled_trips_delete(self):
        ...
        response = gtfsrealtimeparser.delete_old_scheduled_trips(self.feed_update, trip)
    ...
    def test_invert_j_train_direction_in_bushwick(self):
        ...
        gtfsrealtimeparser.invert_m_train_direction_in_bushwick(
    ...
    def test_delete_first_stop_event_slow_updating_trips__one_stop_id(self):
        ...
        gtfsrealtimeparser.delete_first_stop_time_in_slow_updating_trips(self.feed_update, trip)
