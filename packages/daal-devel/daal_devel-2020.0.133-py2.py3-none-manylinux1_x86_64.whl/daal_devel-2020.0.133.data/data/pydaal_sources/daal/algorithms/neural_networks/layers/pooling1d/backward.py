...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_backward22_', [dirname(__file__)])
        except ImportError:
            import _backward22_
            return _backward22_
        if fp is not None:
            try:
                _mod = imp.load_module('_backward22_', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _backward22_ = swig_import_helper()
...
class Input(daal.algorithms.neural_networks.layers.backward.Input):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _backward22_.delete_Input
    __del__ = lambda self: None

    def getGradientSize(self):
        return _backward22_.Input_getGradientSize(self)
Input_swigregister = _backward22_.Input_swigregister
...
class Result(daal.algorithms.neural_networks.layers.backward.Result):
    ...
    def __init__(self):
        this = _backward22_.new_Result()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _backward22_.delete_Result
    __del__ = lambda self: None

    def check(self, input, parameter, method):
        return _backward22_.Result_check(self, input, parameter, method)

    def allocate_Float64(self, input, parameter, method):
        r"""
    This function is specialized for float64"""
        return _backward22_.Result_allocate_Float64(self, input, parameter, method)


    def allocate_Float32(self, input, parameter, method):
        r"""
    This function is specialized for float32"""
        return _backward22_.Result_allocate_Float32(self, input, parameter, method)

Result_swigregister = _backward22_.Result_swigregister
