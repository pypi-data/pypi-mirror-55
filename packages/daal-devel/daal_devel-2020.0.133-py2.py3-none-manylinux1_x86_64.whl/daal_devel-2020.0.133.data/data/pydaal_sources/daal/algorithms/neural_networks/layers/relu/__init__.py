...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_relu1_', [dirname(__file__)])
        except ImportError:
            import _relu1_
            return _relu1_
        if fp is not None:
            try:
                _mod = imp.load_module('_relu1_', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _relu1_ = swig_import_helper()
...
_relu1_.defaultDense_swigconstant(_relu1_)
defaultDense = _relu1_.defaultDense

_relu1_.auxData_swigconstant(_relu1_)
auxData = _relu1_.auxData

_relu1_.lastLayerDataId_swigconstant(_relu1_)
lastLayerDataId = _relu1_.lastLayerDataId
class Parameter(daal.algorithms.neural_networks.layers.Parameter):
    ...
    def __init__(self):
        this = _relu1_.new_Parameter()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _relu1_.delete_Parameter
    __del__ = lambda self: None
Parameter_swigregister = _relu1_.Parameter_swigregister
...
class Batch_Float64DefaultDense(daal.algorithms.neural_networks.layers.LayerIface):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["parameter"] = _relu1_.Batch_Float64DefaultDense_parameter_set
    __swig_getmethods__["parameter"] = _relu1_.Batch_Float64DefaultDense_parameter_get
    if _newclass:
        parameter = _swig_property(_relu1_.Batch_Float64DefaultDense_parameter_get, _relu1_.Batch_Float64DefaultDense_parameter_set)

    def __init__(self):
        this = _relu1_.new_Batch_Float64DefaultDense()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _relu1_.delete_Batch_Float64DefaultDense
    __del__ = lambda self: None
Batch_Float64DefaultDense_swigregister = _relu1_.Batch_Float64DefaultDense_swigregister
...
class Batch_Float32DefaultDense(daal.algorithms.neural_networks.layers.LayerIface):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["parameter"] = _relu1_.Batch_Float32DefaultDense_parameter_set
    __swig_getmethods__["parameter"] = _relu1_.Batch_Float32DefaultDense_parameter_get
    if _newclass:
        parameter = _swig_property(_relu1_.Batch_Float32DefaultDense_parameter_get, _relu1_.Batch_Float32DefaultDense_parameter_set)

    def __init__(self):
        this = _relu1_.new_Batch_Float32DefaultDense()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _relu1_.delete_Batch_Float32DefaultDense
    __del__ = lambda self: None
Batch_Float32DefaultDense_swigregister = _relu1_.Batch_Float32DefaultDense_swigregister
