...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_tanh1_', [dirname(__file__)])
        except ImportError:
            import _tanh1_
            return _tanh1_
        if fp is not None:
            try:
                _mod = imp.load_module('_tanh1_', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _tanh1_ = swig_import_helper()
...
_tanh1_.defaultDense_swigconstant(_tanh1_)
defaultDense = _tanh1_.defaultDense

_tanh1_.auxValue_swigconstant(_tanh1_)
auxValue = _tanh1_.auxValue

_tanh1_.lastLayerDataId_swigconstant(_tanh1_)
lastLayerDataId = _tanh1_.lastLayerDataId
class Parameter(daal.algorithms.neural_networks.layers.Parameter):
    ...
    def __init__(self):
        this = _tanh1_.new_Parameter()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _tanh1_.delete_Parameter
    __del__ = lambda self: None
Parameter_swigregister = _tanh1_.Parameter_swigregister
...
class Batch_Float64DefaultDense(daal.algorithms.neural_networks.layers.LayerIface):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["parameter"] = _tanh1_.Batch_Float64DefaultDense_parameter_set
    __swig_getmethods__["parameter"] = _tanh1_.Batch_Float64DefaultDense_parameter_get
    if _newclass:
        parameter = _swig_property(_tanh1_.Batch_Float64DefaultDense_parameter_get, _tanh1_.Batch_Float64DefaultDense_parameter_set)

    def __init__(self):
        this = _tanh1_.new_Batch_Float64DefaultDense()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _tanh1_.delete_Batch_Float64DefaultDense
    __del__ = lambda self: None
Batch_Float64DefaultDense_swigregister = _tanh1_.Batch_Float64DefaultDense_swigregister
...
class Batch_Float32DefaultDense(daal.algorithms.neural_networks.layers.LayerIface):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["parameter"] = _tanh1_.Batch_Float32DefaultDense_parameter_set
    __swig_getmethods__["parameter"] = _tanh1_.Batch_Float32DefaultDense_parameter_get
    if _newclass:
        parameter = _swig_property(_tanh1_.Batch_Float32DefaultDense_parameter_get, _tanh1_.Batch_Float32DefaultDense_parameter_set)

    def __init__(self):
        this = _tanh1_.new_Batch_Float32DefaultDense()
        try:
            self.this.append(this)
        except:
            self.this = this
    __swig_destroy__ = _tanh1_.delete_Batch_Float32DefaultDense
    __del__ = lambda self: None
Batch_Float32DefaultDense_swigregister = _tanh1_.Batch_Float32DefaultDense_swigregister
