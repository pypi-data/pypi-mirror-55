...
in_data = pd.DataFrame(range(len(korea_holiday)), index=korea_holiday)
...
def _freq_b_end_date_range(end, periods):
    """
...
def _freq_b_start_date_range(start, periods):
    """
...
def _freq_b_start_end_date_range(start, end):
    """
    :param start: DateTime, 시작 날짜
    :param end: DateTime, 끝 날짜
    :return: list(DateTime)
...
def k_date_range(start=None, end=None, periods=None, freq=None):
    """
