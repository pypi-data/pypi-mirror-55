...
class Client(BaseClient):
          ...
          - *(dict) --*
            ...
            - **ResourcePendingMaintenanceActions** *(dict) --*
              ...
              - **ResourceIdentifier** *(string) --*
                ...
                The Amazon Resource Name (ARN) of the DMS resource that the pending maintenance action applies to. For information about creating an ARN, see `Constructing an Amazon Resource Name (ARN) for AWS DMS <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Introduction.AWS.ARN.html>`__ in the DMS documentation.
        ...
        :param S3Settings:
          ...
          - **IncludeOpForFullLoad** *(boolean) --*
            ...
            .. note::
              ...
              This setting works together with the ``CdcInsertsOnly`` parameter for output to .csv files only. For more information about how these settings work together, see `Indicating Source DB Operations in Migrated S3 Data <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.S3.html#CHAP_Target.S3.Configuring.InsertOps>`__ in the *AWS Database Migration Service User Guide.* .
    ...
    def create_event_subscription(
        ...
        **Request Syntax**
        ...
        :param EventCategories:
          ...
          A list of event categories for a source type that you want to subscribe to. For more information, see `Working with Events and Notifications <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html>`__ in the *AWS Database Migration Service User Guide.*
    ...
    def create_replication_instance(
        ...
        AWS DMS requires that your account have certain roles with appropriate permissions before you can create a replication instance. For information on the required roles, see `Creating the IAM Roles to Use With the AWS CLI and AWS DMS API <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.APIRole.html>`__ . For information on the required permissions, see `IAM Permissions Needed to Use AWS DMS <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.IAMPermissions.html>`__ .
    ...
    def create_replication_task(
        ...
        **Request Syntax**
        ...
        :param TableMappings: **[REQUIRED]**
          ...
          The table mappings for the task, in JSON format. For more information, see `Table Mapping <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.CustomizingTasks.TableMapping.html>`__ in the *AWS Database Migration User Guide.*

        :type ReplicationTaskSettings: string
        :param ReplicationTaskSettings:

          Overall settings for the task, in JSON format. For more information, see `Task Settings <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.CustomizingTasks.TaskSettings.html>`__ in the *AWS Database Migration User Guide.*
        ...
        :param CdcStartPosition:
          ...
          .. note::
            ...
            When you use this task setting with a source PostgreSQL database, a logical replication slot should already be created and associated with the source endpoint. You can verify this by setting the ``slotName`` extra connection attribute to the name of this logical replication slot. For more information, see `Extra Connection Attributes When Using PostgreSQL as a Source for AWS DMS <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Source.PostgreSQL.html#CHAP_Source.PostgreSQL.ConnectionAttrib>`__ .
            ...
            - **ReplicationTask** *(dict) --*
              ...
              - **ReplicationTaskStats** *(dict) --*
                ...
                - **StartDate** *(datetime) --*
                  ...
                  The date the replication task was started either with a fresh start or a resume. For more information, see `StartReplicationTaskType <https://docs.aws.amazon.com/dms/latest/APIReference/API_StartReplicationTask.html#DMS-StartReplicationTask-request-StartReplicationTaskType>`__ .
    ...
    def delete_connection(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/dms-2016-01-01/DeleteConnection>`_
