...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def cancel_elasticsearch_service_software_update(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def describe_elasticsearch_instance_type_limits(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_reserved_elasticsearch_instance_offerings(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_reserved_elasticsearch_instances(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_compatible_elasticsearch_versions(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_upgrade_history(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_upgrade_status(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_elasticsearch_instance_types(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def list_elasticsearch_versions(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def start_elasticsearch_service_software_update(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def upgrade_elasticsearch_domain(self) -> None:
        pass
