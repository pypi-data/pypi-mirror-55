...
version = cnewtonprop.__version__
...
extlinks = {
    'issue': ('https://github.com/qucontrol/cnewtonprop/issues/%s', '#'),
    'pr': ('https://github.com/qucontrol/cnewtonprop/pull/%s', 'PR #'),
}
