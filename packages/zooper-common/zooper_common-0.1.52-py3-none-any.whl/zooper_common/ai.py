"""Zooper AI Model library.

* ZooperInceptionResNetV2
"""
...
from keras_applications import _KERAS_BACKEND, _KERAS_LAYERS, _KERAS_MODELS, _KERAS_UTILS
...
def ZooperBaseInceptionResNetV2(include_top=True,
                                weights='imagenet',
                                input_tensor=None,
                                input_shape=None,
                                pooling=None,
...
def ZooperInceptionResNetV2(*args, **kwargs):
    """ A custom InceptionResNetV2 model built on top of Keras InceptionResNetV2. """
    return ZooperBaseInceptionResNetV2(*args, **kwargs)
