...
def import_func_from_source(source_path      , fn_name      )            :  # pylint: disable=g-bare-generic
...
def import_func_from_module(module_path      , fn_name      )            :  # pylint: disable=g-bare-generic
