...
class CliKubeflowEndToEndTest(tf.test.TestCase):
  ...
  def _change_pipeline_name(self, filename      , origin_dsl_dir      ,
                            new_dsl_dir      , origin_pipeline_name      ,
                            new_pipeline_name      )        :
  ...
  def _delete_pipeline(self, pipeline_name      ):
  ...
  def _delete_experiment(self, pipeline_name      ):
  ...
  def _delete_all_runs(self, experiment_id      ):
    try:
  ...
  def _valid_create_and_check(self, pipeline_path      ,
                              pipeline_name      )        :
  ...
  def _run_pipeline_using_kfp_client(self, pipeline_name      ):
