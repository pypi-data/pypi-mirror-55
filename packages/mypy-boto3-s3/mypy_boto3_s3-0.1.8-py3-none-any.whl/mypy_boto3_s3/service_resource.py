...
class ServiceResource(Boto3ServiceResource):
    buckets: mypy_boto3_s3_scope.buckets
    # pylint: disable=arguments-differ
    def Bucket(self, name: str = None) -> mypy_boto3_s3_scope.Bucket:
        pass

    # pylint: disable=arguments-differ
    def BucketAcl(self, bucket_name: str = None) -> mypy_boto3_s3_scope.BucketAcl:
        pass

    # pylint: disable=arguments-differ
    def BucketCors(self, bucket_name: str = None) -> mypy_boto3_s3_scope.BucketCors:
        pass

    # pylint: disable=arguments-differ
    def BucketLifecycle(
        self, bucket_name: str = None
    ) -> mypy_boto3_s3_scope.BucketLifecycle:
        pass
    ...
    def BucketLogging(
        self, bucket_name: str = None
    ) -> mypy_boto3_s3_scope.BucketLogging:
        pass
    ...
    # pylint: disable=arguments-differ
    def BucketPolicy(self, bucket_name: str = None) -> mypy_boto3_s3_scope.BucketPolicy:
        pass
    ...
    def BucketTagging(
        self, bucket_name: str = None
    ) -> mypy_boto3_s3_scope.BucketTagging:
        pass
    ...
    def BucketWebsite(
        self, bucket_name: str = None
    ) -> mypy_boto3_s3_scope.BucketWebsite:
        pass
...
class Bucket(Boto3ServiceResource):
    ...
    name: str
    multipart_uploads: mypy_boto3_s3_scope.multipart_uploads
    object_versions: mypy_boto3_s3_scope.object_versions
    objects: mypy_boto3_s3_scope.objects
    # pylint: disable=arguments-differ
    def copy(
        self,
...
class MultipartUpload(Boto3ServiceResource):
    ...
    object_key: str
    id: str
    parts: mypy_boto3_s3_scope.parts
    # pylint: disable=arguments-differ
    def abort(self) -> None:
        pass
