...
class Client(BaseClient):
    ...
    def add_application_input(
        ...
        Adds a streaming source to your Amazon Kinesis application. For conceptual information, see `Configuring Application Input <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html>`__ .

        You can add a streaming source either when you create an application or you can use this operation to add a streaming source after you create an application. For more information, see `CreateApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_CreateApplication.html>`__ .

        Any configuration update, including adding a streaming source using this operation, results in a new version of the application. You can use the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation to find the current application version.
        ...
        **Request Syntax**
        ...
        :param CurrentApplicationVersionId: **[REQUIRED]**
          ...
          Current version of your Amazon Kinesis Analytics application. You can use the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation to find the current application version.
        ...
        :param Input: **[REQUIRED]**
          ...
          - **InputProcessingConfiguration** *(dict) --*
            ...
            The `InputProcessingConfiguration <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_InputProcessingConfiguration.html>`__ for the input. An input processor transforms records as they are received from the stream, before the application's SQL code executes. Currently, the only input processing configuration available is `InputLambdaProcessor <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_InputLambdaProcessor.html>`__ .
          ...
          - **InputParallelism** *(dict) --*
            ...
            (see `Configuring Application Input <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html>`__ .

            - **Count** *(integer) --*

              Number of in-application streams to create. For more information, see `Limits <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/limits.html>`__ .
            ...
            - **RecordColumns** *(list) --* **[REQUIRED]**
              ...
              - *(dict) --*
                ...
                - **Mapping** *(string) --*
                  ...
                  Reference to the data element in the streaming input or the reference data source. This element is required if the `RecordFormatType <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_RecordFormat.html#analytics-Type-RecordFormat-RecordFormatTypel>`__ is ``JSON`` .
        ...
        **Request Syntax**
        ...
        :param Output: **[REQUIRED]**
          ...
          - **DestinationSchema** *(dict) --* **[REQUIRED]**
            ...
            Describes the data format when records are written to the destination. For more information, see `Configuring Application Output <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-output.html>`__ .
    ...
    def add_application_reference_data_source(
        ...
        For conceptual information, see `Configuring Application Input <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html>`__ . For the limits on data sources you can add to your application, see `Limits <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/limits.html>`__ .
    ...
    def create_application(
        ...
        For introductory exercises to create an Amazon Kinesis Analytics application, see `Getting Started <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/getting-started.html>`__ .
        ...
        **Request Syntax**
        ...
        :param Inputs:
          ...
          - *(dict) --*
            ...
            When you configure the application input, you specify the streaming source, the in-application stream name that is created, and the mapping between the two. For more information, see `Configuring Application Input <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html>`__ .
        ...
        :param Outputs:
          ...
          - *(dict) --*
            ...
            For limits on how many destinations an application can write and other limitations, see `Limits <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/limits.html>`__ .
        ...
        :param CloudWatchLoggingOptions:
          ...
          Use this parameter to configure a CloudWatch log stream to monitor application configuration errors. For more information, see `Working with Amazon CloudWatch Logs <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/cloudwatch-logs.html>`__ .
    ...
    def delete_application_cloud_watch_logging_option(
        ...
        Deletes a CloudWatch log stream from an application. For more information about using CloudWatch log streams with Amazon Kinesis Analytics applications, see `Working with Amazon CloudWatch Logs <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/cloudwatch-logs.html>`__ .
        ...
        **Request Syntax**
        ...
        :param CloudWatchLoggingOptionId: **[REQUIRED]**
          ...
          The ``CloudWatchLoggingOptionId`` of the CloudWatch logging option to delete. You can get the ``CloudWatchLoggingOptionId`` by using the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation.
    ...
    def delete_application_input_processing_configuration(
        ...
        Deletes an `InputProcessingConfiguration <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_InputProcessingConfiguration.html>`__ from an input.
        ...
        **Request Syntax**
        ...
        :param InputId: **[REQUIRED]**
          ...
          The ID of the input configuration from which to delete the input processing configuration. You can get a list of the input IDs for an application by using the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation.
    ...
    def delete_application_reference_data_source(
        ...
        If the application is running, Amazon Kinesis Analytics immediately removes the in-application table that you created using the `AddApplicationReferenceDataSource <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_AddApplicationReferenceDataSource.html>`__ operation.
        ...
        **Request Syntax**
        ...
        :param CurrentApplicationVersionId: **[REQUIRED]**
          ...
          Version of the application. You can use the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation to get the current application version. If the version specified is not the current version, the ``ConcurrentModificationException`` is returned.

        :type ReferenceId: string
        :param ReferenceId: **[REQUIRED]**

          ID of the reference data source. When you add a reference data source to your application using the `AddApplicationReferenceDataSource <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_AddApplicationReferenceDataSource.html>`__ , Amazon Kinesis Analytics assigns an ID. You can use the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation to get the reference ID.
    ...
    def describe_application(
        ...
        If you want to retrieve a list of all applications in your account, use the `ListApplications <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_ListApplications.html>`__ operation.
          ...
          - *(dict) --*
            ...
            - **ApplicationDetail** *(dict) --*
              ...
              - **InputDescriptions** *(list) --*
                ...
                Describes the application input configuration. For more information, see `Configuring Application Input <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html>`__ .
                ...
                - *(dict) --*
                  ...
                  - **InputProcessingConfigurationDescription** *(dict) --*
                    ...
                    - **InputLambdaProcessorDescription** *(dict) --*
                      ...
                      Provides configuration information about the associated `InputLambdaProcessorDescription <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_InputLambdaProcessorDescription.html>`__ .

                      - **ResourceARN** *(string) --*

                        The ARN of the `AWS Lambda <https://docs.aws.amazon.com/lambda/>`__ function that is used to preprocess the records in the stream.
              ...
              - **ReferenceDataSourceDescriptions** *(list) --*
                ...
                Describes reference data sources configured for the application. For more information, see `Configuring Application Input <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html>`__ .
                ...
                - *(dict) --*
                  ...
                  - **ReferenceId** *(string) --*
                    ...
                    ID of the reference data source. This is the ID that Amazon Kinesis Analytics assigns when you add the reference data source to your application using the `AddApplicationReferenceDataSource <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_AddApplicationReferenceDataSource.html>`__ operation.
    ...
    def discover_input_schema(
        ...
        You can use the inferred schema when configuring a streaming source for your application. For conceptual information, see `Configuring Application Input <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html>`__ . Note that when you create an application using the Amazon Kinesis Analytics console, the console uses this operation to infer a schema and show it in the console user interface.
        ...
        **Request Syntax**
        ...
        :param InputProcessingConfiguration:
          ...
          The `InputProcessingConfiguration <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_InputProcessingConfiguration.html>`__ to use to preprocess the records before discovering the schema of the records.
    ...
    def list_tags_for_resource(
        ...
        """
        Retrieves the list of key-value tags assigned to the application. For more information, see `Using Tagging <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-tagging.html>`__ .

        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalytics-2015-08-14/ListTagsForResource>`_
    ...
    def start_application(
        ...
        The application status must be ``READY`` for you to start an application. You can get the application status in the console or using the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation.

        After you start the application, you can stop the application from processing the input by calling the `StopApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_StopApplication.html>`__ operation.
        ...
        :param InputConfigurations: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **Id** *(string) --* **[REQUIRED]**
              ...
              Input source ID. You can get this ID by calling the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation.
    ...
    def stop_application(
        ...
        Stops the application from processing input data. You can stop an application only if it is in the running state. You can use the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation to find the application state. After the application is stopped, Amazon Kinesis Analytics stops reading data from the input, the application stops processing data, and there is no output written to the destination.
    ...
    def tag_resource(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalytics-2015-08-14/TagResource>`_
    ...
    def update_application(
        ...
        **Request Syntax**
        ...
        :param CurrentApplicationVersionId: **[REQUIRED]**
          ...
          The current application version ID. You can use the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation to get this value.
            ...
            - *(dict) --*
              ...
              - **InputProcessingConfigurationUpdate** *(dict) --*
                ...
                - **InputLambdaProcessorUpdate** *(dict) --* **[REQUIRED]**
                  ...
                  Provides update information for an `InputLambdaProcessor <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_InputLambdaProcessor.html>`__ .

                  - **ResourceARNUpdate** *(string) --*

                    The Amazon Resource Name (ARN) of the new `AWS Lambda <https://docs.aws.amazon.com/lambda/>`__ function that is used to preprocess the records in the stream.
          ...
          - **ReferenceDataSourceUpdates** *(list) --*
            ...
            - *(dict) --*
              ...
              - **ReferenceId** *(string) --* **[REQUIRED]**
                ...
                ID of the reference data source being updated. You can use the `DescribeApplication <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__ operation to get this value.
