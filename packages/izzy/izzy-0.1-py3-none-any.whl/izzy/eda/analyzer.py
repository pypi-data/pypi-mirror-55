...
class FeatureAnalyzer:
    ...
    def __init__(self, x, y, z=None, clean=True, engine='LR', verbose=False):
        ...
        ----------
        x : array-like
            The principle feature to analyze.
        y : array-like
            The outcome to analyze against.
        z : array-like
            A secondary feature for interaction analysis. (Optional)
        clean : bool
