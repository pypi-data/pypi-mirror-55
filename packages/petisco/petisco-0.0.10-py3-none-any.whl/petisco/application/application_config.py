...
class ApplicationConfig(metaclass=Singleton):
    ...
    def __init__(
        ...
        if services_mode_mapper:
            ...
            info_services = [(key, service.info()) for key, service in self.services_provider()]
        ...
        if repositories_mode_mapper:
            ...
            info_repositories = [(key, repository.info()) for key, repository in self.repositories_provider()]
