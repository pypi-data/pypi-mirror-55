...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def apply_security_groups_to_load_balancer(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def attach_load_balancer_to_subnets(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def create_app_cookie_stickiness_policy(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def create_lb_cookie_stickiness_policy(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def delete_load_balancer_listeners(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def delete_load_balancer_policy(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def describe_load_balancer_attributes(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_load_balancer_policies(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_load_balancer_policy_types(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def detach_load_balancer_from_subnets(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def disable_availability_zones_for_load_balancer(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def enable_availability_zones_for_load_balancer(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def set_load_balancer_listener_ssl_certificate(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def set_load_balancer_policies_for_backend_server(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def set_load_balancer_policies_of_listener(self) -> None:
        pass
