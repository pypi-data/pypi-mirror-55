...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.1.0-alpha.1572629873+g7c3f110'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.1.0-alpha.1572629873+g7c3f110`
                """)
            else:
                raise
