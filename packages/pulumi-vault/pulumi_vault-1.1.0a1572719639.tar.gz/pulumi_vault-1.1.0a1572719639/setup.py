...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.1.0-alpha.1572719639+gd3e08e4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.1.0-alpha.1572719639+gd3e08e4`
                """)
            else:
                raise
