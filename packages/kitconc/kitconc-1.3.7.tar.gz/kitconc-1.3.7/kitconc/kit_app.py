...
class KitApp(Tk):
    ...
    def __add_widgets(self):
        ...
        # frm_cmb_corpora
        self.frm_cmb_corpora = ttk.Combobox(self.frm_lbl_corpora,state='readonly',width=25)
        self.frm_cmb_corpora.place(x=5,y=5)
        self.__load_corpora()
        ...
        self.frm_pgb.place(x=10,y=565,width=200)
        # frm_lbl_options
    ...
    def __on_tool(self):
        def callback():
            ...
            # Wordlist
            if tool == 'Wordlist' and self.kit.corpus_in_use!=None:
