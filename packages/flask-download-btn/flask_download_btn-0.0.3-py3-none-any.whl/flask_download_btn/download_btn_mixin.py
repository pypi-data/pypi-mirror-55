...
class DownloadBtnMixin(FunctionBase):
    ...
    def tmpdir_savefile(self, filename):
        return os.path.join(self.tmpdir, filename)

    @property
    def zipf_name(self):
        return self.model_id+'-zip.zip'
    ...
    def _filename(self):
        ...
        return os.path.join(os.getcwd(), self.zipf_path)
    ...
    def _attachment_filename(self):
        ...
        if num_files == 0:
            return ''
        if num_files == 1:
            return self.attachment_filename or self.filenames[0]
    ...
    def _zip_files(self):
        ...
        zipf = zipfile.ZipFile(self.zipf_path, 'w', zipfile.ZIP_DEFLATED)
