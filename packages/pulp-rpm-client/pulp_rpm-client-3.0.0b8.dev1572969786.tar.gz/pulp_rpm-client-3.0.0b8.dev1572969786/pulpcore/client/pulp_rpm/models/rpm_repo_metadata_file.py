...
class RpmRepoMetadataFile(object):
    ...
    @property
    def file(self):
        """Gets the file of this RpmRepoMetadataFile.  # noqa: E501

        An uploaded file that should be turned into the artifact of the content unit.  # noqa: E501

        :return: The file of this RpmRepoMetadataFile.  # noqa: E501
        :rtype: str
        """
        return self._file
    ...
    @file.setter
    def file(self, file):
        """Sets the file of this RpmRepoMetadataFile.

        An uploaded file that should be turned into the artifact of the content unit.  # noqa: E501

        :param file: The file of this RpmRepoMetadataFile.  # noqa: E501
        :type: str
        """
    ...
    @property
    def repository(self):
        """Gets the repository of this RpmRepoMetadataFile.  # noqa: E501

        A URI of a repository the new content unit should be associated with.  # noqa: E501

        :return: The repository of this RpmRepoMetadataFile.  # noqa: E501
        :rtype: str
        """
    ...
    def repository(self, repository):
        """Sets the repository of this RpmRepoMetadataFile.

        A URI of a repository the new content unit should be associated with.  # noqa: E501

        :param repository: The repository of this RpmRepoMetadataFile.  # noqa: E501
        :type: str
        """
