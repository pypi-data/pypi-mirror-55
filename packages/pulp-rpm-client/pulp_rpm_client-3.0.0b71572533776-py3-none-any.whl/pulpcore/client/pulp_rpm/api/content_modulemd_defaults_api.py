...
class ContentModulemdDefaultsApi(object):
    ...
    def create_with_http_info(self, relative_path, module, stream, profiles, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/rpm/modulemd-defaults/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/rpm/modulemd-defaults/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read(self, modulemd_defaults_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str modulemd_defaults_href: URI of Modulemd Defaults. e.g.: /pulp/api/v3/content/rpm/modulemd-defaults/1/ (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
    ...
    def read_with_http_info(self, modulemd_defaults_href, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ModulemdDefaults, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ModulemdDefaults',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
