...
from ..logistic_regression_multiclassifier.logistic_regression_multiclassifier import \
    LogisticRegressionMultiClassifier, MulticlassLogisticRegressionModule, \
    MulticlassLogisticRegressionModuleDefaultParameters


class TestLRMultiCase(MultiClassCommonCase):
    entry_class = MulticlassLogisticRegressionModule
    model_class = LogisticRegressionMultiClassifier
    performance_assert_threshold = .90
    ...
    default_range_parameter = {
        ...
        'ps_l2_weight': ParameterRangeSettings.from_literal(
            MulticlassLogisticRegressionModuleDefaultParameters.PsL2Weight),
        'ps_memory_size': None,
        'random_number_seed': None
    }
