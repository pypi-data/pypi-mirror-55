...
from ..boosted_decision_tree_multiclassifier.boosted_decision_tree_multiclassifier import \
    BoostedDecisionTreeMultiClassifier, MultiClassBoostedDecisionTreeModule, \
    MultiClassBoostedDecisionTreeModuleDefaultParameters


class TestBoostedDecisionTreeMultiClassCase(MultiClassCommonCase):
    entry_class = MultiClassBoostedDecisionTreeModule
    model_class = BoostedDecisionTreeMultiClassifier
    ...
    default_range_parameter = {
        ...
        'ps_num_trees': ParameterRangeSettings.from_literal(
            MultiClassBoostedDecisionTreeModuleDefaultParameters.PsNumTrees),
        'random_number_seed': None
    }
