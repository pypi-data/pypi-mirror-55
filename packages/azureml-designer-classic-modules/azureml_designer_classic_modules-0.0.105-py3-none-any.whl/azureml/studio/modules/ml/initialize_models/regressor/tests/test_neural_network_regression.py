...
from ..neural_network_regressor.neural_network_regressor import \
    NeuralNetworkRegressionModule, NeuralNetworkRegressor, CreateNeuralNetworkRegressionModelNeuralNetworkTopology, \
    NeuralNetworkRegressionModuleDefaultParameters


class TestNNRegressorCase(RegressionCommonCase):
    entry_class = NeuralNetworkRegressionModule
    model_class = NeuralNetworkRegressor
    ...
    default_range_parameter = {
        ...
        'ps_learning_rate': ParameterRangeSettings.from_literal(
            NeuralNetworkRegressionModuleDefaultParameters.PsLearningRate),
    ...
    def test_num_iterations_work(self):
        ...
        mltest_utils.assert_greater(error_value, error_value2, )
