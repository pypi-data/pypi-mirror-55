...
def relative_humidity(air_temperature, dew_temperature):
    """
    Calculates relative humidity from air temperature and dew point
    References: https://en.wikipedia.org/wiki/Dew_point,
    ...
    rh = 100 * (np.exp((17.629 * dew_temperature) / (243.04 + dew_temperature)) / np.exp(
        (17.629 * air_temperature) / (243.04 + air_temperature)))
