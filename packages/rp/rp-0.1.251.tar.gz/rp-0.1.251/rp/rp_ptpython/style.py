...
temp.update({                                                                                                
    ...
    Token.SearchMatch.Current:                            'noinherit',
    ...
    Token.Toolbar.Completions.Completion.Current:         'noinherit',
    Token.Menu.Completions.Completion:                    'noinherit',
    Token.Menu.Completions.Completion.Current:            'noinherit',
    Token.Menu.Completions.Meta:                          'noinherit',
    Token.Menu.Completions.Meta.Current:                  'noinherit',
