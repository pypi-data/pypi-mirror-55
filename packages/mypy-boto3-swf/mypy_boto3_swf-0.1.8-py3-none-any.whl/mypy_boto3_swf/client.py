...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def list_activity_types(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_workflow_types(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def record_activity_task_heartbeat(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def request_cancel_workflow_execution(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def respond_activity_task_canceled(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def respond_activity_task_completed(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def respond_activity_task_failed(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def signal_workflow_execution(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def terminate_workflow_execution(self) -> None:
        pass
