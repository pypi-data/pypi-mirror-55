...
class Client(BaseClient):
    ...
    def register_activity_type(
        ...
        **Request Syntax**
        ...
        :param defaultTaskPriority:
          ...
          For more information about setting task priority, see `Setting Task Priority <https://docs.aws.amazon.com/amazonswf/latest/developerguide/programming-priority.html>`__ in the *in the *Amazon SWF Developer Guide* .* .
    ...
    def undeprecate_activity_type(
        ...
        * Constrain the following parameters by using a ``Condition`` element with the appropriate keys.
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/UndeprecateActivityType>`_
    ...
    def undeprecate_domain(
        ...
        * You cannot use an IAM policy to constrain this action's parameters.
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/UndeprecateDomain>`_
    ...
    def undeprecate_workflow_type(
        ...
        * Constrain the following parameters by using a ``Condition`` element with the appropriate keys.
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/UndeprecateWorkflowType>`_
    ...
    def untag_resource(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/UntagResource>`_
