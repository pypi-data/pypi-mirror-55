...
from clustering_jhk.utils.validation import _num_samples
from clustering_jhk.utils.extmath import row_norms
from clustering_jhk.utils.extmath import safe_sparse_dot
from clustering_jhk.utils import get_chunk_n_rows, gen_even_slices
...
def euclidean_distances(X,
    ...
    if X.dtype == np.float32:
        ...
        distances = np.add(distances, XX, out=distances, casting="unsafe")
        distances = np.add(distances, YY, out=distances, casting="unsafe")
