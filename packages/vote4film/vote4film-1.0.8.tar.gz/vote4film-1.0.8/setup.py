...
['src',
 'src.calender',
 'src.calender.migrations',
 'src.films',
 'src.films.clients',
 'src.films.core',
 'src.films.migrations',
 'src.films.templatetags',
 'src.schedule',
 'src.schedule.migrations',
 'src.vote4film',
 'src.votes',
 'src.votes.migrations',
 'src.web']

package_data = \
{'': ['*'],
 'src.calender': ['templates/calender/*'],
 'src.films': ['templates/films/*'],
 'src.schedule': ['templates/schedule/*'],
 'src.votes': ['templates/votes/*', 'templates/votes/includes/*'],
 'src.web': ['templates/web/*']}
