...
class IndividualWs(BaseIndividualWs):
    ...
    def rest_orders(self,coin,currency):
        ...
        logger.info('rest_order_history: %s' , instrument_id)
    ...
    def rest_ledger(self, coin,currency,order_id=None):
        ...
        logger.info('rest_ledger: %s' , instrument_id)
        ...
        while not ledgers_all:
            ...
            logger.info('ledgers: %s', ledgers_all)
    ...
    def update_ledger(self,event):
        ...
        try:
            ...
            logger.info('will update ledger, %s' , json.dumps( event.message) )
            ...
            for k,v in update.items():
                ...
                if coin_fee or currency_fee:
                    ...
                    logger.info('update ledger: %s', json.dumps(event.message))
                ...
                while True:
                    ...
                    if table == 'spot/account':
                        ...
                        for item in data:
                            ...
                            logger.info('order update: %s' , item)
