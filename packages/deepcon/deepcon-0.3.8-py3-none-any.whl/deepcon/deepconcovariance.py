...
#model_weights_file_name = './weights-rdd-covariance.hdf5'

google_colab_pathname = '/usr/local/lib/python3.6/dist-packages/deepcon/weights-rdd-covariance.hdf5'
website_pathname = '/usr/local/lib/python3.6/site-packages/deepcon/weights-rdd-covariance.hdf5'
#local_machine_pathname = '.../Python37/Lib/site-packages/deepcon/weights-rdd-covariance'

if os.path.exists(google_colab_pathname):
    model_weights_file_name = google_colab_pathname
elif os.path.exists(website_pathname):
    model_weights_file_name = website_pathname
else:
    #model_weights_file_name = local_machine_pathname
    #~/.local/lib/...
    model_weights_file_name = './weights-rdd-covariance.hdf5'
