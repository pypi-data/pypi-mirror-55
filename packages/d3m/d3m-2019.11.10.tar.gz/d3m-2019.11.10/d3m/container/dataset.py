    ...
    def _get_column_metadata(self, column: typing.Dict) -> typing.Dict:
        ...
        if column.get('timeGranularity', None):
            column_metadata['time_granularity'] = {
                ...
                'unit': TIME_GRANULARITY_MAP[column['timeGranularity']['units']],
            }
...
class D3MDatasetSaver(Saver):
    ...
    # We do not use "resource" and "dataset_location_base_path" but we keep them for all "_get_*_resource_description" methods to have the same signature.
