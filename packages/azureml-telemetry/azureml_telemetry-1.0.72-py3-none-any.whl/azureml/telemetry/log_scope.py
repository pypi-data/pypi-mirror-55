...
try:
    import azureml._base_sdk_common as _base_sdk_common
    # not able to refer _base_sdk_common._ClientSessionId here due to the
    # circular module reference between core and telemetry
...
class LogScope:
    ...
    def get_merged_props(self, props: dict) -> dict:
        ...
        client_session_id = telemetry_session_id or _base_sdk_common._ClientSessionId
        merged["SessionId"] = client_session_id
        return merged
