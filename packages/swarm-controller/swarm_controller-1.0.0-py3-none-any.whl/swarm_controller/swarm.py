...
class SwarmNode:
    ...
    def bootstrap(self):
        ...
        # sleep for 10 seconds and check if there is a split-brain
        # if there is - leave the swarm and try the bootstrap again
        time.sleep(10)

        if self.swarm.get_max_quorum() > self.info["Swarm"].get("Managers", 0):
