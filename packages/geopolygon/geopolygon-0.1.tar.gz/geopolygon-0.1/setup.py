...
setup(
  ...
  url = 'https://github.com/CostRagno/geopolygon	',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/CostRagno/geopolygon/archive/v_01.tar.gz',    # I explain this later on
