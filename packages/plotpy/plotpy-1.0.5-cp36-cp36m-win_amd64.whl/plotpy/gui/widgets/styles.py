...
from plotpy.gui.dataset.datatypes import DataSetGroupGui, DataSetGui
from plotpy.gui.dataset.qtitemwidgets import DataSetWidget
from plotpy.gui.dataset.qtwidgets import DataSetEditLayout
from plotpy.gui.widgets.colormap import build_icon_from_cmap_name, get_colormap_list
...
class ItemParameters(object):
    ...
    def edit(self, plot, title, icon):
        ...
        dset = DataSetGroupGui(parameters, title=title.rstrip("."), icon=icon)
...
# ===================================================
class LineStyleParam(DataSetGui):
...
# ===================================================
class BrushStyleParam(DataSetGui):
...
# QwtText parameters
# ===================================================
class TextStyleParam(DataSetGui):
...
# ===================================================
class AxeStyleParam(DataSetGui):
...
class ImageAxesParam(DataSetGui):
...
# ===================================================
class ErrorBarParam(DataSetGui):
    mode = ChoiceItem(
        _("Display"),
        default=0,
...
class BaseImageParam(DataSetGui):
    _multiselection = False
    ...
    def update_param(self, image):
        ...
        from plotpy.gui.widgets.items.image import INTERP_NEAREST, INTERP_LINEAR
...
class TransformParamMixin(DataSetGui):
...
class QuadGridParam(TransformParamMixin):
    _multiselection = False
    label = StringItem(_("Image title"), default=_("Image")).set_prop(
        "display", hide=GetAttrProp("_multiselection")
    )
...
class XYImageParam(RawImageParam, TransformParamMixin):
    def update_item(self, image):
        """
...
class MaskedImageParamMixin(DataSetGui):
...
# ===================================================
class HistogramParam(DataSetGui):
...
# ===================================================
class Histogram2DParam(BaseImageParam, TransformParamMixin):
    """Histogram"""
...
class AxesShapeParam(DataSetGui):
...
class AnnotationParam(DataSetGui):
    _multiselection = False
...
# ===================================================
class RangeShapeParam(DataSetGui):
    _styles = BeginTabGroup("Styles")
    # ------------------------------------------------------------------ Line tab
    ___line = BeginGroup(_("Line")).set_prop("display", icon="dashdot.png")
    line = LineStyleItem(_("Line (not selected)"))
