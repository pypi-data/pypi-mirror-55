...
"""
plotpy.gui.widgets.items.annotations
------------------------------------
...
>>> from plotpy.gui.widgets.items.annotations import AnnotatedCircle
>>> from plotpy.gui.widgets.styles import AnnotationParam
...
from plotpy.gui.widgets.geometry import (
    compute_angle,
    compute_center,
    compute_distance,
    compute_rect_size,
...
from plotpy.gui.widgets.items.label import DataInfoLabel
...
from plotpy.gui.widgets.styles import AnnotationParam, LabelParam
...
class AnnotatedPoint(AnnotatedShape):
    ...
    def get_infos(self):
        ...
        return "( {} ; {} )".format(self.x_to_str(xt), self.y_to_str(yt))
