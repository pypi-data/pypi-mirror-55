...
from plotpy.gui.widgets.config import CONF
from plotpy.gui.widgets.debug import buttons_to_str, evt_type_to_str
...
class UndoMoveObject(object):
    ...
    def compute_positions(self):
        ...
        :return:
        """
        from plotpy.gui.widgets.items.utils import axes_to_canvas
