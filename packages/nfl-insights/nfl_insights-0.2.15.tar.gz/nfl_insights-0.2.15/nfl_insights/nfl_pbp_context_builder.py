...
class NFLPbpContextBuilder:
    ...
    def _create_play(self, play, parent=None, playStatus=None):
        try:
            ...
            # offense/defense/kicking/retrieving team setting
            ...
            if 'kickingTeam_id' in _newplay:
                _newplay['retrievingTeam_id'] = self._playContext.awayTeam if _newplay['kickingTeam_id'] == self._playContext.homeTeam else self._playContext.homeTeam
    ...
    def _calculate_points(self, newplay):
        ...
        for _key in ['defense', 'offense', 'kicking', 'retrieving']:
