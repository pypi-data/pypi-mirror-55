...
def get_lessons(root_dir, out_dir, silent=False):
...
def run(root_dir, lesson_th=None, srt_th=None):
    ...
    lessons = get_lessons(root_dir, out_dir, silent)
