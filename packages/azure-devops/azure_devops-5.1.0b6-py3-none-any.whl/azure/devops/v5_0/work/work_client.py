...
class WorkClient(Client):
    ...
    def get_backlog_level_work_items(self, team_context, backlog_id):
        ...
        :rtype: :class:`<BacklogLevelWorkItems> <azure.devops.v5_0.work.models.BacklogLevelWorkItems>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def get_backlog(self, team_context, id):
        ...
        :rtype: :class:`<BacklogLevelConfiguration> <azure.devops.v5_0.work.models.BacklogLevelConfiguration>`
        """
        project = None
        team = None
        if team_context is not None:
    ...
    def get_process_configuration(self, project):
        ...
        :param str project: Project ID or project name
        :rtype: :class:`<ProcessConfiguration> <azure.devops.v5_0.work.models.ProcessConfiguration>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
    ...
    def get_iteration_work_items(self, team_context, iteration_id):
        ...
        :param :class:`<TeamContext> <azure.devops.v5_0.work.models.TeamContext>` team_context: The team context for the operation
        :param str iteration_id: ID of the iteration
        :rtype: :class:`<IterationWorkItems> <azure.devops.v5_0.work.models.IterationWorkItems>`
        """
        project = None
        team = None
        if team_context is not None:
