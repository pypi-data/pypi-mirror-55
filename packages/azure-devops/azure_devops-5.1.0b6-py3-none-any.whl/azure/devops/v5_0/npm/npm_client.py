...
class NpmClient(Client):
    ...
    def update_packages(self, batch_request, feed_id):
        ...
        :param :class:`<NpmPackagesBatchRequest> <azure.devops.v5_0.npm.models.NpmPackagesBatchRequest>` batch_request: Information about the packages to update, the operation to perform, and its associated data.
        :param str feed_id: Name or ID of the feed.
        """
        route_values = {}
        if feed_id is not None:
