...
class DebugEntryCreateBatch(Model):
    ...
    :type debug_entries: list of :class:`DebugEntry <azure.devops.v5_0.symbol.models.DebugEntry>`
    """
...
class JsonBlobIdentifierWithBlocks(Model):
    ...
    :param block_hashes:
    :type block_hashes: list of :class:`JsonBlobBlockHash <azure.devops.v5_0.symbol.models.JsonBlobBlockHash>`
    :param identifier_value:
    :type identifier_value: str
    """
...
class DebugEntry(ResourceBase):
    ...
    :type url: str
    :param blob_details:
    :type blob_details: :class:`JsonBlobIdentifierWithBlocks <azure.devops.v5_0.symbol.models.JsonBlobIdentifierWithBlocks>`
    ...
    :type blob_identifier: :class:`JsonBlobIdentifier <azure.devops.v5_0.symbol.models.JsonBlobIdentifier>`
