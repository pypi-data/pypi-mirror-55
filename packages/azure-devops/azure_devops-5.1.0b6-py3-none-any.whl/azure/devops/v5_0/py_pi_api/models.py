...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v5_0.py_pi.models.ReferenceLinks>`
...
class PackageVersionDetails(Model):
    ...
    :type views: :class:`JsonPatchOperation <azure.devops.v5_0.py_pi.models.JsonPatchOperation>`
    """
...
class PyPiPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <azure.devops.v5_0.py_pi.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MinimalPackageDetails <azure.devops.v5_0.py_pi.models.MinimalPackageDetails>`
    """
