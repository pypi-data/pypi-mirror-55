...
class MemberEntitlementManagementClient(Client):
    ...
    def add_user_entitlement(self, user_entitlement):
        ...
        :rtype: :class:`<UserEntitlementsPostResponse> <azure.devops.v5_0.member_entitlement_management.models.UserEntitlementsPostResponse>`
        """
    ...
    def update_user_entitlements(self, document, do_not_send_invite_for_new_users=None):
        ...
        :rtype: :class:`<UserEntitlementOperationReference> <azure.devops.v5_0.member_entitlement_management.models.UserEntitlementOperationReference>`
        """
        query_parameters = {}
    ...
    def get_user_entitlement(self, user_id):
        ...
        :param str user_id: ID of the user.
        :rtype: :class:`<UserEntitlement> <azure.devops.v5_0.member_entitlement_management.models.UserEntitlement>`
        """
        route_values = {}
        if user_id is not None:
            route_values['userId'] = self._serialize.url('user_id', user_id, 'str')
