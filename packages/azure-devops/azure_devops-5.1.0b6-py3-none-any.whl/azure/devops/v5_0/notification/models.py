...
class VssNotificationEvent(Model):
    ...
    :type actors: list of :class:`EventActor <azure.devops.v5_0.microsoft._visual_studio._services._web_api.models.EventActor>`
    ...
    :type scopes: list of :class:`EventScope <azure.devops.v5_0.microsoft._visual_studio._services._web_api.models.EventScope>`
