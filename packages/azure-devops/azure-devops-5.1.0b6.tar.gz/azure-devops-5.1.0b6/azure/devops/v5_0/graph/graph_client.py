...
class GraphClient(Client):
    ...
    def get_descriptor(self, storage_key):
        ...
        :rtype: :class:`<GraphDescriptorResult> <azure.devops.v5_0.graph.models.GraphDescriptorResult>`
        """
        route_values = {}
    ...
    def create_group(self, creation_context, scope_descriptor=None, group_descriptors=None):
        ...
        :param :class:`<GraphGroupCreationContext> <azure.devops.v5_0.graph.models.GraphGroupCreationContext>` creation_context: The subset of the full graph group used to uniquely find the graph subject in an external provider.
    ...
    def get_storage_key(self, subject_descriptor):
        ...
        :rtype: :class:`<GraphStorageKeyResult> <azure.devops.v5_0.graph.models.GraphStorageKeyResult>`
        """
        route_values = {}
        if subject_descriptor is not None:
            route_values['subjectDescriptor'] = self._serialize.url('subject_descriptor', subject_descriptor, 'str')
    ...
    def lookup_subjects(self, subject_lookup):
        ...
        :param :class:`<GraphSubjectLookup> <azure.devops.v5_0.graph.models.GraphSubjectLookup>` subject_lookup: A list of descriptors that specifies a subset of subjects to retrieve. Each descriptor uniquely identifies the subject across all instance scopes, but only at a single point in time.
        :rtype: {GraphSubject}
        """
