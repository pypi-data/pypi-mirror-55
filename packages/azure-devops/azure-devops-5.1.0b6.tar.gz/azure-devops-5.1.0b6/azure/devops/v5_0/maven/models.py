...
class MavenDistributionManagement(Model):
    ...
    :param repository:
    :type repository: :class:`MavenRepository <azure.devops.v5_0.maven.models.MavenRepository>`
    :param snapshot_repository:
    :type snapshot_repository: :class:`MavenSnapshotRepository <azure.devops.v5_0.maven.models.MavenSnapshotRepository>`
    """
...
class MavenPackage(Model):
    ...
    :type artifact_index: :class:`ReferenceLink <azure.devops.v5_0.maven.models.ReferenceLink>`
    :param artifact_metadata:
    :type artifact_metadata: :class:`ReferenceLink <azure.devops.v5_0.maven.models.ReferenceLink>`
    :param deleted_date:
    :type deleted_date: datetime
    :param files:
    :type files: :class:`ReferenceLinks <azure.devops.v5_0.maven.models.ReferenceLinks>`
    :param group_id:
    :type group_id: str
    :param pom:
    :type pom: :class:`MavenPomMetadata <azure.devops.v5_0.maven.models.MavenPomMetadata>`
    :param requested_file:
    :type requested_file: :class:`ReferenceLink <azure.devops.v5_0.maven.models.ReferenceLink>`
    :param snapshot_metadata:
    :type snapshot_metadata: :class:`ReferenceLink <azure.devops.v5_0.maven.models.ReferenceLink>`
    :param version:
    :type version: str
    :param versions:
    :type versions: :class:`ReferenceLinks <azure.devops.v5_0.maven.models.ReferenceLinks>`
    :param versions_index:
    :type versions_index: :class:`ReferenceLink <azure.devops.v5_0.maven.models.ReferenceLink>`
    """
...
class MavenPackagesBatchRequest(Model):
    ...
    :type data: :class:`BatchOperationData <azure.devops.v5_0.maven.models.BatchOperationData>`
    ...
    :type packages: list of :class:`MavenMinimalPackageDetails <azure.devops.v5_0.maven.models.MavenMinimalPackageDetails>`
    """
...
class MavenPomBuild(Model):
    ...
    :param plugins:
    :type plugins: list of :class:`Plugin <azure.devops.v5_0.maven.models.Plugin>`
    """
...
class MavenPomCi(Model):
    ...
    :param notifiers:
    :type notifiers: list of :class:`MavenPomCiNotifier <azure.devops.v5_0.maven.models.MavenPomCiNotifier>`
    :param system:
    :type system: str
    :param url:
    :type url: str
...
class MavenPomDependencyManagement(Model):
    ...
    :param dependencies:
    :type dependencies: list of :class:`MavenPomDependency <azure.devops.v5_0.maven.models.MavenPomDependency>`
    """
...
class MavenPomMetadata(MavenPomGav):
    ...
    :type version: str
    :param build:
    :type build: :class:`MavenPomBuild <azure.devops.v5_0.maven.models.MavenPomBuild>`
    :param ci_management:
    :type ci_management: :class:`MavenPomCi <azure.devops.v5_0.maven.models.MavenPomCi>`
    :param contributors:
    :type contributors: list of :class:`MavenPomPerson <azure.devops.v5_0.maven.models.MavenPomPerson>`
    :param dependencies:
    :type dependencies: list of :class:`MavenPomDependency <azure.devops.v5_0.maven.models.MavenPomDependency>`
    :param dependency_management:
    :type dependency_management: :class:`MavenPomDependencyManagement <azure.devops.v5_0.maven.models.MavenPomDependencyManagement>`
    :param description:
    :type description: str
    :param developers:
    :type developers: list of :class:`MavenPomPerson <azure.devops.v5_0.maven.models.MavenPomPerson>`
    :param distribution_management:
    :type distribution_management: :class:`MavenDistributionManagement <azure.devops.v5_0.maven.models.MavenDistributionManagement>`
    :param inception_year:
    :type inception_year: str
    :param issue_management:
    :type issue_management: :class:`MavenPomIssueManagement <azure.devops.v5_0.maven.models.MavenPomIssueManagement>`
    :param licenses:
    :type licenses: list of :class:`MavenPomLicense <azure.devops.v5_0.maven.models.MavenPomLicense>`
    :param mailing_lists:
    :type mailing_lists: list of :class:`MavenPomMailingList <azure.devops.v5_0.maven.models.MavenPomMailingList>`
    :param model_version:
    ...
    :type name: str
    :param organization:
    :type organization: :class:`MavenPomOrganization <azure.devops.v5_0.maven.models.MavenPomOrganization>`
    :param packaging:
    :type packaging: str
    :param parent:
    :type parent: :class:`MavenPomParent <azure.devops.v5_0.maven.models.MavenPomParent>`
    :param prerequisites:
    :type prerequisites: dict
    :param properties:
    :type properties: dict
    :param scm:
    :type scm: :class:`MavenPomScm <azure.devops.v5_0.maven.models.MavenPomScm>`
    :param url:
    :type url: str
    """
...
class Package(Model):
    ...
    :type _links: :class:`ReferenceLinks <azure.devops.v5_0.maven.models.ReferenceLinks>`
...
class Plugin(MavenPomGav):
    ...
    :type version: str
    :param configuration:
    :type configuration: :class:`PluginConfiguration <azure.devops.v5_0.maven.models.PluginConfiguration>`
    """
