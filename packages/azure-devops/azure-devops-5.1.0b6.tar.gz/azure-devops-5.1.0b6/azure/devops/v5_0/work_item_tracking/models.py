...
class AccountMyWorkResult(Model):
    ...
    :type work_item_details: list of :class:`AccountWorkWorkItemModel <azure.devops.v5_0.work_item_tracking.models.AccountWorkWorkItemModel>`
    """
...
class WorkItemDelete(WorkItemDeleteReference):
    ...
    :type resource: :class:`WorkItem <azure.devops.v5_0.work_item_tracking.models.WorkItem>`
    """
...
class WorkItemType(WorkItemTrackingResource):
    ...
    :type field_instances: list of :class:`WorkItemTypeFieldInstance <azure.devops.v5_0.work_item_tracking.models.WorkItemTypeFieldInstance>`
    :param fields: The fields that exist on the work item type.
    :type fields: list of :class:`WorkItemTypeFieldInstance <azure.devops.v5_0.work_item_tracking.models.WorkItemTypeFieldInstance>`
    :param icon: The icon of the work item type.
    :type icon: :class:`WorkItemIcon <azure.devops.v5_0.work_item_tracking.models.WorkItemIcon>`
    ...
    :type states: list of :class:`WorkItemStateColor <azure.devops.v5_0.work_item_tracking.models.WorkItemStateColor>`
...
class WorkItemTypeCategory(WorkItemTrackingResource):
    ...
    :type default_work_item_type: :class:`WorkItemTypeReference <azure.devops.v5_0.work_item_tracking.models.WorkItemTypeReference>`
    ...
    :type work_item_types: list of :class:`WorkItemTypeReference <azure.devops.v5_0.work_item_tracking.models.WorkItemTypeReference>`
    """
...
class WorkItemUpdate(WorkItemTrackingResource):
    ...
    :type relations: :class:`WorkItemRelationUpdates <azure.devops.v5_0.work_item_tracking.models.WorkItemRelationUpdates>`
    :param rev: The revision number of work item update.
    :type rev: int
    :param revised_by: Identity for the work item update.
    :type revised_by: :class:`IdentityReference <azure.devops.v5_0.work_item_tracking.models.IdentityReference>`
...
class QueryHierarchyItem(WorkItemTrackingResource):
    ...
    :type children: list of :class:`QueryHierarchyItem <azure.devops.v5_0.work_item_tracking.models.QueryHierarchyItem>`
    :param clauses: The clauses for a flat query.
    :type clauses: :class:`WorkItemQueryClause <azure.devops.v5_0.work_item_tracking.models.WorkItemQueryClause>`
    :param columns: The columns of the query.
    :type columns: list of :class:`WorkItemFieldReference <azure.devops.v5_0.work_item_tracking.models.WorkItemFieldReference>`
    :param created_by: The identity who created the query item.
    :type created_by: :class:`IdentityReference <azure.devops.v5_0.work_item_tracking.models.IdentityReference>`
    ...
    :type last_executed_by: :class:`IdentityReference <azure.devops.v5_0.work_item_tracking.models.IdentityReference>`
    ...
    :type last_modified_by: :class:`IdentityReference <azure.devops.v5_0.work_item_tracking.models.IdentityReference>`
    :param last_modified_date: When the query item was last modified.
    :type last_modified_date: datetime
    :param link_clauses: The link query clause.
    :type link_clauses: :class:`WorkItemQueryClause <azure.devops.v5_0.work_item_tracking.models.WorkItemQueryClause>`
    ...
    :type source_clauses: :class:`WorkItemQueryClause <azure.devops.v5_0.work_item_tracking.models.WorkItemQueryClause>`
    :param target_clauses: The target clauses in a tree or one-hop link query.
    :type target_clauses: :class:`WorkItemQueryClause <azure.devops.v5_0.work_item_tracking.models.WorkItemQueryClause>`
...
class WorkItem(WorkItemTrackingResource):
    ...
    :type relations: list of :class:`WorkItemRelation <azure.devops.v5_0.work_item_tracking.models.WorkItemRelation>`
...
class WorkItemClassificationNode(WorkItemTrackingResource):
    ...
    :type children: list of :class:`WorkItemClassificationNode <azure.devops.v5_0.work_item_tracking.models.WorkItemClassificationNode>`
...
class WorkItemComments(WorkItemTrackingResource):
    ...
    :type comments: list of :class:`WorkItemComment <azure.devops.v5_0.work_item_tracking.models.WorkItemComment>`
...
class WorkItemField(WorkItemTrackingResource):
    ...
    :type supported_operations: list of :class:`WorkItemFieldOperation <azure.devops.v5_0.work_item_tracking.models.WorkItemFieldOperation>`
