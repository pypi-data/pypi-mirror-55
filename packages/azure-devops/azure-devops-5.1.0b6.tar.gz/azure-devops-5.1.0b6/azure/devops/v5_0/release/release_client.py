...
class ReleaseClient(Client):
    ...
    def update_release_environment(self, environment_update_data, project, release_id, environment_id):
        ...
        :param :class:`<ReleaseEnvironmentUpdateMetadata> <azure.devops.v5_0.release.models.ReleaseEnvironmentUpdateMetadata>` environment_update_data: Environment update meta data.
        :param str project: Project ID or project name
    ...
    def update_gates(self, gate_update_metadata, project, gate_step_id):
        ...
        :param :class:`<GateUpdateMetadata> <azure.devops.v5_0.release.models.GateUpdateMetadata>` gate_update_metadata: Metadata to patch the Release Gates.
        :param str project: Project ID or project name
        :param int gate_step_id: Gate step Id.
        :rtype: :class:`<ReleaseGates> <azure.devops.v5_0.release.models.ReleaseGates>`
        """
        route_values = {}
        if project is not None:
            route_values['project'] = self._serialize.url('project', project, 'str')
