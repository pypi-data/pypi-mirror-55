...
class FeedBatchData(Model):
    ...
    :param data:
    :type data: :class:`FeedBatchOperationData <azure.devops.v5_0.packaging.models.FeedBatchOperationData>`
    :param operation:
...
class FeedChange(Model):
    ...
    :type feed: :class:`Feed <azure.devops.v5_0.packaging.models.Feed>`
...
class FeedChangesResponse(Model):
    ...
    :param _links:
    :type _links: :class:`ReferenceLinks <azure.devops.v5_0.packaging.models.ReferenceLinks>`
    ...
    :type feed_changes: list of :class:`FeedChange <azure.devops.v5_0.packaging.models.FeedChange>`
...
class FeedCore(Model):
    ...
    :type upstream_sources: list of :class:`UpstreamSource <azure.devops.v5_0.packaging.models.UpstreamSource>`
    :param view: Definition of the view.
    :type view: :class:`FeedView <azure.devops.v5_0.packaging.models.FeedView>`
...
class FeedPermission(Model):
    ...
    :type identity_descriptor: :class:`str <azure.devops.v5_0.packaging.models.str>`
...
class FeedRetentionPolicy(Model):
    ...
    :param age_limit_in_days: Used for legacy scenarios and may be removed in future versions.
...
class MinimalPackageVersion(Model):
    ...
    :type views: list of :class:`FeedView <azure.devops.v5_0.packaging.models.FeedView>`
    """
...
class Package(Model):
    ...
    :type versions: list of :class:`MinimalPackageVersion <azure.devops.v5_0.packaging.models.MinimalPackageVersion>`
    """
...
class PackageChange(Model):
    ...
    :type package: :class:`Package <azure.devops.v5_0.packaging.models.Package>`
    :param package_version_change: Change that was performed on a package version.
    :type package_version_change: :class:`PackageVersionChange <azure.devops.v5_0.packaging.models.PackageVersionChange>`
    """
...
class PackageChangesResponse(Model):
    ...
    :type package_changes: list of :class:`PackageChange <azure.devops.v5_0.packaging.models.PackageChange>`
    """
...
class PackageFile(Model):
    ...
    :type children: list of :class:`PackageFile <azure.devops.v5_0.packaging.models.PackageFile>`
    :param name: File name.
    :type name: str
    :param protocol_metadata: Extended data unique to a specific package type.
    :type protocol_metadata: :class:`ProtocolMetadata <azure.devops.v5_0.packaging.models.ProtocolMetadata>`
    """
...
class PackageVersion(MinimalPackageVersion):
    ...
    :type dependencies: list of :class:`PackageDependency <azure.devops.v5_0.packaging.models.PackageDependency>`
    ...
    :type files: list of :class:`PackageFile <azure.devops.v5_0.packaging.models.PackageFile>`
    :param other_versions: Other versions of this package.
    :type other_versions: list of :class:`MinimalPackageVersion <azure.devops.v5_0.packaging.models.MinimalPackageVersion>`
    ...
    :type source_chain: list of :class:`UpstreamSource <azure.devops.v5_0.packaging.models.UpstreamSource>`
...
class PackageVersionChange(Model):
    ...
    :type package_version: :class:`PackageVersion <azure.devops.v5_0.packaging.models.PackageVersion>`
    """
...
class PackageVersionProvenance(Model):
    ...
    :type provenance: :class:`Provenance <azure.devops.v5_0.packaging.models.Provenance>`
    """
...
class Feed(FeedCore):
    ...
    :type permissions: list of :class:`FeedPermission <azure.devops.v5_0.packaging.models.FeedPermission>`
