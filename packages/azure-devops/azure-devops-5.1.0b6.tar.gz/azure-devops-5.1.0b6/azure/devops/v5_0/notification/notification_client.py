...
class NotificationClient(Client):
    ...
    def get_subscription_diagnostics(self, subscription_id):
        ...
        :rtype: :class:`<SubscriptionDiagnostics> <azure.devops.v5_0.notification.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def update_subscription_diagnostics(self, update_parameters, subscription_id):
        ...
        [Preview API]
        :param :class:`<UpdateSubscripitonDiagnosticsParameters> <azure.devops.v5_0.notification.models.UpdateSubscripitonDiagnosticsParameters>` update_parameters:
        :param str subscription_id:
        :rtype: :class:`<SubscriptionDiagnostics> <azure.devops.v5_0.notification.models.SubscriptionDiagnostics>`
        """
        route_values = {}
    ...
    def publish_event(self, notification_event):
        ...
        :param :class:`<VssNotificationEvent> <azure.devops.v5_0.notification.models.VssNotificationEvent>` notification_event:
        :rtype: :class:`<VssNotificationEvent> <azure.devops.v5_0.notification.models.VssNotificationEvent>`
        """
    ...
    def get_subscriber(self, subscriber_id):
        ...
        :rtype: :class:`<NotificationSubscriber> <azure.devops.v5_0.notification.models.NotificationSubscriber>`
        """
        route_values = {}
    ...
    def update_subscriber(self, update_parameters, subscriber_id):
        """UpdateSubscriber.
        [Preview API]
        :param :class:`<NotificationSubscriberUpdateParameters> <azure.devops.v5_0.notification.models.NotificationSubscriberUpdateParameters>` update_parameters:
        :param str subscriber_id:
        :rtype: :class:`<NotificationSubscriber> <azure.devops.v5_0.notification.models.NotificationSubscriber>`
        """
        route_values = {}
    ...
    def create_subscription(self, create_parameters):
        ...
        :param :class:`<NotificationSubscriptionCreateParameters> <azure.devops.v5_0.notification.models.NotificationSubscriptionCreateParameters>` create_parameters:
