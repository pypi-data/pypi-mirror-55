...
try:
    ...
    class GeneratedsSuper(object):
        ...
        def gds_parse_time(cls, input_data):
            ...
            return dt.time()
        @staticmethod
        def gds_validate_primitive_type(
                validator, value, input_name, gds_collector):
            try:
                validator(value, input_name=input_name)
            except GDSParseError as parse_error:
                gds_collector.add_message(str(parse_error))
...
class containerType(GeneratedsSuper):
    ...
    def validate_(self, gds_collector, recursive=False):
        ...
        if recursive:
            self.sample1.validate_(gds_collector, recursive=True)
            self.sample2_bad.validate_(gds_collector, recursive=True)
            self.sample3_bad.validate_(gds_collector, recursive=True)
            self.sample4_bad.validate_(gds_collector, recursive=True)
            self.sample2.validate_(gds_collector, recursive=True)
...
class simpleOneType(GeneratedsSuper):
    ...
    def validate_(self, gds_collector, recursive=False):
        ...
        message_count = len(self.gds_collector_.get_messages())
        # validate simple type attributes
        self.validate_integer_range_1_st(self.integer_range_1_value_with_default)
        # validate simple type children
        self.validate_integer_range_1_st(self.integer_range_1_value)
        self.validate_pattern_st(self.pattern_value)
        self.validate_token_enum_st(self.token_enum_value)
        ...
        self.validate_integer_range_A_2_st(self.simpletype2a)
        self.validate_anonymous_float_valueType(self.anonymous_float_value)
        self.gds_validate_primitive_type(self.gds_validate_integer, self.primative_integer, 'primative_integer', self.gds_collector_)
        self.gds_validate_primitive_type(self.gds_validate_float, self.primative_float, 'primative_float', self.gds_collector_)
        # validate complex type children
        if recursive:
            pass
        return message_count == len(self.gds_collector_.get_messages())
