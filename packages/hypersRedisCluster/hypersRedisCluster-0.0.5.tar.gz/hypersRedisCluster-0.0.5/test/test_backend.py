...
class CacheTestCaset(unittest.TestCase):
    def setUp(self):
        self.cache = cache
        try:
            self.cache.clear()
    ...
    def test_set(self):
        self.cache.set("keya", "value of key a", 10)
        value = cache.get("keya")
        self.assertEqual(value, "value of key a")

    def test_timeout(self):
        self.cache.set("key_timeout", "timeout", 3)
        sleep(3)
        value = cache.get("key_timeout")
