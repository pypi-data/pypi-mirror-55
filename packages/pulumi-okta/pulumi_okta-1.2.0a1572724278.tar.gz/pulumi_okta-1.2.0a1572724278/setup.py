...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v1.2.0-alpha.1572724278+gee3b291'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v1.2.0-alpha.1572724278+gee3b291`
                """)
            else:
                raise
