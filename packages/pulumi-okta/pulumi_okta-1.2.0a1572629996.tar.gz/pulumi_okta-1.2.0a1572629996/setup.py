...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v1.2.0-alpha.1572629996+gc1d93f2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v1.2.0-alpha.1572629996+gc1d93f2`
                """)
            else:
                raise
