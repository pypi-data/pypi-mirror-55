...
def plot_diagram(x_name, y_name, ax, fig, z_name = ' ', mass_min = 0.5, mass_max = 6.0, color_log = False, isochrones = [], specialIsoschrones = [], specialColor = []):
    masses = np.linspace(np.log10(0.5),np.log10(10), 40)
    masses = 10**masses
    path = get_path()
