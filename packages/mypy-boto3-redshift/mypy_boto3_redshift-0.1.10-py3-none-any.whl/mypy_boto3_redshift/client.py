...
class Client(BaseClient):
    ...
    def modify_cluster_maintenance(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/ModifyClusterMaintenance>`_
    ...
    def modify_cluster_snapshot(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/ModifyClusterSnapshot>`_
