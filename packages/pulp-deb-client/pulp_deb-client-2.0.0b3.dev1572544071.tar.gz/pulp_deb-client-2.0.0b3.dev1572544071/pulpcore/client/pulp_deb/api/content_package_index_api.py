...
class ContentPackageIndexApi(object):
    ...
    def create(self, data, **kwargs):  # noqa: E501
        ...
        :param PackageIndex data: (required)
    ...
    def create_with_http_info(self, data, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PackageIndex, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/deb/package_index/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='PackageIndex',  # noqa: E501
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/pulp/api/v3/content/deb/package_index/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read(self, package_index_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str package_index_href: URI of Package Index. e.g.: /pulp/api/v3/content/deb/package_index/1/ (required)
        :param str fields: A list of fields to include in the response.
        :param str exclude_fields: A list of fields to exclude from the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
