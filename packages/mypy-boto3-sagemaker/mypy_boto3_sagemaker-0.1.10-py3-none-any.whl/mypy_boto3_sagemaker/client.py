...
class Client(BaseClient):
    ...
    def create_code_repository(
        ...
        The repository can be hosted either in `AWS CodeCommit <https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html>`__ or in any other Git repository.
    ...
    def create_endpoint(
        ...
        If any of the models hosted at this endpoint get model data from an Amazon S3 location, Amazon SageMaker uses AWS Security Token Service to download model artifacts from the S3 path you provided. AWS STS is activated in your IAM user account by default. If you previously deactivated AWS STS for a region, you need to reactivate AWS STS for that region. For more information, see `Activating and Deactivating AWS STS i an AWS Region <IAM/latest/UserGuide/id_credentials_temp_enable-regions.html>`__ in the *AWS Identity and Access Management User Guide* .
        ...
        **Request Syntax**
        ...
        :param ProductionVariants: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **AcceleratorType** *(string) --*
              ...
              The size of the Elastic Inference (EI) instance to use for the production variant. EI instances provide on-demand GPU computing for inference. For more information, see `Using Elastic Inference in Amazon SageMaker <https://docs.aws.amazon.com/sagemaker/latest/dg/ei.html>`__ .

        :type Tags: list
        :param Tags:

          A list of key-value pairs. For more information, see `Using Cost Allocation Tags <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html#allocation-what>`__ in the *AWS Billing and Cost Management User Guide* .
        ...
        :param KmsKeyId:
          ...
          .. note::
            ...
            For a list of nitro-based instances, see `Nitro-based Instances <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html#ec2-nitro-instances>`__ in the *Amazon Elastic Compute Cloud User Guide for Linux Instances* .

            For more information about storage volumes on nitro-based instances, see `Amazon EBS and NVMe on Linux Instances <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/nvme-ebs-volumes.html>`__ .
        ...
        **Request Syntax**
        ...
        :param HyperParameterTuningJobConfig: **[REQUIRED]**
            ...
            - **IntegerParameterRanges** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ScalingType** *(string) --*
                  ...
                  The scale that hyperparameter tuning uses to search the hyperparameter range. For information about choosing a hyperparameter scale, see `Hyperparameter Scaling <https://docs.aws.amazon.com/sagemaker/latest/dg/automatic-model-tuning-define-ranges.html#scaling-type>`__ . One of the following values:
          ...
          - **TrainingJobEarlyStoppingType** *(string) --*
            ...
            Amazon SageMaker stops training jobs launched by the hyperparameter tuning job when they are unlikely to perform better than previously completed training jobs. For more information, see `Stop Training Jobs Early <https://docs.aws.amazon.com/sagemaker/latest/dg/automatic-model-tuning-early-stopping.html>`__ .
        ...
        :param Tags:
          ...
          An array of key-value pairs. You can use tags to categorize your AWS resources in different ways, for example, by purpose, owner, or environment. For more information, see `AWS Tagging Strategies <https://docs.aws.amazon.com/https:/aws.amazon.com/answers/account-management/aws-tagging-strategies/>`__ .
        ...
        **Request Syntax**
        ...
        :param OutputConfig: **[REQUIRED]**
          ...
          - **KmsKeyId** *(string) --*
            ...
            The KMS key policy must grant permission to the IAM role that you specify in your ``CreateLabelingJob`` request. For more information, see `Using Key Policies in AWS KMS <http://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html>`__ in the *AWS Key Management Service Developer Guide* .
        ...
        :param HumanTaskConfig: **[REQUIRED]**
          ...
          - **UiConfig** *(dict) --* **[REQUIRED]**
            ...
            - **UiTemplateS3Uri** *(string) --* **[REQUIRED]**
              ...
              The Amazon S3 bucket location of the UI template. For more information about the contents of a UI template, see `Creating Your Custom Labeling Task Template <https://docs.aws.amazon.com/sagemaker/latest/dg/sms-custom-templates-step2.html>`__ .
          ...
          - **AnnotationConsolidationConfig** *(dict) --* **[REQUIRED]**
            ...
            - **AnnotationConsolidationLambdaArn** *(string) --* **[REQUIRED]**
              ...
              * *Named entity eecognition* - Groups similar selections and calculates aggregate boundaries, resolving to most-assigned label.  ``arn:aws:lambda:us-east-1:432418664414:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:us-east-2:266458841044:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:us-west-2:081040173940:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:eu-west-1:568282634449:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:ap-northeast-1:477331159723:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:ap-southeast-2:454466003867:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:ap-south-1:565803892007:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:eu-central-1:203001061592:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:ap-northeast-2:845288260483:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:eu-west-2:487402164563:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:ap-southeast-1:377565633583:function:ACS-NamedEntityRecognition``    ``arn:aws:lambda:ca-central-1:918755190332:function:ACS-NamedEntityRecognition``
              ...
              For more information, see `Annotation Consolidation <https://docs.aws.amazon.com/sagemaker/latest/dg/sms-annotation-consolidation.html>`__ .
    ...
    def create_model(
        ...
        **Request Syntax**
        ...
        :param VpcConfig:
          ...
          A `VpcConfig <https://docs.aws.amazon.com/sagemaker/latest/dg/API_VpcConfig.html>`__ object that specifies the VPC that you want your model to connect to. Control access to and from your model container by configuring the VPC. ``VpcConfig`` is used in hosting services and in batch transform. For more information, see `Protect Endpoints by Using an Amazon Virtual Private Cloud <https://docs.aws.amazon.com/sagemaker/latest/dg/host-vpc.html>`__ and `Protect Data in Batch Transform Jobs by Using an Amazon Virtual Private Cloud <https://docs.aws.amazon.com/sagemaker/latest/dg/batch-vpc.html>`__ .
    ...
    def create_notebook_instance(
        ...
        **Request Syntax**
        ...
        :param AcceleratorTypes:
          ...
          A list of Elastic Inference (EI) instance types to associate with this notebook instance. Currently, only one instance type can be associated with a notebook instance. For more information, see `Using Elastic Inference in Amazon SageMaker <https://docs.aws.amazon.com/sagemaker/latest/dg/ei.html>`__ .
    ...
    def create_training_job(
        ...
        * ``EnableManagedSpotTraining`` - Optimize the cost of training machine learning models by up to 80% by using Amazon EC2 Spot instances. For more information, see `Managed Spot Training <https://docs.aws.amazon.com/sagemaker/latest/dg/model-managed-spot-training.html>`__ .
    ...
    def create_transform_job(
        ...
        **Request Syntax**
        ...
        :param DataProcessing:
          ...
          The data structure used to specify the data to be used for inference in a batch transform job and to associate the data that is relevant to the prediction results in the output. The input filter provided allows you to exclude input data that is not needed for inference in a batch transform job. The output filter provided allows you to include input data relevant to interpreting the predictions in the output from the job. For more information, see `Associate Prediction Results with their Corresponding Input Records <https://docs.aws.amazon.com/sagemaker/latest/dg/batch-transform-data-processing.html>`__ .

          - **InputFilter** *(string) --*

            A `JSONPath <https://docs.aws.amazon.com/sagemaker/latest/dg/batch-transform-data-processing.html#data-processing-operators>`__ expression used to select a portion of the input data to pass to the algorithm. Use the ``InputFilter`` parameter to exclude fields, such as an ID column, from the input. If you want Amazon SageMaker to pass the entire input dataset to the algorithm, accept the default value ``$`` .

            Examples: ``"$"`` , ``"$[1:]"`` , ``"$.features"``

          - **OutputFilter** *(string) --*

            A `JSONPath <https://docs.aws.amazon.com/sagemaker/latest/dg/batch-transform-data-processing.html#data-processing-operators>`__ expression used to select a portion of the joined dataset to save in the output file for a batch transform job. If you want Amazon SageMaker to store the entire input dataset in the output file, leave the default value, ``$`` . If you specify indexes that aren't within the dimension size of the joined dataset, you get an error.
    ...
    def create_workteam(
        ...
        **Request Syntax**
        ...
        :param MemberDefinitions: **[REQUIRED]**
          ...
          A list of ``MemberDefinition`` objects that contains objects that identify the Amazon Cognito user pool that makes up the work team. For more information, see `Amazon Cognito User Pools <https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-identity-pools.html>`__ .
        ...
        :param Tags:
          ...
          For more information, see `Resource Tag <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html>`__ and `Using Cost Allocation Tags <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html#allocation-what>`__ in the *AWS Billing and Cost Management User Guide* .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AcceleratorTypes** *(list) --*
              ...
              A list of the Elastic Inference (EI) instance types associated with this notebook instance. Currently only one EI instance type can be associated with a notebook instance. For more information, see `Using Elastic Inference in Amazon SageMaker <sagemaker/latest/dg/ei.html>`__ .
                ...
                'CompilationJobSummaries': [
                    {
                        ...
                        'CompilationStartTime': datetime(2015, 1, 1),
                        'CompilationEndTime': datetime(2015, 1, 1),
                        'CompilationTargetDevice': 'lambda'|'ml_m4'|'ml_m5'|'ml_c4'|'ml_c5'|'ml_p2'|'ml_p3'|'jetson_tx1'|'jetson_tx2'|'jetson_nano'|'rasp3b'|'deeplens'|'rk3399'|'rk3288'|'aisage'|'sbe_c'|'qcs605'|'qcs603',
                        'LastModifiedTime': datetime(2015, 1, 1),
                        'CompilationJobStatus': 'INPROGRESS'|'COMPLETED'|'FAILED'|'STARTING'|'STOPPING'|'STOPPED'
                    },
                ],
    ...
    def update_notebook_instance(
        ...
        **Request Syntax**
        ...
        :param AcceleratorTypes:
          ...
          A list of the Elastic Inference (EI) instance types to associate with this notebook instance. Currently only one EI instance type can be associated with a notebook instance. For more information, see `Using Elastic Inference in Amazon SageMaker <sagemaker/latest/dg/ei.html>`__ .
