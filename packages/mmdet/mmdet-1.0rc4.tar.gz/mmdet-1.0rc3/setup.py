...
if __name__ == '__main__':
    ...
    setup(
        ...
        long_description='Refer to github',
        author='OpenMMLab',
        ...
        install_requires=['mmcv>=0.2.10', 'numpy', 'matplotlib', 'six', 'terminaltables', 'pycocotools', 'torch>=1.1', 'torchvision', 'imagecorruptions', 'albumentations>=0.3.2'],
        ext_modules=[
            make_cython_ext(
                name='soft_nms_cpu',
