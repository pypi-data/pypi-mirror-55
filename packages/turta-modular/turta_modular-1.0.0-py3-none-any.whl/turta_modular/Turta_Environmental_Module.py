...
# Python Library for Bosch Sensortec BME680 Environmental Sensor.
# Version 1.01
...
class BME680Sensor:
    ...
    def configure_sensor(self, temperature_oversampling, pressure_oversampling, humidity_oversampling, iir_filter, heat_duration, heat_temperature):
        ...
        Parameters:
        temperature_oversampling (TemperatureOversamplings): Temperature oversampling
        pressure_oversampling (PressureOversamplings): Pressure oversampling
        humidity_oversampling (HumidityOversamplings): Humidity oversampling
        iir_filter (IIRFilterCoefficients): IIR Filter
        heat_duration (int): Gas sensor heat duration in ms. Max value is 252
        heat_temperature (int): Gas sensor heat temperature in C. Max value is 400"""
    ...
    def _compensate_temperature(self, tempADC):
        ...
        Parameters:
        tempADC (int): Analog temperature value"""
    ...
    def _compensate_pressure(self, presADC):
        ...
        Parameters:
        presADC (int): Analog pressure value"""
    ...
    def _compensate_humidity(self, humADC):
        ...
        Parameters:
        humADC (int): Analog humidity value"""
    ...
    def _force_read(self, gas_measurement_enabled):
        ...
        Parameters:
        gas_measurement_enabled (bool): Enable or disable gas measurement"""
    ...
    def read_altitude(self, meanSeaLevelPressureInBar):
        ...
        Parameters:
        meanSeaLevelPressureInBar (float): Mean sea level pressure in bar. Will be used for altitude calculation from the pressure
    ...
    def read_tph(self):
        ...
        Returns:
        float array: Temperature, pressure and relative humidity, respectively"""
    ...
    def _set_gas_measurement(self, state):
        ...
        Parameters:
        state (bool): Gas measurement mode. True for on, false for off"""
    ...
    def _select_heater_profile_setpoint(self, heaterProfileSetPoint):
        ...
        Parameters:
        heaterProfileSetPoint (HeaterProfileSetPoints): Heater profile set-point"""
    ...
    def _get_gas_measuring_status(self):
        ...
        Returns:
        bool: Gas measurement running status"""
    ...
    def _calculate_heat_duration(self, dur):
        ...
        Parameters:
        dur (int): Wait duration in ms (Max value is 252)

        Returns:
        int: Gas sensor wait time"""
