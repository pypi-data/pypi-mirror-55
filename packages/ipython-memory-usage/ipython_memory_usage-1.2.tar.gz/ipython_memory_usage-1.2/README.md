...
To push to PyPI I need to follow https://docs.python.org/3/distributing/index.html#distributing-index - specifically:

* bump the version number in `setup.py` and `ipython_memory_usage.py`
* `python setup.py sdist`
* `twine upload dist/*`. This uses https://pypi.org/project/twine/ .
