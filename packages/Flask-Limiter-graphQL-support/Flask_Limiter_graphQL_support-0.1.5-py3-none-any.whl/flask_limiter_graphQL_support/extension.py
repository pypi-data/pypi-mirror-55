...
from flask_limiter_graphQL_support.wrappers import Limit, LimitGroup
...
class Limiter(object):
    ...
    def __check_request_limit(self, in_middleware=True, obj=None):
            ...
            if isinstance(obj, Blueprint):
                ...
                def __inner(*a, **k):
                    if self._auto_check and not g.get("_rate_limiting_complete"):
                        self.__check_request_limit(False, obj)
