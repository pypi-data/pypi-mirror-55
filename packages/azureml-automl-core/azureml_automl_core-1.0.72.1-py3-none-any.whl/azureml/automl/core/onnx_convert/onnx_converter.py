...
class OnnxConverter:
    ...
    class _SplitOnnxModelName(Enum):
    ...
    def _convert_featurizer_model(self, model, model_name, model_desc, target_opset):
        ...
        if isinstance(model_desc, dict):
            ...
            desc_str = str(model_desc)
        mdl_name = "{}_{}".format(model_name, self._SplitOnnxModelName.FeaturizerOnnxModel.name)
    ...
    def _convert_estimator_model(self, model, model_name, model_desc, target_opset,
        ...
        if isinstance(model_desc, dict):
            ...
            desc_str = str(model_desc)
        mdl_name = "{}_{}".format(model_name, self._SplitOnnxModelName.EstimatorOnnxModel.name)
