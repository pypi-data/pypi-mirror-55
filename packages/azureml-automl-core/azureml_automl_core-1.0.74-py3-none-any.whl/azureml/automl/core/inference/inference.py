...
AutoMLCondaPackagesList = ['numpy>=1.16.0,<=1.16.2', 'pandas',
                           'scikit-learn', 'py-xgboost<=0.80', 'fbprophet==0.5', 'psutil>=5.2.2,<6.0.0']
AutoMLPipPackagesList = ['azureml-train-automl', 'inference-schema', 'azureml-explain-model', 'azureml-defaults']
