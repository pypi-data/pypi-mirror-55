...
class Client(BaseClient):
    ...
    def get_rightsizing_recommendation(
        ...
        Recommendations are generated to either downsize or terminate instances, along with providing savings detail and metrics. For details on calculation and function, see `Optimizing Your Cost with Rightsizing Recommendations <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ce-what-is.html>`__ .

        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/GetRightsizingRecommendation>`_
    ...
    def get_savings_plans_coverage(
        ...
        * ``INSTANCE_FAMILY``
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/GetSavingsPlansCoverage>`_
        ...
        **Request Syntax**
        ...
        :param Filter:
          ...
          * ``INSTANCE_FAMILY``
           ...
           ``GetSavingsPlansCoverage`` uses the same `Expression <http://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Expression.html>`__ object as the other operations, but only ``AND`` is supported among each dimension. If there are multiple values for a dimension, they are OR'd together.
    ...
    def get_savings_plans_purchase_recommendation(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/GetSavingsPlansPurchaseRecommendation>`_
    ...
    def get_savings_plans_utilization(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/GetSavingsPlansUtilization>`_
        ...
        **Request Syntax**
        ...
        :param Filter:
          ...
          * ``INSTANCE_TYPE_FAMILY``
           ...
           ``GetSavingsPlansUtilization`` uses the same `Expression <http://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Expression.html>`__ object as the other operations, but only ``AND`` is supported among each dimension. If there are multiple values for a dimension, they are OR'd together.
        ...
        **Request Syntax**
        ...
        :param Filter:
          ...
          * ``INSTANCE_TYPE_FAMILY``
           ...
           ``GetSavingsPlansUtilizationDetails`` uses the same `Expression <http://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Expression.html>`__ object as the other operations, but only ``AND`` is supported among each dimension. If there are multiple values for a dimension, they are OR'd together.
    ...
    def get_usage_forecast(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/GetUsageForecast>`_
