GGG2014 TCCON data from Orleans, France (47.97 N,2.11 E).
The data cover dates starting from 20090829 through 20171128.
...
The site page for Orleans, France is:
https://tccon-wiki.caltech.edu/Sites/Orleans

Below is a description of the contents of the Orleans, France .nc file:
netcdf or20090829_20171128.public {
dimensions:
	a20 = 20 ;
	a32 = 32 ;
	a4 = 4 ;
...
// global attributes:
		...
		:id = "or" ;
		:longName = "orleans01" ;
		:Contact = "Thorsten Warneke <warneke@iup.physik.uni-bremen.de>" ;
		:Location = "Orleans, France" ;
		:Data_DOI = "10.14291/tccon.ggg2014.orleans01.R0/1149276" ;
		:Data_Reference = "Warneke, T., J. Messerschmidt, J. Notholt, C. Weinzierl, N. Deutscher, C. Petri, P. Grupe, C. Vuillemin, F. Truong, M. Schmidt, M. Ramonet, E. Parmentier. 2017. TCCON data from Orleans, France, Release GGG2014R0. TCCON data archive, hosted by CaltechDATA, California Institute of Technology, Pasadena, CA, U.S.A. https://doi.org/10.14291/tccon.ggg2014.orleans01.R0/1149276" ;
		:Data_Revision = "R0" ;
