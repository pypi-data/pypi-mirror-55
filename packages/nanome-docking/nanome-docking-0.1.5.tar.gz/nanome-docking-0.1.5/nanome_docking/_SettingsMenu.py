...
class SettingsMenu():
    def __init__(self, docking_plugin, closed_callback):
        ...
        self._menu = nanome.ui.Menu.io.from_json(os.path.join(os.path.dirname(__file__), '_advanced_settings.json'))
        ...
        self._btn_score_all_frames.register_pressed_callback()
    
    def get_score_frames(self):
        return self._score_all_frames

    def toggle_score_all_frames(self):
