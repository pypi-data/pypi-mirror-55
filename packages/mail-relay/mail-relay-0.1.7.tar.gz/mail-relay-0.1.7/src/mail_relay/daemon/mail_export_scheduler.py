from mail_relay.mail.helpers import decrypt_server_message, get_email_mime, get_wrapped_key, wrap_for_export
...
class MailExportScheduler():
    ...
    def export_user_mails(self, member, export_state):
        has_more = True
        ...
        while has_more:
            ...
            for m in email_updates['messages']:
                ...
                try:
                    ...
                    g_log.error('error decryption email {}'.format(m['id']))
                    g_log.exception(e)
                    continue
