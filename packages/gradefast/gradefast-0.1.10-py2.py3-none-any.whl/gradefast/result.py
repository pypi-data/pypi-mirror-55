...
class Result:
    ...
    def __repr__(self):
        ...
        + "exec_time: {}, pkg_path: {}, comment: {})".format(self.exec_time, 
        self.pkg_path, self.comment)
    ...
    def to_flat_dict(self, result_params_prefix='result_param'):
        ...
        return {'team_id': self.team_id, 'file': self.file, 
        'exec_time': self.exec_time, 'pkg_path': self.pkg_path,
        **flattened_dict, 'comment': self.comment}
...
class ResultGroup:
    ...
    def to_flattened_list(self):
        flattened_results = []
        for result in self:
            flattened_results.append(result.to_flat_dict())
    ...
    def to_csv(self, save_location):
        ...
        try:
            # create csv
            list_of_dictionary = self.to_flattened_list()
