...
class ComponentTest:
    ...
    def test_create_valid(self, count=1):
        ...
        for valids in self.comp.get_valids(Endpoints.CREATE, count):
            ...
            with Instance(self.comp, **valids) as instance:
                for k,v in valids.items():
                    ...
                    assert v == self.comp.endpoints.prop_from_res(instance.data, k)
