          ...
          - *(dict) --*
            ...
            - **EventStream** (:class:`.EventStream`) --
              ...
              - **KMSInvalidStateException** *(dict) --*
                ...
                The request was rejected because the state of the specified resource isn't valid for this request. For more information, see `How Key State Affects Use of a Customer Master Key <http://docs.aws.amazon.com/kms/latest/developerguide/key-state.html>`__ in the *AWS Key Management Service Developer Guide* .
              ...
              - **KMSThrottlingException** *(dict) --*
                ...
                The request was denied due to request throttling. For more information about throttling, see `Limits <http://docs.aws.amazon.com/kms/latest/developerguide/limits.html#requests-per-second>`__ in the *AWS Key Management Service Developer Guide* .
