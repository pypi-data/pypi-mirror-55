...
class ContainerCollectionOutput(CollectionMixin):
    ...
    def __init__(self, label=None, info=None, description=None, contents=None, id=None, info_exists=None, curator=None, created=None, modified=None, permissions=None, files=None, notes=None, tags=None, analyses=None):  # noqa: E501
