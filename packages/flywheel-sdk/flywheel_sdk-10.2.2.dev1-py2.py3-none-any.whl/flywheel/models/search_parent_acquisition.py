...
class SearchParentAcquisition(AcquisitionMixin):
    ...
    def __init__(self, label=None, info=None, session=None, uid=None, timestamp=None, timezone=None, id=None, parents=None, collections=None, files=None, created=None, modified=None, info_exists=None, permissions=None, notes=None, tags=None, analyses=None):  # noqa: E501
