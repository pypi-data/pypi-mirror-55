...
class SearchParentSession(ProjectMixin):
    ...
    def __init__(self, operator=None, label=None, info=None, project=None, uid=None, timestamp=None, timezone=None, subject=None, age=None, weight=None, id=None, info_exists=None, parents=None, created=None, modified=None, permissions=None, group=None, project_has_template=None, satisfies_template=None, files=None, notes=None, tags=None, analyses=None):  # noqa: E501
