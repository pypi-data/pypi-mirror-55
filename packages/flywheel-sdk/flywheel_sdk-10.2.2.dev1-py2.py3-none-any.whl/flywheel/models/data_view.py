...
class DataView(object):
    ...
    def __init__(self, parent=None, label=None, description=None, columns=None, file_spec=None, include_ids=None, include_labels=None, missing_data_strategy=None, id=None, origin=None):  # noqa: E501
