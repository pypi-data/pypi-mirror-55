...
vspec = importlib.util.spec_from_file_location(
  "version",
  str(Path(__file__).resolve().parent / 'jsendit' / "version.py")
)
...
setup(
    name='jsendit',
    description="This is a way simple library to help you format JSend messages.",
    ...
    url='https://github.com/patdaburu/jsendit',
    download_url=(
        f'https://github.com/patdaburu/'
        f'jsendit/archive/{version}.tar.gz'
    ),
    keywords=[
