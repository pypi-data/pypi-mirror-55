...
__version__ = '2.1.10'   # {major dotnet version}.{minor dotnet version}.{revision}
# We can rev the revision due to patch-level change in .net or changes in dependencies

# Manually specifiying '2.1.9' here is a temporary hack to hotfix not using the amldownloads cdn.
deps_url_base = 'https://azuremldownloads.azureedge.net/dotnetcore2-dependencies/' + '2.1.9' + '/'
dist = None
version = None
