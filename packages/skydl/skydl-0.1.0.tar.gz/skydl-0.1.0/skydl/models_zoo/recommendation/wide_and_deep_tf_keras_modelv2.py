...
class WideAndDeepTfKerasModelV2(TfKerasModelV2):
    ...
    def adjust_parse_args_value(self):
        ...
        self.parser_args.model_version = '20191107010'
    ...
    def predict_from_load_model(self, *args, **kwargs):
        ...
        self.log.info("already called load_model from: " + self.get_model_saved_dir() + "/saved_model.h5")
    ...
    def predict_from_load_weights(self, *args, **kwargs):
        ...
        self.log.info("predict_from_load_weights#get_model_checkpoint_dir=", self.get_model_checkpoint_dir())
