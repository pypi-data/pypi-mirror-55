...
class Google:
    def __init__(self):
        ...
        self._google_apps_grid_button = StaticElement(self._web_driver, "class=gb_b")
    ...
    def click_google_apps_grid_button(self):
        ...
        self._google_apps_grid_button.click()

        # Let's return the GoogleAppsList object.
        return GoogleAppsList(self._google_apps_list)
...
class GoogleAppsList:
    ...
    def wait_until_ready(self):
        ...
        self._element.wait_for().visible()
    ...
    def get_all_apps(self):
        ...
        return [GoogleApp(e) for e in self._element.find_elements("class=gb_Z")]
...
class GoogleApp:
    def __init__(self, element):
        ...
        self._name = StaticElement(self._element, "class=gb_4")

    def get_name(self):
        # get_text() doesn't work here, so use javascript
        # return self.name.get_text()
        return self._name.get_web_driver().execute_script('return arguments[0].innerText', self._name)
