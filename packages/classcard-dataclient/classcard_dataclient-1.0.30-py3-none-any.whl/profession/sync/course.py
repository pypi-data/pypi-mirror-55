...
from classcard_dataclient.models.course import Course, CourseTableManager, CourseCategory
...
class CourseSyncV1(BaseSync):
    ...
    def create_course(self, course_schedule, manager, forbidden_category=set()):
        ...
        for course_info in course_schedule:
            ...
            course.add_position(course_info['timeslot'], course_info['weekDay'], category)
    ...
    def sync(self):
        ...
        self.related_member()
        course_table = CourseTableManager(name=res['semester'], number=b64encode(res['semester'])[:20])
