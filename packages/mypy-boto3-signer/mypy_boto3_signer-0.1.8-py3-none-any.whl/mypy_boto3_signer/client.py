...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def cancel_signing_profile(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_signing_job(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_signing_platform(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_signing_profile(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_signing_jobs(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def list_signing_platforms(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def list_signing_profiles(self) -> None:
        pass
