...
setup(
    ...
    description='a try to make the setuptest for the CYBR CSCW-SUITE (CCS) available. After your 1.) wget sourceforge.net/projects/c-c-s/files/latest/download  & 2.) docker-compose up --build  3.) you simply run this setuptest for setting up and test your just deployed CCS on your own server',
