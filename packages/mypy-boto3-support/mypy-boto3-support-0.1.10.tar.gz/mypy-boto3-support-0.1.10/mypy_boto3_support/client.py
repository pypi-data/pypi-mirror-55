    ...
    def create_case(
        ...
        * **issueType.** The type of issue for the case. You can specify either "customer-service" or "technical." If you do not indicate a value, the default is "technical."
        ...
        .. note::
           ...
           Service limit increases are not supported by the Support API; you must submit service limit increase requests in `Support Center <https://console.aws.amazon.com/support>`__ . The ``caseId`` is not the ``displayId`` that appears in `Support Center <https://console.aws.amazon.com/support>`__ . You can use the  DescribeCases API to get the ``displayId`` .
        ...
        **Request Syntax**
        ...
        :param issueType:
          ...
          .. note::
            ...
            Service limit increases are not supported by the Support API; you must submit service limit increase requests in `Support Center <https://console.aws.amazon.com/support>`__ .
          ...
          - *(dict) --*
            ...
            - **severityLevels** *(list) --*
              ...
              - *(dict) --*
                ...
                A code and name pair that represents the severity level of a support case. The available values depend on the support plan for the account. For more information, see `Choosing a Severity <https://docs.aws.amazon.com/awssupport/latest/user/getting-started.html#choosing-severity>`__ .
                ...
                - **name** *(string) --*
                  ...
                  For more information, see `Choosing a Severity <https://docs.aws.amazon.com/awssupport/latest/user/getting-started.html#choosing-severity>`__
