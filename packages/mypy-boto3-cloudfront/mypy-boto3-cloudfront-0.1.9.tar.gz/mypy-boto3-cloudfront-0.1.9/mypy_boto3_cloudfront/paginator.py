...
class ListCloudFrontOriginAccessIdentities(Boto3Paginator):
    def paginate(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/cloudfront-2019-03-26/ListCloudFrontOriginAccessIdentities>`_
...
class ListDistributions(Boto3Paginator):
    def paginate(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/cloudfront-2019-03-26/ListDistributions>`_
              ...
              - **Items** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **Origins** *(dict) --*
                    ...
                    - **Items** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        For the current limit on the number of origins or origin groups that you can specify for a distribution, see `Amazon CloudFront Limits <https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits_cloudfront>`__ in the *AWS General Reference* .
                        ...
                        - **DomainName** *(string) --*
                          ...
                          For more information about specifying this value for different types of origins, see `Origin Domain Name <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesDomainName>`__ in the *Amazon CloudFront Developer Guide* .
                          ...
                          - **Items** *(list) --*
                            ...
                            - *(dict) --*
                              ...
                              - **HeaderName** *(string) --*
                                ...
                                The name of a header that you want CloudFront to forward to your origin. For more information, see `Forwarding Custom Headers to Your Origin (Web Distributions Only) <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/forward-custom-headers.html>`__ in the *Amazon CloudFront Developer Guide* .
                        ...
                        - **S3OriginConfig** *(dict) --*
                          ...
                          - **OriginAccessIdentity** *(string) --*
                            ...
                            For more information about the origin access identity, see `Serving Private Content through CloudFront <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html>`__ in the *Amazon CloudFront Developer Guide* .
                  ...
                  - **DefaultCacheBehavior** *(dict) --*
                    ...
                    - **ForwardedValues** *(dict) --*
                      ...
                      - **QueryString** *(boolean) --*
                        ...
                        For more information, see `Configuring CloudFront to Cache Based on Query String Parameters <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/QueryStringParameters.html>`__ in the *Amazon CloudFront Developer Guide* .
                      ...
                      - **Cookies** *(dict) --*
                        ...
                        - **WhitelistedNames** *(dict) --*
                          ...
                          For the current limit on the number of cookie names that you can whitelist for each cache behavior, see `CloudFront Limits <https://docs.aws.amazon.com/general/latest/gr/xrefaws_service_limits.html#limits_cloudfront>`__ in the *AWS General Reference* .
                      ...
                      - **Headers** *(dict) --*
                        ...
                        For more information, see `Caching Content Based on Request Headers <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/header-caching.html>`__ in the *Amazon CloudFront Developer Guide* .
                        ...
                        - **Quantity** *(integer) --*
                          ...
                          * **S3 bucket** : See `HTTP Request Headers That CloudFront Removes or Updates <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/RequestAndResponseBehaviorS3Origin.html#request-s3-removed-headers>`__

                          * **Custom origin** : See `HTTP Request Headers and CloudFront Behavior <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/RequestAndResponseBehaviorCustomOrigin.html#request-custom-headers-behavior>`__
                    ...
                    - **ViewerProtocolPolicy** *(string) --*
                      ...
                      * ``https-only`` : If a viewer sends an HTTP request, CloudFront returns an HTTP status code of 403 (Forbidden).
                      ...
                      For more information about requiring the HTTPS protocol, see `Using an HTTPS Connection to Access Your Objects <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/SecureConnections.html>`__ in the *Amazon CloudFront Developer Guide* .
                  ...
                  - **CacheBehaviors** *(dict) --*
                    ...
                    - **Items** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        For the current limit on the number of cache behaviors that you can add to a distribution, see `Amazon CloudFront Limits <https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits_cloudfront>`__ in the *AWS General Reference* .
                        ...
                        For more information about cache behaviors, see `Cache Behaviors <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesCacheBehavior>`__ in the *Amazon CloudFront Developer Guide* .
                        ...
                        - **PathPattern** *(string) --*
                          ...
                          For more information, see `Path Pattern <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesPathPattern>`__ in the *Amazon CloudFront Developer Guide* .
                    ...
                    - **Items** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        * How long CloudFront caches HTTP status codes in the 4xx and 5xx range.
                        ...
                        For more information about custom error pages, see `Customizing Error Responses <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/custom-error-pages.html>`__ in the *Amazon CloudFront Developer Guide* .
                        ...
                        - **ErrorCachingMinTTL** *(integer) --*
                          ...
                          For more information, see `Customizing Error Responses <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/custom-error-pages.html>`__ in the *Amazon CloudFront Developer Guide* .
                  ...
                  - **ViewerCertificate** *(dict) --*
                    ...
                    - **SSLSupportMethod** *(string) --*
                      ...
                      * ``vip`` : CloudFront uses dedicated IP addresses for your content and can respond to HTTPS requests from any viewer. However, there are additional monthly charges. For details, including specific pricing information, see `Custom SSL options for Amazon CloudFront <http://aws.amazon.com/cloudfront/custom-ssl-domains/>`__ on the AWS marketing site.
                      ...
                      For more information, see `Choosing How CloudFront Serves HTTPS Requests <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/cnames-https-dedicated-ip-or-sni.html>`__ in the *Amazon CloudFront Developer Guide* .
                    ...
                    - **Certificate** *(string) --*
                      ...
                      * `ACMCertificateArn <https://docs.aws.amazon.com/cloudfront/latest/APIReference/API_ViewerCertificate.html#cloudfront-Type-ViewerCertificate-ACMCertificateArn>`__

                      * `IAMCertificateId <https://docs.aws.amazon.com/cloudfront/latest/APIReference/API_ViewerCertificate.html#cloudfront-Type-ViewerCertificate-IAMCertificateId>`__

                      * `CloudFrontDefaultCertificate <https://docs.aws.amazon.com/cloudfront/latest/APIReference/API_ViewerCertificate.html#cloudfront-Type-ViewerCertificate-CloudFrontDefaultCertificate>`__
                  ...
                  - **AliasICPRecordals** *(list) --*
                    ...
                    For more information about ICP recordals, see `Signup, Accounts, and Credentials <https://docs.amazonaws.cn/en_us/aws/latest/userguide/accounts-and-credentials.html>`__ in *Getting Started with AWS services in China* .
...
class ListInvalidations(Boto3Paginator):
    def paginate(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/cloudfront-2019-03-26/ListInvalidations>`_
...
class ListStreamingDistributions(Boto3Paginator):
    def paginate(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/cloudfront-2019-03-26/ListStreamingDistributions>`_
                ...
                - *(dict) --*
                  ...
                  - **S3Origin** *(dict) --*
                    ...
                    - **OriginAccessIdentity** *(string) --*
                      ...
                      For more information, see `Using an Origin Access Identity to Restrict Access to Your Amazon S3 Content <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.html>`__ in the *Amazon CloudFront Developer Guide* .
                  ...
                  - **TrustedSigners** *(dict) --*
                    ...
                    For more information, see `Serving Private Content through CloudFront <https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html>`__ in the *Amazon CloudFront Developer Guide* .
