...
class BaseModel(RecordModel):
    ...
    @classmethod
    def get_one(cls, limit=1, offset=None, col_name='', desc=None, where_id=None, where_url=None, have_html=None, is_null_data=None):  # type: (int, int, str, bool, any, any) -> Union[List[BaseModel], BaseModel]
        if col_name:
