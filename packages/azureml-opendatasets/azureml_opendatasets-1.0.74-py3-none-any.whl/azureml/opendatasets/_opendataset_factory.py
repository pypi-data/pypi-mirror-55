...
class TabularOpenDatasetFactory:
    ...
    def get_tabular_dataset(
        ...
        if enable_telemetry:
            ...
            log_properties['StartDate'] = start_date
            log_properties['EndDate'] = end_date
            with log_activity(
                    PublicDataTelemetry.logger,
                    'get_tabular_dataset',
    ...
    def _get_tabular_dataset(
        ...
        new_ds._telemetry_info = _DatasetTelemetryInfo(entry_point='PythonSDK:OpenDataset')
