...
*AmphoraeApi* | [**amphorae_upload_signal_value_old**](docs/AmphoraeApi.md#amphorae_upload_signal_value_old) | **POST** /api/amphorae/{id}/signals/values | 
