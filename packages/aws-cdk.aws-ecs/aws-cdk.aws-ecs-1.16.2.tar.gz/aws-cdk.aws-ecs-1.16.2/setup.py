...
kwargs = json.loads("""
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-autoscaling~=1.16,>=1.16.2",
        "aws-cdk.aws-autoscaling-hooktargets~=1.16,>=1.16.2",
