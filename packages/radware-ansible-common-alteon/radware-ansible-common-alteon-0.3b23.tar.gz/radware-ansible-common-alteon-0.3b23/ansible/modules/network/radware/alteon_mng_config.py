...
options:
  ...
  command:
    description:
      ...
      - Use C(commit) to apply pending config changes. it revert on apply error and report success=false with details instead of raise exception. 
      - Use C(commit_save) commit and save. report success=false with details instead of raise exception. 
