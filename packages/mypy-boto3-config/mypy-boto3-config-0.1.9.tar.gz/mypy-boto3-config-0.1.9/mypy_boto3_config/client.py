...
class Client(BaseClient):
    ...
    def delete_organization_config_rule(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/DeleteOrganizationConfigRule>`_
    ...
    def describe_organization_config_rule_statuses(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/DescribeOrganizationConfigRuleStatuses>`_
    ...
    def describe_organization_config_rules(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/DescribeOrganizationConfigRules>`_
              ...
              - *(dict) --*
                ...
                - **OrganizationManagedRuleMetadata** *(dict) --*
                  ...
                  - **RuleIdentifier** *(string) --*
                    ...
                    For organization config managed rules, a predefined identifier from a list. For example, ``IAM_PASSWORD_POLICY`` is a managed rule. To reference a managed rule, see `Using AWS Managed Config Rules <https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html>`__ .
    ...
    def describe_remediation_exceptions(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/DescribeRemediationExceptions>`_
    ...
    def get_organization_config_rule_detailed_status(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/GetOrganizationConfigRuleDetailedStatus>`_
    ...
    def put_configuration_recorder(
        self,
        ConfigurationRecorder: Dict[str, Any]
    ) -> None:
        """
    ...
    def put_organization_config_rule(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/PutOrganizationConfigRule>`_
    ...
    def put_remediation_exceptions(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/PutRemediationExceptions>`_
