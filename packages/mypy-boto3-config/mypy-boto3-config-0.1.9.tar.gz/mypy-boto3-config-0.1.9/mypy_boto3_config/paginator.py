...
class DescribeAggregationAuthorizations(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`ConfigService.Client.describe_aggregation_authorizations`.
...
class DescribeConfigRuleEvaluationStatus(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`ConfigService.Client.describe_config_rule_evaluation_status`.
...
class DescribeConfigurationAggregatorSourcesStatus(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`ConfigService.Client.describe_configuration_aggregator_sources_status`.
...
class DescribeConfigurationAggregators(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`ConfigService.Client.describe_configuration_aggregators`.
...
class DescribePendingAggregationRequests(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`ConfigService.Client.describe_pending_aggregation_requests`.
...
class ListAggregateDiscoveredResources(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`ConfigService.Client.list_aggregate_discovered_resources`.
