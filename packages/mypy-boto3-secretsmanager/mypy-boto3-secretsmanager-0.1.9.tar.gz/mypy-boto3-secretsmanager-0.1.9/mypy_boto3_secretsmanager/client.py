    ...
    def put_secret_value(
        ...
        **Request Syntax**
        ...
        :param SecretString:
          ...
          For storing multiple values, we recommend that you use a JSON text string argument and specify key/value pairs. For information on how to format a JSON parameter for the various command line tool environments, see `Using JSON for Parameters <https://docs.aws.amazon.com/cli/latest/userguide/cli-using-param.html#cli-using-param-json>`__ in the *AWS CLI User Guide* .
    ...
    def tag_resource(
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          This parameter to the API requires a JSON text string argument. For information on how to format a JSON parameter for the various command line tool environments, see `Using JSON for Parameters <https://docs.aws.amazon.com/cli/latest/userguide/cli-using-param.html#cli-using-param-json>`__ in the *AWS CLI User Guide* . For the AWS CLI, you can also use the syntax: ``--Tags Key="Key1",Value="Value1",Key="Key2",Value="Value2"[,…]``
