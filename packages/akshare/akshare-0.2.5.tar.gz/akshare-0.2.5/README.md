...
(本文档更新于 **2019-11-04**; 如发现库和文档相关问题, 请联系 [AkShare](https://github.com/jindaxiang/akshare) 作者: jindaxiang@163.com)
...
| 名称   | 类型 | 必选 | 描述                                                                              |
| -------- | ---- | ---- | --- |
| symbol | str  | Y    |   港股代码,可以通过**get_hk_stock_name**函数返回所有港股代码|
...
```python
import akshare as ak
data, hfq_factor, qfq_factor = ak.get_hk_stock_hist_data(symbol="00005")
stock_df = ak.get_hk_stock_name()
```
...
数据示例(港股行情及名词列表**get_hk_stock_name**函数返回值)
```
     symbol            name         engname tradetype lasttrade prevclose  \
0     00001              长和     CHEUNG KONG      EQTY    72.800    72.500   
1     00002            中电控股    CLP HOLDINGS      EQTY    82.450    81.350   
2     00003          香港中华煤气  HK & CHINA GAS      EQTY    15.420    15.220   
3     00004           九龙仓集团  WHARF HOLDINGS      EQTY    18.080    17.820   
4     00005            汇丰控股   HSBC HOLDINGS      EQTY    59.600    59.500   
     ...             ...             ...       ...       ...       ...   
2431  08621  METROPOLIS CAP            NULL      EQTY     0.221     0.300   
2432  08622          华康生物医学            NULL      EQTY     0.170     0.170   
2433  08631            申港控股  SUN KONG HLDGS      EQTY     0.159     0.156   
2434  08635          连成科技集团    NOVACON TECH      EQTY     0.144     0.141   
2435  08668            瀛海集团            NULL      EQTY     0.169     0.165   
        open    high     low    volume currentvolume     amount  \
0     71.750  72.800  71.750   2784249        394000  201956641   
1     81.100  82.600  81.100   2667344        338500  219522803   
2     15.200  15.500  15.200  16035049       1294000  247517903   
3     17.760  18.080  17.740   2362079        477000   42401218   
4     58.900  59.750  58.900  10663691       1306400  634874453   
      ...     ...     ...       ...           ...        ...   
2431   0.290   0.290   0.221   9536000        960000    2356944   
2432   0.174   0.174   0.170    256000          8000      43768   
2433   0.158   0.164   0.158    200000         10000      32250   
2434   0.138   0.145   0.138    296000         48000      42184   
2435   0.161   0.170   0.161   1270000        100000     211660   
                 ticktime     buy    sell high_52week low_52week     eps  \
0     2019-11-01 16:08:26  72.750  72.800      86.450     64.300  10.110   
1     2019-11-01 16:08:28  82.450  82.500      97.400     78.000   5.360   
2     2019-11-01 16:08:26  15.400  15.420      19.840     14.800   0.605   
3     2019-11-01 16:08:30  18.060  18.080      25.650     16.300   2.180   
4     2019-11-01 16:08:28  59.600  59.650      70.500     55.300   4.935   
                   ...     ...     ...         ...        ...     ...   
2431  2019-11-01 16:08:24   0.221   0.229       1.200      0.250  -0.003   
2432  2019-11-01 16:08:24   0.170   0.180       0.540      0.093  -0.002   
2433  2019-11-01 16:08:24   0.151   0.159       0.670      0.140   0.017   
2434  2019-11-01 16:08:24   0.144   0.145       1.430      0.130    None   
2435  2019-11-01 16:08:24   0.164   0.169       0.260      0.152    None   
     dividend   stocks_sum pricechange changepercent  
0       0.000   3856240500       0.300     0.4137931  
1        None   2526450570       1.100     1.3521819  
2        None  16925052244       0.200     1.3140604  
3        None   3049027327       0.260     1.4590348  
4        None  20583110199       0.100     0.1680672  
       ...          ...         ...           ...  
2431     None    800000000      -0.079   -26.3333333  
2432     None    400000000       0.000     0.0000000  
2433     None    400000000       0.003     1.9230769  
