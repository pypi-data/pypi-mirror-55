...
def futures_hq_spot(subscribe_list=subscribe_exchange_symbol()):
...
if __name__ == "__main__":
    ...
    while True:
        time.sleep(3)
        data = futures_hq_spot(subscribe_list=subscribe_exchange_symbol())
        print(data)
