...
class Client(BaseClient):
              ...
              - *(dict) --*
                ...
                - **Schedule** *(dict) --*
                  ...
                  - **ScheduleExpression** *(string) --*
                    ...
                    A ``cron`` expression used to specify the schedule. For more information, see `Time-Based Schedules for Jobs and Crawlers <http://docs.aws.amazon.com/glue/latest/dg/monitor-data-warehouse-schedule.html>`__ . For example, to run something every day at 12:15 UTC, specify ``cron(15 12 * * ? *)`` .
            ...
            - **DevEndpoints** *(list) --*
              ...
              - *(dict) --*
                ...
                - **GlueVersion** *(string) --*
                  ...
                  For more information about the available AWS Glue versions and corresponding Spark and Python versions, see `Glue version <https://docs.aws.amazon.com/glue/latest/dg/add-job.html>`__ in the developer guide.
            ...
            - **Jobs** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DefaultArguments** *(dict) --*
                  ...
                  For information about how to specify and consume your own Job arguments, see the `Calling AWS Glue APIs in Python <https://docs.aws.amazon.com/glue/latest/dg/aws-glue-programming-python-calling.html>`__ topic in the developer guide.

                  For information about the key-value pairs that AWS Glue consumes to set up your job, see the `Special Parameters Used by AWS Glue <https://docs.aws.amazon.com/glue/latest/dg/aws-glue-programming-etl-glue-arguments.html>`__ topic in the developer guide.
    ...
    def batch_get_workflows(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/BatchGetWorkflows>`_
    ...
    def create_crawler(
        ...
        **Request Syntax**
        ...
        :param Configuration:
          ...
          The crawler configuration information. This versioned JSON string allows users to specify aspects of a crawler's behavior. For more information, see `Configuring a Crawler <http://docs.aws.amazon.com/glue/latest/dg/crawler-configuration.html>`__ .
        ...
        :param Tags:
          ...
          The tags to use with this crawler request. You can use tags to limit access to the crawler. For more information, see `AWS Tags in AWS Glue <http://docs.aws.amazon.com/glue/latest/dg/monitor-tags.html>`__ .
    ...
    def create_dev_endpoint(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          The tags to use with this DevEndpoint. You may use tags to limit access to the DevEndpoint. For more information about tags in AWS Glue, see `AWS Tags in AWS Glue <https://docs.aws.amazon.com/glue/latest/dg/monitor-tags.html>`__ in the developer guide.
    ...
    def create_job(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          The tags to use with this job. You may use tags to limit access to the job. For more information about tags in AWS Glue, see `AWS Tags in AWS Glue <https://docs.aws.amazon.com/glue/latest/dg/monitor-tags.html>`__ in the developer guide.
        ...
        **Request Syntax**
        ...
        :param Parameters: **[REQUIRED]**
          ...
          - **TransformType** *(string) --* **[REQUIRED]**
            ...
            For information about the types of machine learning transforms, see `Creating Machine Learning Transforms <http://docs.aws.amazon.com/glue/latest/dg/add-job-machine-learning-transform.html>`__ .
    ...
    def create_trigger(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          The tags to use with this trigger. You may use tags to limit access to the trigger. For more information about tags in AWS Glue, see `AWS Tags in AWS Glue <https://docs.aws.amazon.com/glue/latest/dg/monitor-tags.html>`__ in the developer guide.
    ...
    def create_workflow(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/CreateWorkflow>`_
    ...
    def delete_ml_transform(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/DeleteMLTransform>`_
            ...
            - **Classifier** *(dict) --*
              ...
              - **GrokClassifier** *(dict) --*
                ...
                - **GrokPattern** *(string) --*
                  ...
                  The grok pattern applied to a data store by this classifier. For more information, see built-in patterns in `Writing Custom Classifiers <http://docs.aws.amazon.com/glue/latest/dg/custom-classifier.html>`__ .

                - **CustomPatterns** *(string) --*

                  Optional custom grok patterns defined by this classifier. For more information, see custom patterns in `Writing Custom Classifiers <http://docs.aws.amazon.com/glue/latest/dg/custom-classifier.html>`__ .
    ...
    def get_ml_task_run(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetMLTaskRun>`_
    ...
    def get_ml_task_runs(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetMLTaskRuns>`_
    ...
    def get_ml_transform(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetMLTransform>`_
            ...
            - **EvaluationMetrics** *(dict) --*
              ...
              - **FindMatchesMetrics** *(dict) --*
                ...
                - **AreaUnderPRCurve** *(float) --*
                  ...
                  For more information, see `Precision and recall <https://en.wikipedia.org/wiki/Precision_and_recall>`__ in Wikipedia.
                ...
                - **F1** *(float) --*
                  ...
                  For more information, see `F1 score <https://en.wikipedia.org/wiki/F1_score>`__ in Wikipedia.

                - **ConfusionMatrix** *(dict) --*

                  The confusion matrix shows you what your transform is predicting accurately and what types of errors it is making.

                  For more information, see `Confusion matrix <https://en.wikipedia.org/wiki/Confusion_matrix>`__ in Wikipedia.
    ...
    def get_ml_transforms(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetMLTransforms>`_
    ...
    def get_workflow(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetWorkflow>`_
    ...
    def get_workflow_run(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetWorkflowRun>`_
    ...
    def get_workflow_runs(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetWorkflowRuns>`_
    ...
    def search_tables(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/SearchTables>`_
    ...
    def start_export_labels_task_run(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/StartExportLabelsTaskRun>`_
    ...
    def tag_resource(
        ...
        """
        Adds tags to a resource. A tag is a label you can assign to an AWS resource. In AWS Glue, you can tag only certain resources. For information about what resources you can tag, see `AWS Tags in AWS Glue <https://docs.aws.amazon.com/glue/latest/dg/monitor-tags.html>`__ .
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          The ARN of the AWS Glue resource to which to add the tags. For more information about AWS Glue resource ARNs, see the `AWS Glue ARN string pattern <https://docs.aws.amazon.com/glue/latest/dg/aws-glue-api-common.html#aws-glue-api-regex-aws-glue-arn-id>`__ .
    ...
    def update_crawler_schedule(
        ...
        **Request Syntax**
        ...
        :param Schedule:
          ...
          The updated ``cron`` expression used to specify the schedule. For more information, see `Time-Based Schedules for Jobs and Crawlers <http://docs.aws.amazon.com/glue/latest/dg/monitor-data-warehouse-schedule.html>`__ . For example, to run something every day at 12:15 UTC, specify ``cron(15 12 * * ? *)`` .
    ...
    def update_ml_transform(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/UpdateMLTransform>`_
