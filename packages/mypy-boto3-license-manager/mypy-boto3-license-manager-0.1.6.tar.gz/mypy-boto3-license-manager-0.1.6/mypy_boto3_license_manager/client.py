...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def delete_license_configuration(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_license_configuration(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_service_settings(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_associations_for_license_configuration(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_license_specifications_for_resource(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def update_license_configuration(self) -> None:
        pass
