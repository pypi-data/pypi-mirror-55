...
setup(
  name = 'geopoly',         # How you named your package folder (MyLib)
  packages = ['geopoly'],   # Chose the same as "name"
  version = '0.1.2.2',      # Start with a small number and increase it with every change you make
