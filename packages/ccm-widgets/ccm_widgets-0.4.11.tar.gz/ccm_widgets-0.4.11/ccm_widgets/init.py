...
def init_jupyter(*, store_bundle_in_notebook=False):
    ...
    if store_bundle_in_notebook:
        print('Initialized ccm_widgets for Jupyter notebooks and stored bundle in notebook.')
    else:
        clear_output()
        print('Initialized ccm_widgets for Jupyter notebooks.')
...
def init_colab(*, store_bundle_in_notebook=False):
    if store_bundle_in_notebook:
        print('Initialized ccm_widgets for Colab notebooks and storing bundle in notebook.')
    else:
        print('Initialized ccm_widgets for Colab notebooks.')
