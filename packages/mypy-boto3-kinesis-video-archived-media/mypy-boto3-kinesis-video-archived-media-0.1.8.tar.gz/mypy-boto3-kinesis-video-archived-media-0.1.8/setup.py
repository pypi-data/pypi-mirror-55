...
from mypy_boto3_kinesis_video_archived_media.version import __version__ as version
...
setup(
    ...
    description="Mypy-friendly boto3 type annotations for kinesis-video-archived-media service.",
    classifiers=[
