        ...
        **Request Syntax**
        ...
        :param MountOptions:
          ...
          - **Version** *(string) --*
            ...
            * **`NFSv3 <https://tools.ietf.org/html/rfc1813>`__ ** - stateless protocol version that allows for asynchronous writes on the server.

            * **`NFSv4.0 <https://tools.ietf.org/html/rfc3530>`__ ** - stateful, firewall-friendly protocol version that supports delegations and pseudo filesystems.

            * **`NFSv4.1 <https://tools.ietf.org/html/rfc5661>`__ ** - stateful protocol version that supports sessions, directory delegations, and parallel data processing. Version 4.1 also includes all features available in version 4.0.
    ...
    def create_location_s3(
        ...
        **Request Syntax**
        ...
        :param S3StorageClass:
          ...
          The Amazon S3 storage class that you want to store your files in when this location is used as a task destination. For more information about S3 storage classes, see `Amazon S3 Storage Classes <https://aws.amazon.com/s3/storage-classes/>`__ in the *Amazon Simple Storage Service Developer Guide* . Some storage classes have behaviors that can affect your S3 storage cost. For detailed information, see  using-storage-classes .
          ...
          - *(dict) --*
            ...
            - **PrivateLinkConfig** *(dict) --*
              ...
              - **PrivateLinkEndpoint** *(string) --*
                ...
                The private endpoint that is configured for an agent that has access to IP addresses in a `PrivateLink <https://docs.aws.amazon.com/vpc/latest/userguide/endpoint-service.html>`__ . An agent that is configured with this endpoint will not be accessible over the public Internet.
