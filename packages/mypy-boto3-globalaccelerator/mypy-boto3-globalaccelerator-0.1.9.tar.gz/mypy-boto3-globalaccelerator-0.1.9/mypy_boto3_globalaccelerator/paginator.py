            ...
            - **Accelerators** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DnsName** *(string) --*
                  ...
                  For more information about the default DNS name, see `Support for DNS Addressing in Global Accelerator <https://docs.aws.amazon.com/global-accelerator/latest/dg/about-accelerators.html#about-accelerators.dns-addressing>`__ in the *AWS Global Accelerator Developer Guide* .
                ...
                - **EndpointDescriptions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **ClientIPPreservationEnabled** *(boolean) --*
                      ...
                      For more information, see `Viewing Client IP Addresses in AWS Global Accelerator <https://docs.aws.amazon.com/global-accelerator/latest/dg/introduction-how-it-works-client-ip.html>`__ in the *AWS Global Accelerator Developer Guide* .
