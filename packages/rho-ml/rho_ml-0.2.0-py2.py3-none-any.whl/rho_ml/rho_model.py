...
class RhoModel(object):
    ...
    training_data_schema: Optional[Type[marshmallow.Schema]] = None
    ...
    def train_logic(self, training_data: Dict[str, Any],
                    *args, **kwargs) -> Any:
    ...
    def predict_logic(self, prediction_data: Dict[str, Any],
                      *args, **kwargs) -> Any:
    ...
    def predict(self, prediction_data: Dict[str, Any], run_validation: bool,
                *args, **kwargs) -> Any:
        if run_validation:
            result = get_validated_result(
