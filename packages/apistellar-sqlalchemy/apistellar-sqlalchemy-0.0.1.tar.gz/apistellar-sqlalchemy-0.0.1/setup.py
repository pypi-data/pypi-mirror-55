...
with cfg_manage(__file__.replace(".py", ".cfg.tpl")):
    setup(
        name="apistellar-sqlalchemy",
        version=get_version("apistellar_sqlalchemy"),
        description="orm ability from apistellar type",
        ...
        keywords="apistellar sqlalchemy orm",
        author="cn",
        author_email="cnaafhvk@foxmail.com",
        url="https://www.github.com/ShichaoMa/apistellar-sqlalchemy",
        license="MIT",
