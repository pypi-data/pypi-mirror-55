...
myfont = fm.FontProperties(fname=os.getcwd().split('lib')[0]+'/msyh.ttf') # 设置字体
...
class plot_max:
    ...
    def show(self, exchange=False, hspace=0.3, wspace=0.1, dfs={}):
        ...
        for i in range(data_count):
            ...
            ax.set_xlabel(d['xlabel'].decode('utf-8'), fontproperties=myfont)
            ax.set_ylabel(d['ylabel'].decode('utf-8'), fontproperties=myfont)
