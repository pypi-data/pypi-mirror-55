...
class Client(BaseClient):
    ...
    def attach_disk(
        ...
        The ``attach disk`` operation supports tag-based access control via resource tags applied to the resource identified by ``disk name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def attach_instances_to_load_balancer(
        ...
        The ``attach instances to load balancer`` operation supports tag-based access control via resource tags applied to the resource identified by ``load balancer name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def attach_load_balancer_tls_certificate(
        ...
        The ``attach load balancer tls certificate`` operation supports tag-based access control via resource tags applied to the resource identified by ``load balancer name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def close_instance_public_ports(
        ...
        The ``close instance public ports`` operation supports tag-based access control via resource tags applied to the resource identified by ``instance name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
        ...
        **Request Syntax**
        ...
        :param sourceResourceName:
          ...
          .. note::
            ...
            Define this parameter only when copying an automatic snapshot as a manual snapshot. For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots>`__ .
    ...
    def create_disk_from_snapshot(
        ...
        The ``create disk from snapshot`` operation supports tag-based access control via request tags and resource tags applied to the resource identified by ``disk snapshot name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
        ...
        **Request Syntax**
        ...
        :param sourceDiskName:
          ...
          .. note::
            ...
            Define this parameter only when creating a new disk from an automatic snapshot. For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots>`__ .
    ...
    def create_domain_entry(
        ...
        The ``create domain entry`` operation supports tag-based access control via resource tags applied to the resource identified by ``domain name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def create_instances_from_snapshot(
        ...
        The ``create instances from snapshot`` operation supports tag-based access control via request tags and resource tags applied to the resource identified by ``instance snapshot name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
        ...
        **Request Syntax**
        ...
        :param sourceInstanceName:
          ...
          .. note::
            ...
            Define this parameter only when creating a new instance from an automatic snapshot. For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots>`__ .
    ...
    def create_load_balancer_tls_certificate(
        ...
        The ``create load balancer tls certificate`` operation supports tag-based access control via resource tags applied to the resource identified by ``load balancer name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def delete_auto_snapshot(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteAutoSnapshot>`_
    ...
    def delete_disk(
        ...
        The ``delete disk`` operation supports tag-based access control via resource tags applied to the resource identified by ``disk name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def delete_disk_snapshot(
        ...
        The ``delete disk snapshot`` operation supports tag-based access control via resource tags applied to the resource identified by ``disk snapshot name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def delete_domain(
        ...
        The ``delete domain`` operation supports tag-based access control via resource tags applied to the resource identified by ``domain name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def delete_domain_entry(
        ...
        The ``delete domain entry`` operation supports tag-based access control via resource tags applied to the resource identified by ``domain name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def delete_instance(
        ...
        The ``delete instance`` operation supports tag-based access control via resource tags applied to the resource identified by ``instance name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def delete_instance_snapshot(
        ...
        The ``delete instance snapshot`` operation supports tag-based access control via resource tags applied to the resource identified by ``instance snapshot name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def delete_key_pair(
        ...
        The ``delete key pair`` operation supports tag-based access control via resource tags applied to the resource identified by ``key pair name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def delete_load_balancer(
        ...
        The ``delete load balancer`` operation supports tag-based access control via resource tags applied to the resource identified by ``load balancer name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def delete_load_balancer_tls_certificate(
        ...
        The ``delete load balancer tls certificate`` operation supports tag-based access control via resource tags applied to the resource identified by ``load balancer name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def detach_disk(
        ...
        The ``detach disk`` operation supports tag-based access control via resource tags applied to the resource identified by ``disk name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def detach_instances_from_load_balancer(
        ...
        The ``detach instances from load balancer`` operation supports tag-based access control via resource tags applied to the resource identified by ``load balancer name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def disable_add_on(
        ...
        """
        Disables an add-on for an Amazon Lightsail resource. For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots>`__ .

        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DisableAddOn>`_
    ...
    def enable_add_on(
        ...
        """
        Enables or modifies an add-on for an Amazon Lightsail resource. For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots>`__ .

        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/EnableAddOn>`_
    ...
    def export_snapshot(
        ...
        The ``export snapshot`` operation supports tag-based access control via resource tags applied to the resource identified by ``source snapshot name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def get_auto_snapshots(
        ...
        """
        Returns the available automatic snapshots for the specified resource name. For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots>`__ .
    ...
    def get_instance_access_details(
        ...
        The ``get instance access details`` operation supports tag-based access control via resource tags applied to the resource identified by ``instance name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def open_instance_public_ports(
        ...
        The ``open instance public ports`` operation supports tag-based access control via resource tags applied to the resource identified by ``instance name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def put_instance_public_ports(
        ...
        The ``put instance public ports`` operation supports tag-based access control via resource tags applied to the resource identified by ``instance name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def reboot_instance(
        ...
        The ``reboot instance`` operation supports tag-based access control via resource tags applied to the resource identified by ``instance name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def start_instance(
        ...
        The ``start instance`` operation supports tag-based access control via resource tags applied to the resource identified by ``instance name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def stop_instance(
        ...
        The ``stop instance`` operation supports tag-based access control via resource tags applied to the resource identified by ``instance name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def tag_resource(
        ...
        The ``tag resource`` operation supports tag-based access control via request tags and resource tags applied to the resource identified by ``resource name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def untag_resource(
        ...
        The ``untag resource`` operation supports tag-based access control via request tags and resource tags applied to the resource identified by ``resource name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def update_domain_entry(
        ...
        The ``update domain entry`` operation supports tag-based access control via resource tags applied to the resource identified by ``domain name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
    ...
    def update_load_balancer_attribute(
        ...
        The ``update load balancer attribute`` operation supports tag-based access control via resource tags applied to the resource identified by ``load balancer name`` . For more information, see the `Lightsail Dev Guide <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__ .
