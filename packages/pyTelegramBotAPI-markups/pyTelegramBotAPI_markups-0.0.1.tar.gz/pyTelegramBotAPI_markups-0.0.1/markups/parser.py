...
BUTTON = T.Dict(
    {
        ...
        "callback": T.String(min_length=1),
...
MARKUP = T.Dict(
    {
        ...
        T.Key("buttons", optional=True): T.List(T.Or(BUTTON, T.Dict({"name": T.String(min_length=1)})))
    }
)

CONFIG = T.Dict(
    {
        "callback_strategy": T.String,
        "delimiter": T.String(min_length=1)
    }
)
