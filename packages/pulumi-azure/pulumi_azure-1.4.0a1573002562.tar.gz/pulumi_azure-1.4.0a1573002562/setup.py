...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.4.0-alpha.1573002562+g7edcfde2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.4.0-alpha.1573002562+g7edcfde2`
                """)
            else:
                raise
