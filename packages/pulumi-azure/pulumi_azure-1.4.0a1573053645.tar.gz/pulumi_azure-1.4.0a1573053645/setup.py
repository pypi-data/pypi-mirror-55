...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.4.0-alpha.1573053645+g74a3f60d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.4.0-alpha.1573053645+g74a3f60d`
                """)
            else:
                raise
