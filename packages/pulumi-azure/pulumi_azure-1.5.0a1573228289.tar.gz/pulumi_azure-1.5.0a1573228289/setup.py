...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.5.0-alpha.1573228289+g468fb3d6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.5.0-alpha.1573228289+g468fb3d6`
                """)
            else:
                raise
