...
def parse_bpmn(bpmn_path: str, json_path: str, template_path: str, model_path: str):
...
def _get_components_from_elements(elements: dict) -> list:
    components = []
...
def _get_elements_of_type(bpmn, element_type):
