...
class Block:
    ...
    def __init__(self, env: Environment, name: str, block_capacity=float("inf")):
        ...
        self.do_on_enter_list: List[on_enter_or_exit_method] = []
        self.do_on_exit_list: List[on_enter_or_exit_method] = []
    ...
    def process_entity(self, entity: Entity):
        ...
        # leaving
        self.block_resource.release(entity.component_resource_request)
...
@abstractmethod
def on_enter_or_exit_method(
    entity: Entity, block0: Optional[Block], block1: Optional[Block]
):
    """methods with this signature can be added to the enter/exit lists"""
    raise NotImplementedError()
