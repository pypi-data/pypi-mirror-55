...
class MqttCore(object):
    ...
    def __init__(self, client_id, clean_session, protocol, use_wss, autoReconnect):
        ...
        self._internal_async_client = InternalAsyncMqttClient(client_id, clean_session, protocol, use_wss, autoReconnect)
