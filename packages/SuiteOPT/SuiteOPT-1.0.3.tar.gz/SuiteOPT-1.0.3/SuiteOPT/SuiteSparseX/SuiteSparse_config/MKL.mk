...
#===============================================================================
    ...
    LDLIBS ?= -L$(MKLROOT)/lib/intel64 -L/opt/intel/compilers_and_libraries_2019.4.243/linux/compiler/lib/intel64 -lm
    ...
    ifndef BLAS
        ifdef MKLROOT
            ...
            #BLAS = /usr/lib64/libopenblaso64-r0.3.3.so -lpthread -lgfortran -lm
...
config:
	...
	@echo 'Intel MKL LIB:            MKLROOT=        ' '$(MKLROOT)'
