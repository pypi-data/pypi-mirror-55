...
from funhandler.blocks import BaseBlock, Addable
...
class TradingEnvBuilder(BaseBlock):
    def __init__(self, name, **kwargs):
        ...
        self.required = ['portfolio', 'store'] # this needs to also include a generator functio
    ...
    def reset(self):
        self.check_required()
        logger.opt(ansi=True).debug(self.task_parts)
