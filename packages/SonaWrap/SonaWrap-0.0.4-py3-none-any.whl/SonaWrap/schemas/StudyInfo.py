...
class StudyInfoSchema(Schema):
    ...
    credits_part1_value = fields.Str(required=False, allow_none=True)
    credits_part2_value = fields.Str(required=False, allow_none=True)
    credits_part3_value = fields.Str(required=False, allow_none=True)
    credits_part4_value = fields.Str(required=False, allow_none=True) #ALL THESE IN VPh part floats
    # TODO implement field with only float vph for me to process with input process
    credits_total_value = fields.Str(required=True)
