...
from typing import List, Callable, Any, Dict, Optional, Tuple, Sequence

from pydatapack import utils as utils
from .parsers import default_parser

__all__ = ['commands', 'generic_command', 'class_options', 'MCCommand']
...
def generate_command(*args):
    return " ".join(default_parser(arg) for arg in args)
...
class MCCommand:
    def __init__(self, *args):
        self.command = generate_command(*args)
