...
class Pulp2contentApi(object):
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['pulp2_id', 'pulp2_id__in', 'pulp2_content_type_id', 'pulp2_content_type_id__in', 'pulp2_last_updated__lt', 'pulp2_last_updated__lte', 'pulp2_last_updated__gt', 'pulp2_last_updated__gte', 'pulp2_last_updated__range', 'pulp3_content', 'pulp2_last_updated', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
    ...
    def read_with_http_info(self, pulp2_content_href, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(Pulp2Content, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='Pulp2Content',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
