...
class Client(BaseClient):
    ...
    def grant_permissions(
        ...
        For information about permissions, see `Security and Access Control to Metadata and Data <https://docs-aws.amazon.com/michigan/latest/dg/security-data-access.html>`__ .
    ...
    def revoke_permissions(
        ...
        **Request Syntax**
        ...
        :param Permissions: **[REQUIRED]**
          ...
          The permissions revoked to the principal on the resource. For information about permissions, see `Security and Access Control to Metadata and Data <https://docs-aws.amazon.com/michigan/latest/dg/security-data-access.html>`__ .
