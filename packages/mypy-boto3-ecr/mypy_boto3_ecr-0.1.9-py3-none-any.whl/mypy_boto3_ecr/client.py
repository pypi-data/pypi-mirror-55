...
class Client(BaseClient):
    ...
    def create_repository(
        ...
        """
        Creates an Amazon Elastic Container Registry (Amazon ECR) repository, where users can push and pull Docker images. For more information, see `Amazon ECR Repositories <https://docs.aws.amazon.com/AmazonECR/latest/userguide/Repositories.html>`__ in the *Amazon Elastic Container Registry User Guide* .
    ...
    def put_lifecycle_policy(
        ...
        """
        Creates or updates a lifecycle policy. For information about lifecycle policy syntax, see `Lifecycle Policy Template <https://docs.aws.amazon.com/AmazonECR/latest/userguide/LifecyclePolicies.html>`__ .
    ...
    def set_repository_policy(
        ...
        """
        Applies a repository policy on a specified repository to control access permissions. For more information, see `Amazon ECR Repository Policies <https://docs.aws.amazon.com/AmazonECR/latest/userguide/RepositoryPolicies.html>`__ in the *Amazon Elastic Container Registry User Guide* .
        ...
        **Request Syntax**
        ...
        :param policyText: **[REQUIRED]**
          ...
          The JSON repository policy text to apply to the repository. For more information, see `Amazon ECR Repository Policy Examples <https://docs.aws.amazon.com/AmazonECR/latest/userguide/RepositoryPolicyExamples.html>`__ in the *Amazon Elastic Container Registry User Guide* .
