...
def scanDevices(target_conn="all", debugPrint=False, lanTimeout=1, scanInArray=True, favouriteOnly=True,filterStr=None):
    foundDevices = dict()
    scannedArrays = list()
...
def userSelectDevice(scanDictionary=None, scanFilterStr=None,favouriteOnly=True, ui="console"):
