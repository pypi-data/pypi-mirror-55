...
class PowerModule:
    ...
    def calibrate(self,load,reportFile,calHeader,myswitchboxDevice):

        return self.calibrateOrVerify("calibrate",load,reportFile,calHeader,myswitchboxDevice)

    def verify(self,load,reportFile,calHeader,myswitchboxDevice):

        return self.calibrateOrVerify("verify",load,reportFile,calHeader,myswitchboxDevice)

    def calibrateOrVerify(self,action,load,reportFile, calHeader, myswitchboxDevice):
        ...
        for channel in list:
            ...
            for calibration in list[channel]:
                ...
                thisItem.init(myswitchboxDevice)
