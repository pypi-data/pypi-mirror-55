...
class DTSCommms:
    ...
    def newNotifyChoiceOption(self, type, dict, dictValue, moduleType = None, outputMode = None):
        ...
        if type is "qpsmodule":
            sendString = self.createXMLSelectionModule(dict, dictValue, outputMode)
        if type is "module":
    ...
    def sendMsgToGUI(self, toSend, timeToWait=5):
       ...
       # printText("IP : " + str(dtsGlobals.GUI_TCP_IP))
    ...
    def createXMLSelectionModule(self, dict, dictValue, outputMode = None):
