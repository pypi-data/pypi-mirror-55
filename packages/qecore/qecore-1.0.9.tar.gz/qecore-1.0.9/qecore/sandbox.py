...
from qecore.time_limit import Timeout, QETimeoutError
...
class TestSandbox:
    ...
    def after_scenario(self, context, scenario):
        ...
        if self.background_image_revert:
            run(f"gsettings set org.gnome.desktop.background picture-uri {self.background_image_location}")
    ...
    def start_recording(self):
        ...
        leftover_recording_process_list = run(f"pgrep -fla qecore_start_recording").strip("\n")
        if leftover_recording_process_list != []:
