...
class Client(BaseClient):
    def accept_match(
         ...
         **Learn more**
         ...
         `Add FlexMatch to a Game Client <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-client.html>`__

         `FlexMatch Events Reference <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-events.html>`__
          ...
          - *(dict) --*
            ...
            - **GameSessionQueue** *(dict) --*
              ...
              - **GameSessionQueueArn** *(string) --*
                ...
                Amazon Resource Name (`ARN <https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html>`__ ) that is assigned to a game session queue and uniquely identifies it. Format is ``arn:aws:gamelift:<region>:<aws account>:gamesessionqueue/<queue name>`` .
    ...
    def create_matchmaking_configuration(
         ...
         **Learn more**
         ...
         `Design a FlexMatch Matchmaker <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-configuration.html>`__

         `Setting up Notifications for Matchmaking <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-notification.html>`__
        ...
        **Request Syntax**
        ...
        :param GameSessionQueueArns: **[REQUIRED]**
          ...
          Amazon Resource Name (`ARN <https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html>`__ ) that is assigned to a game session queue and uniquely identifies it. Format is ``arn:aws:gamelift:<region>:<aws account>:gamesessionqueue/<queue name>`` . These queues are used when placing game sessions for matches that are created with this matchmaking configuration. Queues can be located in any region.
          ...
          - *(dict) --*
            ...
            - **Configuration** *(dict) --*
              ...
              - **BackfillMode** *(string) --*
                ...
                Method used to backfill game sessions created with this matchmaking configuration. MANUAL indicates that the game makes backfill requests or does not use the match backfill feature. AUTOMATIC indicates that GameLift creates  StartMatchBackfill requests whenever a game session has one or more open slots. Learn more about manual and automatic backfill in `Backfill Existing Games with FlexMatch <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-backfill.html>`__ .
    ...
    def create_matchmaking_rule_set(
        ...
        * `Build a Rule Set <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-rulesets.html>`__

        * `Design a Matchmaker <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-configuration.html>`__

        * `Matchmaking with FlexMatch <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-intro.html>`__
          ...
          - *(dict) --*
            ...
            - **GameSessionPlacement** *(dict) --*
              ...
              - **MatchmakerData** *(string) --*
                ...
                Information on the matchmaking process for this game. Data is in JSON syntax, formatted as a string. It identifies the matchmaking configuration used to create the match, and contains data on all players assigned to the match, including player attributes and team assignments. For more details on matchmaker data, see `Match Data <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-server.html#match-server-data>`__ .
    ...
    def describe_matchmaking(
         ...
         **Learn more**
         ...
         `Set Up FlexMatch Event Notification <https://docs.aws.amazon.com/gamelift/latest/developerguidematch-notification.html>`__
              ...
              - *(dict) --*
                ...
                - **GameSessionConnectionInfo** *(dict) --*
                  ...
                  - **GameSessionArn** *(string) --*
                    ...
                    Amazon Resource Name (`ARN <https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html>`__ ) that is assigned to a game session and uniquely identifies it.
    ...
    def describe_matchmaking_configurations(
         ...
         **Learn more**
         ...
         `Setting Up FlexMatch Matchmakers <https://docs.aws.amazon.com/gamelift/latest/developerguide/matchmaker-build.html>`__
    ...
    def get_game_session_log_url(
        ...
        .. note::
          ...
          See the `AWS Service Limits <https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits_gamelift>`__ page for maximum log file sizes. Log files that exceed this limit are not saved.
    ...
    def put_scaling_policy(
        ...
        Learn more about how to work with auto-scaling in `Set Up Fleet Automatic Scaling <https://docs.aws.amazon.com/gamelift/latest/developerguide/fleets-autoscaling.html>`__ .
    ...
    def start_match_backfill(
        ...
        The process of finding backfill matches is essentially identical to the initial matchmaking process. The matchmaker searches the pool and groups tickets together to form potential matches, allowing only one backfill ticket per potential match. Once the a match is formed, the matchmaker creates player sessions for the new players. All tickets in the match are updated with the game session's connection information, and the  GameSession object is updated to include matchmaker data on the new players. For more detail on how match backfill requests are processed, see `How Amazon GameLift FlexMatch Works <https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-match.html>`__ .

         **Learn more**

         `Backfill Existing Games with FlexMatch <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-backfill.html>`__

         `How GameLift FlexMatch Works <https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-match.html>`__
    ...
    def start_matchmaking(
        ...
        * When the match is successfully placed, the matchmaking tickets move into ``COMPLETED`` status. Connection information (including game session endpoint and player session) is added to the matchmaking tickets. Matched players can use the connection information to join the game.
         ...
         **Learn more**
         ...
         `Set Up FlexMatch Event Notification <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-notification.html>`__

         `FlexMatch Integration Roadmap <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-tasks.html>`__
    ...
    def update_matchmaking_configuration(
        ...
        **Request Syntax**
        ...
        :param NotificationTarget:
          ...
          SNS topic ARN that is set up to receive matchmaking notifications. See `Setting up Notifications for Matchmaking <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-notification.html>`__ for more information.
