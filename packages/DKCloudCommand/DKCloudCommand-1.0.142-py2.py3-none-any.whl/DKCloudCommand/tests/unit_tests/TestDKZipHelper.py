...
class TestDKZipHelper(DKCommonUnitTestSettings):
    ...
    def test_unzip_first_file_as_string(self):
        ...
        output_as_string = DKZipHelper.unzip_first_file_as_string(zipped_input)
        self.assertIsNotNone(output_as_string)
        self.assertTrue(isinstance(output_as_string, str))
