...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def associate_resolver_rule(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def delete_resolver_endpoint(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def delete_resolver_rule(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def disassociate_resolver_rule(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_resolver_endpoint(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_resolver_rule(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_resolver_rule_association(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_resolver_rule_policy(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_resolver_endpoint_ip_addresses(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def put_resolver_rule_policy(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def update_resolver_endpoint(self) -> None:
        pass
