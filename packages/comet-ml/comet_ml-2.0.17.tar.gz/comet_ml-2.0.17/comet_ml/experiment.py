...
from ._typing import Any, Dict, List, Set, Tuple
from .comet import (
    format_url,
    generate_guid,
    get_cmd_args_dict,
...
class BaseExperiment(object):
    ...
    def _upload_file_by_path(
        ...
        try:
            check_max_file_size(file_path, max_size, UPLOAD_FILE_OS_ERROR)
    ...
    def _log_cpu_details(self, metrics):
        for metric in metrics:
            self.log_metric(metric, metrics[metric], include_context=False)
    ...
    def _file_upload(
        ...
        LOGGER.debug(
            "File upload message %r, type %r, params %r, clean %r",
            upload_file,
            upload_type,
            url_params,
            clean,
