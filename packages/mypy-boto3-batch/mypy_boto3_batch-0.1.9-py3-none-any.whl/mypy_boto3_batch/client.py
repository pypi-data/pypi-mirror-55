        ...
        **Request Syntax**
        ...
        :param computeResources:
          ...
          - **subnets** *(list) --* **[REQUIRED]**
            ...
            The VPC subnets into which the compute resources are launched. For more information, see `VPCs and Subnets <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html>`__ in the *Amazon VPC User Guide* .
                ...
                - **containerProperties** *(dict) --*
                  ...
                  - **linuxParameters** *(dict) --*
                    ...
                    - **devices** *(list) --*
                      ...
                      Any host devices to expose to the container. This parameter maps to ``Devices`` in the `Create a container <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section of the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the ``--device`` option to `docker run <https://docs.docker.com/engine/reference/run/>`__ .
