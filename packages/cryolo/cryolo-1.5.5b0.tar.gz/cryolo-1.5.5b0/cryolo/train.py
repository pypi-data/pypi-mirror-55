...
def create_parser(parser):
    ...
    deexsp_group.add_argument(
        ...
        action="store_true",
        default=True,
        help="Use python multiprocessing. If multiprocessing leads to problems during trainig (freezing), set it to false to use multithreading.",
    )
...
def main(args=None):
    ...
    do_multiprocessing = args.use_multiprocessing
