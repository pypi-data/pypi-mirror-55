...
printPackageSettingsPreview = True
...
if printPackageSettingsPreview:
    print("... PACKAGE CONFIGURTAION VALUES: \n")
    print("module_name: %s \n" % module_name)
    print("module_version: %s \n" % module_version)
    print("module_description: %s \n" % module_description)
    print("module_python: %s \n" % module_python)
    print("module_authors: %s \n" % module_authors)
    print("module_authors_email: %s \n" % module_authors_email)
    print("module_long_description_content_type: %s \n" % module_long_description_content_type)
    # print("module_long_description: %s \n" % module_long_description)
    print("module_license: %s \n" % module_license)
    print("module_url: %s \n" % module_url)
    print("module_project_urls: %s \n" % module_project_urls)
    print("module_classifiers: %s \n" % module_classifiers)
    print("module_keywords: %s \n" % module_keywords)
    print("module_packages: %s \n" % module_packages)
    print("module_install_requires: %s \n" % module_install_requires)
    print("module_extras_require: %s \n" % module_extras_require)
    print("module_package_data: %s \n" % module_package_data)
    print("module_entry_points: %s \n" % module_entry_points)
    print("module_data_included: %s \n" % module_data_included)
    print("module_enable_compression: %s \n" % module_enable_compression)
    print("module_setup_requires: %s \n" % module_setup_requires)
    print("module_test_suite: %s \n" % module_test_suite)
    print("module_test_requires: %s \n" % module_test_requires)
