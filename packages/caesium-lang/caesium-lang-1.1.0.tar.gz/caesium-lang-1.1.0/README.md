...
1. Ensure that you have a working version of python3 (If you don't, you can get it from the [official site](https://www.python.org/downloads/)). Any python version >= 3.3.0 should work.
