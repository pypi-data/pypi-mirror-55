...
class MetasploitStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ListJobs = channel.unary_unary(
        '/Metasploit/ListJobs',
        request_serializer=metasploit__pb2.Test.SerializeToString,
        response_deserializer=metasploit__pb2.Test2.FromString,
        )
...
def add_MetasploitServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ListJobs': grpc.unary_unary_rpc_method_handler(
          servicer.ListJobs,
          request_deserializer=metasploit__pb2.Test.FromString,
          response_serializer=metasploit__pb2.Test2.SerializeToString,
      ),
