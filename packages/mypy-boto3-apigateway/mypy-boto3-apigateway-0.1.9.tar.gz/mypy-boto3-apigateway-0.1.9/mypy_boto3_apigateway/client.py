          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents an authorization layer for methods. If enabled on a method, API Gateway will activate the authorizer when a client calls the method.
              ...
              `Use Lambda Function as Authorizer <https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-use-lambda-authorizer.html>`__  `Use Cognito User Pool as Authorizer <https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-integrate-with-cognito.html>`__
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The content map is a JSON string of API-specific key-value pairs. Although an API can use any shape for the content map, only the OpenAPI-compliant documentation fields will be injected into the associated API entity definition in the exported OpenAPI definition file.
              ...
              `Documenting an API <https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-documenting-api.html>`__ ,  DocumentationParts
    ...
    def create_model(
        ...
        **Request Syntax**
        ...
        :param schema:
          ...
          The schema for the model. For ``application/json`` models, this should be `JSON schema draft 4 <https://tools.ietf.org/html/draft-zyp-json-schema-04>`__ model.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents a unique identifier for a version of a deployed  RestApi that is callable by users.
              ...
              `Deploy an API <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-deploy-api.html>`__
            ...
            - **accessLogSettings** *(dict) --*
              ...
              - **format** *(string) --*
                ...
                A single line format of the access logs of data, as specified by selected `$context variables <https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-mapping-template-reference.html#context-variable-reference>`__ . The format must include at least ``$context.requestId`` .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            * TooManyRequestsException
            ...
            For detailed error code information, including the corresponding HTTP Status Codes, see `API Gateway Error Codes <https://docs.aws.amazon.com/apigateway/api-reference/handling-errors/#api-error-codes>`__
            ...
            In addition to making the REST API call directly, you can use the AWS CLI and an AWS SDK to access this resource.
               ...
               `API Gateway Limits <https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-limits.html>`__  `Developer Guide <https://docs.aws.amazon.com/apigateway/latest/developerguide/welcome.html>`__ , `AWS CLI <https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-account.html>`__
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The collection of documentation parts of an API.
               ...
               `Documenting an API <https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-documenting-api.html>`__ ,  DocumentationPart
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Use the  DocumentationVersions to manage documentation snapshots associated with various API stages.
              ...
              `Documenting an API <https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-documenting-api.html>`__ ,  DocumentationPart ,  DocumentationVersion
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            A gateway response of a given response type and status code, with optional response parameters and mapping templates.
             ...
             For more information about valid gateway response types, see `Gateway Response Types Supported by API Gateway <https://docs.aws.amazon.com/apigateway/latest/developerguide/supported-gateway-response-types.html>`__   Example: Get a Gateway Response of a given response type Request
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The collection of the  GatewayResponse instances of a  RestApi as a ``responseType`` -to- GatewayResponse object map of key-value pairs. As such, pagination is not supported for querying this collection.
             ...
             For more information about valid gateway response types, see `Gateway Response Types Supported by API Gateway <https://docs.aws.amazon.com/apigateway/latest/developerguide/supported-gateway-response-types.html>`__   Example: Get the collection of gateway responses of an API Request
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents an HTTP, HTTP_PROXY, AWS, AWS_PROXY, or Mock integration.
             ...
             In the API Gateway console, the built-in Lambda integration is an AWS integration.  `Creating an API <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-create-api.html>`__
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents a mapping template used to transform a payload.
              ...
              `Mapping Templates <https://docs.aws.amazon.com/apigateway/latest/developerguide/models-mappings.html#models-mappings-mappings>`__
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            In OpenAPI, the  RequestValidators of an API is defined by the `x-amazon-apigateway-request-validators <https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-swagger-extensions.html#api-gateway-swagger-extensions-request-validators.html>`__ extension.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            A list of  Stage resources that are associated with the  ApiKey resource.
             ...
             `Deploying API in Stages <https://docs.aws.amazon.com/apigateway/latest/developerguide/stages.html>`__
    ...
    def import_api_keys(
        ...
        **Request Syntax**
        ...
        :param body: **[REQUIRED]**
          ...
          The payload of the POST request to import API keys. For the payload format, see `API Key File Format <https://docs.aws.amazon.com/apigateway/latest/developerguide/api-key-file-format.html>`__ .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            A collection of the imported  DocumentationPart identifiers.
             ...
             This is used to return the result when documentation parts in an external (e.g., OpenAPI) file are imported into API Gateway  `Documenting an API <https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-documenting-api.html>`__ , `documentationpart:import <https://docs.aws.amazon.com/apigateway/api-reference/link-relation/documentationpart-import/>`__ ,  DocumentationPart
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **claims** *(dict) --*
              ...
              The `open identity claims <https://openid.net/specs/openid-connect-core-1_0.html#StandardClaims>`__ , with any supported custom attributes, returned from the Cognito Your User Pool configured for the API.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents the response of the test invoke request in the HTTP method.
              ...
              `Test API using the API Gateway console <https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-test-method.html#how-to-test-method-console>`__
