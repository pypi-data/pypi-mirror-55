...
class Client(BaseClient):
    ...
    def create_fleet(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          For more information, see `Tagging Your Resources <https://docs.aws.amazon.com/appstream2/latest/developerguide/tagging-basic.html>`__ in the *Amazon AppStream 2.0 Administration Guide* .
        ...
        :param IamRoleArn:
          ...
          For more information, see `Using an IAM Role to Grant Permissions to Applications and Scripts Running on AppStream 2.0 Streaming Instances <https://docs.aws.amazon.com/appstream2/latest/developerguide/using-iam-roles-to-grant-permissions-to-applications-scripts-streaming-instances.html>`__ in the *Amazon AppStream 2.0 Administration Guide* .
    ...
    def create_image_builder(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          For more information about tags, see `Tagging Your Resources <https://docs.aws.amazon.com/appstream2/latest/developerguide/tagging-basic.html>`__ in the *Amazon AppStream 2.0 Administration Guide* .
    ...
    def create_streaming_url(
        ...
        **Request Syntax**
        ...
        :param SessionContext:
          ...
          The session context. For more information, see `Session Context <https://docs.aws.amazon.com/appstream2/latest/developerguide/managing-stacks-fleets.html#managing-stacks-fleets-parameters>`__ in the *Amazon AppStream 2.0 Administration Guide* .
    ...
    def create_usage_report_subscription(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/appstream-2016-12-01/CreateUsageReportSubscription>`_
    ...
    def delete_usage_report_subscription(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/appstream-2016-12-01/DeleteUsageReportSubscription>`_
    ...
    def describe_usage_report_subscriptions(
        ...
        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/appstream-2016-12-01/DescribeUsageReportSubscriptions>`_
