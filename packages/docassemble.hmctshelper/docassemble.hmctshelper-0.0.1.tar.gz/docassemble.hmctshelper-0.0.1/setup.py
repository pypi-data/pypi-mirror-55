...
setup(name='docassemble.hmctshelper',
      ...
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/hmctshelper/', package='docassemble.hmctshelper'),
     )
