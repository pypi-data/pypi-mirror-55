...
class SignageliveServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateSnapshot = channel.unary_unary(
        '/admobilize.signagelive.v1alpha1.SignageliveService/CreateSnapshot',
        request_serializer=admobilize_dot_signagelive_dot_v1alpha1_dot_signagelive__service__pb2.SnapshotRequest.SerializeToString,
...
def add_SignageliveServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreateSnapshot': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=admobilize_dot_signagelive_dot_v1alpha1_dot_signagelive__service__pb2.SnapshotRequest.FromString,
