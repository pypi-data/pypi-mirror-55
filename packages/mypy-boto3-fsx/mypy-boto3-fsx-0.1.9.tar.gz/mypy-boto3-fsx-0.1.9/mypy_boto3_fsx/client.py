        ...
        :param WindowsConfiguration:
          ...
          - **SelfManagedActiveDirectoryConfiguration** *(dict) --*
            ...
            - **DnsIps** *(list) --* **[REQUIRED]**
              ...
              A list of up to two IP addresses of DNS servers or domain controllers in the self-managed AD directory. The IP addresses need to be either in the same VPC CIDR range as the one in which your Amazon FSx file system is being created, or in the private IP version 4 (Iv4) address ranges, as specified in `RFC 1918 <http://www.faqs.org/rfcs/rfc1918.html>`__ :
