...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def delete_faces(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def delete_stream_processor(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_collection(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_stream_processor(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_celebrity_info(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_celebrity_recognition(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_content_moderation(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_face_detection(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_face_search(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def get_label_detection(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def get_person_tracking(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_stream_processors(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def start_stream_processor(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def stop_stream_processor(self) -> None:
        pass
