...
class Iface(object):
    ...
    def sqlQuery(self, auth, query, offset, limit):
        """
        Parameters:
         - auth
         - query
...
class Client(Iface):
    ...
    def sqlQuery(self, auth, query, offset, limit):
        ...
        Parameters:
         ...
         - limit
        """
        self.send_sqlQuery(auth, query, offset, limit)
        return self.recv_sqlQuery()

    def send_sqlQuery(self, auth, query, offset, limit):
...
class Processor(Iface, TProcessor):
    ...
    def process_sqlQuery(self, seqid, iprot, oprot):
        ...
        result = sqlQuery_result()
        try:
            result.success = self._handler.sqlQuery(args.auth, args.query, args.offset, args.limit)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except koverse.thriftgen.ttypes.TKoverseException as ke:
...
fieldAutoSuggest_args.thrift_spec = (
    ...
    (4, TType.LIST, 'dataSetIds', (TType.STRING, 'UTF8', False), None, ),  # 4
)
...
class sqlQuery_args(object):
    ...
    def __init__(self, auth=None, query=None, offset=None, limit=None,):
        self.auth = auth
        self.query = query
        self.offset = offset
        self.limit = limit
