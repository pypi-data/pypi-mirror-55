...
class Client(BaseClient):
    ...
    def attach_policy(
        ...
        * **Service control policy (SCP)** - An SCP specifies what permissions can be delegated to users in affected member accounts. The scope of influence for a policy depends on what you attach the policy to:
        ...
        For more information about how AWS Organizations policies permissions work, see `Using Service Control Policies <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scp.html>`__ in the *AWS Organizations User Guide.*
    ...
    def create_account(
        ...
        * Check the AWS CloudTrail log for the ``CreateAccountResult`` event. For information on using AWS CloudTrail with AWS Organizations, see `Monitoring the Activity in Your Organization <http://docs.aws.amazon.com/organizations/latest/userguide/orgs_monitoring.html>`__ in the *AWS Organizations User Guide.*
    ...
    def create_organization(
        ...
        """
        Creates an AWS organization. The account whose user is calling the ``CreateOrganization`` operation automatically becomes the `master account <https://docs.aws.amazon.com/IAM/latest/UserGuide/orgs_getting-started_concepts.html#account>`__ of the new organization.
    ...
    def create_policy(
        ...
        **Request Syntax**
        ...
        :param Content: **[REQUIRED]**
          ...
          The policy content to add to the new policy. For example, if you create a `service control policy <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scp.html>`__ (SCP), this string must be JSON text that specifies the permissions that admins in attached accounts can delegate to their users, groups, and roles. For more information about the SCP syntax, see `Service Control Policy Syntax <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_reference_scp-syntax.html>`__ in the *AWS Organizations User Guide.*
    ...
    def describe_create_account_status(
        ...
        **Request Syntax**
        ...
        :param CreateAccountRequestId: **[REQUIRED]**
          ...
          The `regex pattern <http://wikipedia.org/wiki/regex>`__ for a create account request ID string requires "car-" followed by from 8 to 32 lower-case letters or digits.
    ...
    def detach_policy(
         ...
         **Note:** Every root, OU, and account must have at least one SCP attached. If you want to replace the default ``FullAWSAccess`` policy with one that limits the permissions that can be delegated, you must attach the replacement policy before you can remove the default one. This is the authorization strategy of `whitelisting <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_about-scps.html#orgs_policies_whitelist>`__ . If you instead attach a second SCP and leave the ``FullAWSAccess`` SCP still attached, and specify ``"Effect": "Deny"`` in the second SCP to override the ``"Effect": "Allow"`` in the ``FullAWSAccess`` policy (or any other attached SCP), you're using the authorization strategy of `blacklisting <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_about-scps.html#orgs_policies_blacklist>`__ .
