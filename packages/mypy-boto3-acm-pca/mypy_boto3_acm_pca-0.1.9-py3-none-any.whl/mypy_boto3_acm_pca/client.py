    ...
    def create_certificate_authority(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          IAM to manage permissions, see `Controlling Access Using IAM Tags <https://docs.aws.amazon.com/IAM/latest/UserGuide/access_iam-tags.html>`__ .
        ...
        **Request Syntax**
        ...
        :param TemplateArn:
          ...
          * arn:aws:acm-pca:::template/RootCACertificate/V1
          ...
          For more information, see `Using Templates <https://docs.aws.amazon.com/acm-pca/latest/userguide/UsingTemplates.html>`__ .
    ...
    def revoke_certificate(
        ...
        **Request Syntax**
        ...
        :param CertificateSerial: **[REQUIRED]**
          ...
          You can also copy the serial number from the console or use the `DescribeCertificate <https://docs.aws.amazon.com/acm/latest/APIReference/API_DescribeCertificate.html>`__ action in the *AWS Certificate Manager API Reference* .
