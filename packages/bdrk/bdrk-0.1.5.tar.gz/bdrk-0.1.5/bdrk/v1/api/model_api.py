...
class ModelApi(object):
    ...
    def get_artefact_details(self, model_id, artefact_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_artefact_details(model_id, artefact_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_artefact_details_with_http_info(model_id, artefact_id, **kwargs)  # noqa: E501

    def get_artefact_details_with_http_info(self, model_id, artefact_id, **kwargs):  # noqa: E501
        """get_artefact_details  # noqa: E501

        Get artefact via model collection public id and artefact ID  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_artefact_details_with_http_info(model_id, artefact_id, async_req=True)
        >>> result = thread.get()
