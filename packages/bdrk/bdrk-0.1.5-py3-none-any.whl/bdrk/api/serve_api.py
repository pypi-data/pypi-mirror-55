...
class ServeApi(object):
    ...
    def deploy_server(self, endpoint_id, **kwargs):  # noqa: E501
        ...
        :param InternalModelServerSchema internal_model_server_schema:
        ...
        :return: InternalModelServerSchema
    ...
    def deploy_server_with_http_info(self, endpoint_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InternalModelServerSchema, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['endpoint_id', 'internal_model_server_schema']  # noqa: E501
        ...
        body_params = None
        if 'internal_model_server_schema' in local_var_params:
            body_params = local_var_params['internal_model_server_schema']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='InternalModelServerSchema',  # noqa: E501
