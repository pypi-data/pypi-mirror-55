...
class ModelEndpointSchema(object):
    ...
    def __init__(self, created_at=None, created_by=None, environment_id=None, expose_method='PRIVATE', fqdn=None, hostname=None, id=None, ingress_protocol=None, object='endpoint', updated_at=None):  # noqa: E501
    ...
    @classmethod
    def from_response(cls, created_at=None, created_by=None, environment_id=None, expose_method='PRIVATE', fqdn=None, hostname=None, id=None, ingress_protocol=None, object='endpoint', updated_at=None):  # noqa: E501
