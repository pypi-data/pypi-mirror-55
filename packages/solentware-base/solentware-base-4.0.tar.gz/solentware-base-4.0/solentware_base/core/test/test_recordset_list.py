...
class RecordsetSegmentList(unittest.TestCase):
    ...
    def test_current_02(self):
        ...
        self.assertEqual(self.rsl.current(), ('key', 65602))
    ...
    def test_first_01(self):
        self.assertEqual(self.rsl.first(), ('key', 65601))
    ...
    def test_get_record_number_at_position(self):
        self.assertEqual(self.rsl.get_record_number_at_position(0), 65601)

    def test_last_01(self):
        self.assertEqual(self.rsl.last(), ('key', 65603))
    ...
    def test_next(self):
        self.assertEqual(self.rsl.next(), ('key', 65601))
        self.assertEqual(self.rsl._current_position_in_segment, 0)
        self.assertEqual(self.rsl.next(), ('key', 65602))
        self.assertEqual(self.rsl.next(), ('key', 65603))
        self.assertEqual(self.rsl.next(), None)

    def test_prev(self):
        self.assertEqual(self.rsl.prev(), ('key', 65603))
        self.assertEqual(self.rsl._current_position_in_segment, 2)
        self.assertEqual(self.rsl.prev(), ('key', 65602))
        self.assertEqual(self.rsl.prev(), ('key', 65601))
        self.assertEqual(self.rsl.prev(), None)

    def test_setat_01(self):
        self.assertEqual(self.rsl.setat(65601), ('key', 65601))
        self.assertEqual(self.rsl._current_position_in_segment, 0)

    def test_setat_02(self):
        self.assertEqual(self.rsl.setat(65600), None)
