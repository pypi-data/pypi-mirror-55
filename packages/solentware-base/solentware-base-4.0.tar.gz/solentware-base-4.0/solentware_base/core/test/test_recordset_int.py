...
class RecordsetSegmentInt(unittest.TestCase):
    ...
    def test_current_02(self):
        ...
        self.assertEqual(self.rsi.current(), ('key', 65601))

    def test_first_01(self):
        self.assertEqual(self.rsi.first(), ('key', 65601))
    ...
    def test_get_record_number_at_position(self):
        self.assertEqual(self.rsi.get_record_number_at_position(None), 65601)

    def test_last_01(self):
        self.assertEqual(self.rsi.last(), ('key', 65601))
        self.assertEqual(self.rsi._current_position_in_segment, 0)
    ...
    def test_next_01(self):
        self.assertEqual(self.rsi.next(), ('key', 65601))
        self.assertEqual(self.rsi._current_position_in_segment, 0)
    ...
    def test_prev_01(self):
        self.assertEqual(self.rsi.prev(), ('key', 65601))
        self.assertEqual(self.rsi._current_position_in_segment, 0)
    ...
    def test_setat_02(self):
        self.assertEqual(self.rsi.setat(65602), None)
