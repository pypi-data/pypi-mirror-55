...
class _Recordset(unittest.TestCase):
    ...
    def test_get_position_of_record_number(self):
        ...
        self.assertEqual(self.rs.get_position_of_record_number(80000), 0)
        self.rs[self.rsl.segment_number] = self.rsl
        self.assertEqual(self.rs.get_position_of_record_number(80000), 3)
        self.assertEqual(self.rs.get_position_of_record_number(65602), 2)
        self.rs[0] = recordset.RecordsetSegmentList(
            0, 'key', records=b'\x00A\x00B\x00C')
        self.assertEqual(self.rs.get_position_of_record_number(65602), 5)
    ...
    def test_get_record_number_at_position(self):
        ...
        self.rs[self.rsl.segment_number] = self.rsl
        self.assertEqual(self.rs.get_record_number_at_position(2), 65602)
        self.rs[0] = recordset.RecordsetSegmentList(
            0, 'key', records=b'\x00A\x00B\x00C')
        self.assertEqual(self.rs.get_record_number_at_position(5), 65602)
    ...
    def test_first(self):
        ...
        self.rs[self.rsl.segment_number] = self.rsl
        self.assertEqual(self.rs.first(), ('key', 65601))

    def test_last(self):
        self.assertEqual(self.rs.last(), None)
        self.rs[self.rsl.segment_number] = self.rsl
        self.assertEqual(self.rs.last(), ('key', 65603))

    def test_next(self):
        self.assertEqual(self.rs.next(), None)
        self.rs[self.rsl.segment_number] = self.rsl
        self.assertEqual(self.rs.next(), ('key', 65601))
        self.assertEqual(self.rs.next(), ('key', 65602))
        self.assertEqual(self.rs.next(), ('key', 65603))
        self.assertEqual(self.rs.next(), None)
        self.rs[4] = recordset.RecordsetSegmentList(
            4, 'key', records=b'\x00A\x00B\x00C')
        self.assertEqual(self.rs.next(), ('key', 131137))

    def test_prev(self):
        self.assertEqual(self.rs.prev(), None)
        self.rs[self.rsl.segment_number] = self.rsl
        self.assertEqual(self.rs.prev(), ('key', 65603))
        self.assertEqual(self.rs.prev(), ('key', 65602))
        self.assertEqual(self.rs.prev(), ('key', 65601))
        self.assertEqual(self.rs.prev(), None)
        self.rs[1] = recordset.RecordsetSegmentList(
            1, 'key', records=b'\x00A\x00B\x00C')
        self.assertEqual(self.rs.prev(), ('key', 32835))
    ...
    def test_current(self):
        ...
        self.assertEqual(self.rs.current(), ('key', 65601))
    ...
    def test_setat(self):
        ...
        self.assertEqual(self.rs.setat(32835), None)
        self.rs[self.rsl.segment_number] = self.rsl
        self.assertEqual(self.rs.setat(32835), None)
        self.rs[1] = recordset.RecordsetSegmentList(
            1, 'key', records=b'\x00A\x00B\x00C')
        self.assertEqual(self.rs.setat(32835), ('key', 32835))
    ...
    def test_is_record_number_in_record_set_01(self):
        ...
        self.assertEqual(self.rs.is_record_number_in_record_set(65600), False)
        self.assertEqual(self.rs.is_record_number_in_record_set(65601), False)

    def test_is_record_number_in_record_set_02(self):
        self.rs[self.rsl.segment_number] = self.rsl
        self.assertEqual(self.rs.is_record_number_in_record_set(1), False)
        self.assertEqual(self.rs.is_record_number_in_record_set(65600), False)
        self.assertEqual(self.rs.is_record_number_in_record_set(65601), True)
    ...
    def test_place_record_number_01(self):
        self.assertEqual(len(self.rs._rs_segments), 0)
        self.assertEqual(self.rs.place_record_number(65600), None)
    ...
    def test_place_record_number_02(self):
        ...
        self.assertEqual(self.rs.count_records(), 3)
        self.assertEqual(self.rs.place_record_number(65601), None)
        self.assertIsInstance(self.rs._rs_segments[2],
                              recordset.RecordsetSegmentBitarray)
        self.assertEqual(self.rs.count_records(), 3)
        self.assertEqual(self.rs.place_record_number(65600), None)
    ...
    def test_remove_record_number_02(self):
        ...
        self.assertIsInstance(self.rs._rs_segments[2],
                              recordset.RecordsetSegmentBitarray)
        self.assertEqual(self.rs.count_records(), 3)
        self.assertEqual(self.rs.remove_record_number(65601), None)
        self.assertIsInstance(self.rs._rs_segments[2],
                              recordset.RecordsetSegmentBitarray)
