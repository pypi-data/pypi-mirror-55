...
class Database_methods(_DBOpen):
    ...
    def test_14_make_recordset_record_number(self):
        self.assertIsInstance(
            self.database.recordlist_record_number('file1'),
            recordset.RecordList)

    def test_15_make_recordset_record_number(self):
        self.assertIsInstance(
            self.database.recordlist_record_number('file1', key=2),
            recordset.RecordList)

    def test_16_make_recordset_record_number(self):
        self.database.table['file1'][0].put(1, 'Some value')
        self.assertIsInstance(
            self.database.recordlist_record_number('file1', key=1),
            recordset.RecordList)

    def test_17_make_recordset_record_number_range(self):
        self.assertIsInstance(
            self.database.recordlist_record_number_range('file1'),
            recordset.RecordList)

    def test_18_make_recordset_record_number_range(self):
        self.create_ebm()
    ...
    def test_19_make_recordset_record_number_range(self):
        self.create_ebm()
        rs = self.database.recordlist_record_number_range(
            'file1', keystart=10)
        self.assertIsInstance(rs, recordset.RecordList)
    ...
    def test_20_make_recordset_record_number_range(self):
        self.create_ebm()
        rs = self.database.recordlist_record_number_range(
            'file1', keyend=35)
        self.assertIsInstance(rs, recordset.RecordList)
    ...
    def test_21_make_recordset_record_number_range(self):
        self.create_ebm()
        rs = self.database.recordlist_record_number_range(
    ...
    def test_22_make_recordset_ebm(self):
        self.assertIsInstance(
            self.database.recordlist_ebm('file1'),
            recordset.RecordList)

    def test_23_make_recordset_ebm(self):
        self.create_ebm()
        self.assertIsInstance(
            self.database.recordlist_ebm('file1'),
            recordset.RecordList)

    def test_24_get_table_connection(self):
        self.assertEqual(
...
class Database_make_recordset(_DBOpen):
    ...
    def test_57__populate_recordset_segment(self):
        ...
        self.assertEqual(len(rs), 0)
        self.assertEqual(d._populate_recordset_segment(rs, bl), None)
        self.assertEqual(len(rs), 1)
        self.assertIsInstance(rs[0], recordset.RecordsetSegmentList)
        self.assertEqual(d._populate_recordset_segment(rs, bs), None)
        self.assertEqual(len(rs), 1)
        self.assertIsInstance(rs[0], recordset.RecordsetSegmentBitarray)
        self.assertEqual(
            d._populate_recordset_segment(rs, b'\x00\x00\x00\x00\x00\x01'),
            None)
        self.assertEqual(len(rs), 1)
        self.assertIsInstance(rs[0], recordset.RecordsetSegmentBitarray)
        self.assertEqual(
            d._populate_recordset_segment(rs, b'\x00\x00\x00\x01\x00\x05'),
            None)
        self.assertEqual(len(rs), 2)
        self.assertIsInstance(rs[0], recordset.RecordsetSegmentBitarray)
