...
id = "de59ab2ba5ffdc5a9c5dd1b898bbe86ac51420be"
date = "2019-11-6 20:28:25 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "de59ab2ba5ffdc5a9c5dd1b898bbe86ac51420be":
        return
    msg = "Program id (de59ab2ba5ffdc5a9c5dd1b898bbe86ac51420be) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
