...
class SkriwarePlugin:
      ...
      self.commands = (
        {
          'name': 'Foo',
          'handler': self.foo,
          'icon': SkriwarePlugin.relpath('foo.png'),
          'menubar': True,
          'toolbar': True,
        },
        {
  ...
  def foo(self):
    # Pass the python code
    # to built-in shell and execute
    code = 'import time\n'
