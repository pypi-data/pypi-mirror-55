            ...
            - **ClientVpnEndpoints** *(list) --*
              ...
              - *(dict) --*
                ...
                - **SplitTunnel** *(boolean) --*
                  ...
                  For information about split-tunnel VPN endpoints, see `Split-Tunnel AWS Client VPN Endpoint <https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/split-tunnel-vpn.html>`__ in the *AWS Client VPN Administrator Guide* .
...
class DescribeDhcpOptions(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`EC2.Client.describe_dhcp_options`.
            ...
            - **Hosts** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ClientToken** *(string) --*
                  ...
                  Unique, case-sensitive identifier that you provide to ensure the idempotency of the request. For more information, see `How to Ensure Idempotency <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Run_Instance_Idempotency.html>`__ .
            ...
            - **NatGateways** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ProvisionedBandwidth** *(dict) --*
                  ...
                  Reserved. If you need to sustain traffic greater than the `documented limits <https://docs.aws.amazon.com/vpc/latest/userguide/vpc-nat-gateway.html>`__ , contact us through the `Support Center <https://console.aws.amazon.com/support/home?>`__ .
              ...
              - *(dict) --*
                ...
                - **SpotFleetRequestConfig** *(dict) --*
                  ...
                  - **IamFleetRole** *(string) --*
                    ...
                    The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that grants the Spot Fleet the permission to request, launch, terminate, and tag instances on your behalf. For more information, see `Spot Fleet Prerequisites <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet-requests.html#spot-fleet-prerequisites>`__ in the *Amazon EC2 User Guide for Linux Instances* . Spot Fleet can terminate Spot Instances on your behalf when you cancel its Spot Fleet request using  CancelSpotFleetRequests or when the Spot Fleet request expires, if you set ``TerminateInstancesWithExpiration`` .
                  ...
                  - **LaunchSpecifications** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      Describes the launch specification for one or more Spot Instances. If you include On-Demand capacity in your fleet request, you can't use ``SpotFleetLaunchSpecification`` ; you must use `LaunchTemplateConfig <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_LaunchTemplateConfig.html>`__ .
...
class DescribeSubnets(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`EC2.Client.describe_subnets`.
...
class DescribeTrafficMirrorFilters(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`EC2.Client.describe_traffic_mirror_filters`.

        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTrafficMirrorFilters>`_
...
class DescribeTrafficMirrorSessions(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`EC2.Client.describe_traffic_mirror_sessions`.

        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTrafficMirrorSessions>`_
...
class DescribeTrafficMirrorTargets(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`EC2.Client.describe_traffic_mirror_targets`.

        See also: `AWS API Documentation <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTrafficMirrorTargets>`_
