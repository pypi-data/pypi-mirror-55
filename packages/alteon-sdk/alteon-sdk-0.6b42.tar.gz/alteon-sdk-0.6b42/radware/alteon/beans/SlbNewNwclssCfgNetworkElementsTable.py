...
class EnumSlbNwclssNetworkElementsTypeAddrOrRegn(BaseBeanEnum):
    address = 1
    region = 2
...
class SlbNewNwclssCfgNetworkElementsTable(DeviceBean):
    def __init__(self, **kwargs):
        ...
        self.TypeAddrOrRegn = EnumSlbNwclssNetworkElementsTypeAddrOrRegn.enum(kwargs.get('TypeAddrOrRegn', None))
