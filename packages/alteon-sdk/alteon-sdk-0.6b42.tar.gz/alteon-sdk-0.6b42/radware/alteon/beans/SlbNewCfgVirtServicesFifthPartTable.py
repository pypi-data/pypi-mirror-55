...
class EnumSlbVirtServiceServApplicationType(BaseBeanEnum):
    basic_slb = 1
    dns = 2
    ftp = 3
    ftp_data = 4
...
class SlbNewCfgVirtServicesFifthPartTable(DeviceBean):
    def __init__(self, **kwargs):
        ...
        self.ServApplicationType = EnumSlbVirtServiceServApplicationType.enum(kwargs.get('ServApplicationType', None))
