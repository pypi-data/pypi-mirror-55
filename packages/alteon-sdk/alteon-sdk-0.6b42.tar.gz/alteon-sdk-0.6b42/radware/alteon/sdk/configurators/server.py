...
class ServerParameters(RadwareParametersStruct):
    ...
    connection_mode: Optional[EnumSlbRealServerSecondPartMode]
    availability: Optional[int]
    server_type: Optional[EnumSlbRealServerType]
    nat_mode: Optional[EnumSlbRealServerSecondPartProxyIpMode]
    nat_address: Optional[str]
    nat_subnet: Optional[str]
    nat6_address: Optional[str]
    nat6_prefix: Optional[int]
    nat_ip_persistency: Optional[EnumSlbRealServerSecondPartProxyIpPersistency]
    nat_network_class_name: Optional[str]
    nat_net_class_ip_persistency: Optional[EnumSlbRealServerSecondPartProxyIpNWclassPersistency]
...
bean_state_map = {
    SlbEnhRealServerInfoTable: dict(exclude=['UpTime', 'DownTime'])
}
