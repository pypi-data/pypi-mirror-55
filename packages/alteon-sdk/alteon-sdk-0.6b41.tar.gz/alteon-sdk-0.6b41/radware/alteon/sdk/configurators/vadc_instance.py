...
class VADCInstanceParameters(RadwareParametersStruct):
    ...
    delegation_vx_syslog: Optional[EnumVADCSysSyslogDelegation]
    delegation_vx_radius: Optional[EnumVADCSysRadiusDelegation]
    delegation_vx_tacacs: Optional[EnumVADCSysTacacsDelegation]
    delegation_vx_smtp: Optional[EnumVADCSysSmtpDelegation]
