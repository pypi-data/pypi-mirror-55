...
class EnumFltExtendedExtended8021pBitsMatch(BaseBeanEnum):
    enabled = 1
    disabled = 2
...
class FltNewCfgExtendedTable(DeviceBean):
    def __init__(self, **kwargs):
        ...
        self.Extended8021pBitsMatch = EnumFltExtendedExtended8021pBitsMatch.enum(kwargs.get('Extended8021pBitsMatch', None))
