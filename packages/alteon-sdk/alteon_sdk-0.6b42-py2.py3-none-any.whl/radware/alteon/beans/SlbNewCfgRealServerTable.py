...
class EnumSlbRealServerUpdateAllRealServers(BaseBeanEnum):
    none = 0
    mode = 1
    maxcon = 2
    weight = 3
...
class SlbNewCfgRealServerTable(DeviceBean):
    def __init__(self, **kwargs):
        ...
        self.UpdateAllRealServers = EnumSlbRealServerUpdateAllRealServers.enum(kwargs.get('UpdateAllRealServers', None))
