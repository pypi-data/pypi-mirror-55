...
class EnumVADCSysSyslogDelegation(BaseBeanEnum):
    enabled = 2
    disabled = 3


class EnumVADCSysRadiusDelegation(BaseBeanEnum):
    enabled = 2
    disabled = 3


class EnumVADCSysTacacsDelegation(BaseBeanEnum):
    enabled = 2
    disabled = 3


class EnumVADCSysSmtpDelegation(BaseBeanEnum):
    enabled = 2
    disabled = 3
...
class EnumVADCSysIdleDelegation(BaseBeanEnum):
    enabled = 2
    disabled = 3
...
class VADCNewCfgSysTable(DeviceBean):
    def __init__(self, **kwargs):
        ...
        self.SyslogDelegation = EnumVADCSysSyslogDelegation.enum(kwargs.get('SyslogDelegation', None))
        self.RadiusDelegation = EnumVADCSysRadiusDelegation.enum(kwargs.get('RadiusDelegation', None))
        self.TacacsDelegation = EnumVADCSysTacacsDelegation.enum(kwargs.get('TacacsDelegation', None))
        self.SmtpDelegation = EnumVADCSysSmtpDelegation.enum(kwargs.get('SmtpDelegation', None))
        ...
        self.IdleDelegation = EnumVADCSysIdleDelegation.enum(kwargs.get('IdleDelegation', None))
