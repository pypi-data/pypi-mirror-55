...
CREATE_DIRECTORY_MODULE_PATH = 'registerMap.export.c.output.macro.MacroTemplates.createDirectory'
...
class TestExternMacroTemplate( unittest.TestCase ) :
    ...
    def setUp( self ) :
        ...
        self.templateConfig = copy.deepcopy( MACRO_TEMPLATE_CONFIGURATION )
        self.templateConfig[ 'files' ] = [ self.templateConfig[ 'files' ][ 1 ] ]


    def testExternMacroOutput( self ) :
        paths = MacroTemplates.Paths()
        paths.includeDirectory = self.includeDirectory
        paths.sourceDirectory = self.sourceDirectory
