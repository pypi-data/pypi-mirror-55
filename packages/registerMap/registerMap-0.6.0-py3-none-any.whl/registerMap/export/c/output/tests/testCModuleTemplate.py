...
CREATE_DIRECTORY_MODULE_PATH = 'registerMap.export.c.output.module.ModuleTemplates.createDirectory'
OPEN_MODULE_PATH = 'registerMap.export.commonCppC.output.module.open'


class TestCModuleTemplates( unittest.TestCase ) :
    ...
    def testInitialCreatedFiles( self ) :
        ...
        outputUnderTest = ModuleTemplates( paths,
                                           self.registerMap )
