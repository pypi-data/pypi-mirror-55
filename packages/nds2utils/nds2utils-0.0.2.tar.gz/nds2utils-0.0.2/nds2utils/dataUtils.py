...
def find_channels(  channel_glob='*',
    ...
    # Get only 'online' channels which can be streamed using stitchRealTimeData()
...
def acquireData(channels,
    ...
    dataDict = acquireData(['H1:LSC-DARM_IN1_DQ', 'H1:LSC-DARM_OUT_DQ'], 1256340013, 1256340167)

    # Get minute and second trends.  Beware of getting minute trends too close to the present, will return only nans
    dataDict = acquireData(['H1:ISI-GND_STS_ITMY_Y_BLRMS_30M_100M.mean,m-trend',
...
def stitchRealTimeData( channels,
    ...
    Inputs:
    channels           = array of strs. Valid LIGO channels from which to fetch data.
                         All channels must be an "online" channel.
