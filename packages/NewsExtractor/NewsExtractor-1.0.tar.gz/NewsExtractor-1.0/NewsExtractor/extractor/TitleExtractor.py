...
from NewsExtractor.defaults import TITLE_HTAG_XPATH, \
...
class TitleExtractor:
    ...
    def extract(self, element: HtmlElement, title_xpath: str = ''):
        title = self.extract_by_xpath(element, title_xpath) or \
                self.extract_by_title(element) or self.extract_by_htag(element)
        return title
