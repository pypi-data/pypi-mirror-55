...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def delete_delivery_stream(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def describe_delivery_stream(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_delivery_streams(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def list_tags_for_delivery_stream(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def start_delivery_stream_encryption(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def stop_delivery_stream_encryption(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def untag_delivery_stream(self) -> None:
        pass
