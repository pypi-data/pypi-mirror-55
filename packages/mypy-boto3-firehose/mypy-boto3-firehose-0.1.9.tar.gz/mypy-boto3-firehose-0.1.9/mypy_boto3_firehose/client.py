        ...
        **Request Syntax**
        ...
        :param S3DestinationConfiguration:
          ...
          - **Prefix** *(string) --*
            ...
            The "YYYY/MM/DD/HH" time format prefix is automatically used for delivered Amazon S3 files. You can also specify a custom prefix, as described in `Custom Prefixes for Amazon S3 Objects <https://docs.aws.amazon.com/firehose/latest/dev/s3-prefixes.html>`__ .

          - **ErrorOutputPrefix** *(string) --*

            A prefix that Kinesis Data Firehose evaluates and adds to failed records before writing them to S3. This prefix appears immediately following the bucket name. For information about how to specify this prefix, see `Custom Prefixes for Amazon S3 Objects <https://docs.aws.amazon.com/firehose/latest/dev/s3-prefixes.html>`__ .
              ...
              - **Deserializer** *(dict) --*
                ...
                - **HiveJsonSerDe** *(dict) --*
                  ...
                  - **TimestampFormats** *(list) --*
                    ...
                    Indicates how you want Kinesis Data Firehose to parse the date and timestamps that may be present in your input data JSON. To specify these format strings, follow the pattern syntax of JodaTime's DateTimeFormat format strings. For more information, see `Class DateTimeFormat <https://www.joda.org/joda-time/apidocs/org/joda/time/format/DateTimeFormat.html>`__ . You can also use the special value ``millis`` to parse timestamps in epoch milliseconds. If you don't specify a format, Kinesis Data Firehose uses ``java.sql.Timestamp::valueOf`` by default.
        ...
        :param RedshiftDestinationConfiguration:
          ...
          - **CopyCommand** *(dict) --* **[REQUIRED]**
            ...
            - **CopyOptions** *(string) --*
              ...
              Optional parameters to use with the Amazon Redshift ``COPY`` command. For more information, see the "Optional Parameters" section of `Amazon Redshift COPY command <https://docs.aws.amazon.com/redshift/latest/dg/r_COPY.html>`__ . Some possible examples that would apply to Kinesis Data Firehose are as follows:
              ...
              For more examples, see `Amazon Redshift COPY command examples <https://docs.aws.amazon.com/redshift/latest/dg/r_COPY_command_examples.html>`__ .
