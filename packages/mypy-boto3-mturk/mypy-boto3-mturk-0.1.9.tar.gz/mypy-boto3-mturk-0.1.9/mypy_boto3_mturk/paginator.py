...
class ListAssignmentsForHIT(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`MTurk.Client.list_assignments_for_hit`.
...
class ListBonusPayments(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`MTurk.Client.list_bonus_payments`.
...
class ListHITsForQualificationType(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`MTurk.Client.list_hits_for_qualification_type`.
...
class ListQualificationTypes(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`MTurk.Client.list_qualification_types`.
...
class ListReviewableHITs(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`MTurk.Client.list_reviewable_hits`.
...
class ListWorkerBlocks(Boto3Paginator):
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`MTurk.Client.list_worker_blocks`.
