...
def send_bmi_request(request, payment):
    ...
    call_back_url = 'https://www.aparnik.co.ir/admin/'#request.build_absolute_uri(reverse('aparnik:shops:zarinpals:verify', args=[payment.uuid]))
    ...
    init_response = requests.post(API_URL_REQUEST, data=init_data)
