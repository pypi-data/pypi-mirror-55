...
4.1.2.post5 (2019-11-12)
------------------------

- Fix typo in attribute name
  [Asko Soukka]

4.1.2.post4 (2019-11-11)
------------------------

- Fix issue where local None on sectionSiteLayout blocked acquisition
  [Asko Soukka]

4.1.2 (2018-07-02)
------------------

- Fix issue where resolving layout url with ajax_load parameter caused fail on
  direct resolve directory lookup
  [Asko Soukka]

- Fix issue where failed resource lookup into filesystem resource directory raised IOError
  [Asko Soukka]

- fix deprecated import Globals
  [Peter Mathis]

- Fix issue where raw site layouts were transformed by diazo
  [Asko Soukka]
