...
class ServiceResource(Boto3ServiceResource):
    def Account(self, id: str) -> mypy_boto3_glacier_scope.Account:
        """
    ...
    def Vault(self, account_id: str, name: str) -> mypy_boto3_glacier_scope.Vault:
        """
    ...
    def create_vault(self, vaultName: str) -> mypy_boto3_glacier_scope.Vault:
        """
...
class Archive(Boto3ServiceResource):
    ...
    def initiate_archive_retrieval(self) -> mypy_boto3_glacier_scope.Job:
        """
...
class Vault(Boto3ServiceResource):
    ...
    def initiate_inventory_retrieval(self) -> mypy_boto3_glacier_scope.Job:
        """
        This operation initiates a job of the specified type, which can be a select, an archival retrieval, or a vault retrieval. For more information about using this operation, see the documentation for the underlying REST API `Initiate a Job <https://docs.aws.amazon.com/amazonglacier/latest/dev/api-initiate-job-post.html>`__ .
...
class vaults(ResourceCollection):
    @classmethod
    def all(cls) -> List[mypy_boto3_glacier_scope.Vault]:
        """
    ...
    ) -> List[mypy_boto3_glacier_scope.Vault]:
        """
    ...
    @classmethod
    def limit(cls, count: int = None) -> List[mypy_boto3_glacier_scope.Vault]:
        """
    ...
    @classmethod
    def page_size(cls, count: int = None) -> List[mypy_boto3_glacier_scope.Vault]:
        """
...
class completed_jobs(ResourceCollection):
    @classmethod
    def all(cls) -> List[mypy_boto3_glacier_scope.Job]:
        """
    ...
    ) -> List[mypy_boto3_glacier_scope.Job]:
        """
    ...
    @classmethod
    def limit(cls, count: int = None) -> List[mypy_boto3_glacier_scope.Job]:
        """
    ...
    @classmethod
    def page_size(cls, count: int = None) -> List[mypy_boto3_glacier_scope.Job]:
        """
...
class multipart_uplaods(ResourceCollection):
    @classmethod
    def all(cls) -> List[mypy_boto3_glacier_scope.MultipartUpload]:
        """
    ...
    def filter(
        cls, marker: str = None, limit: str = None
    ) -> List[mypy_boto3_glacier_scope.MultipartUpload]:
        """
    ...
    @classmethod
    def limit(cls, count: int = None) -> List[mypy_boto3_glacier_scope.MultipartUpload]:
        """
