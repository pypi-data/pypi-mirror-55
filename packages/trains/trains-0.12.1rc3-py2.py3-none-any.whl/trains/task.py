...
from .utilities.proxy_object import ProxyDictPreWrite, ProxyDictPostWrite
...
class Task(_Task):
    ...
    **Usage:** :func:`Task.init` or :func:`Task.get_task`
    ...
    @classmethod
    def get_tasks(cls, project_name=None, task_name=None):
        """
        ...
        :param str task_name: task name (str) in within the selected project (use None for all tasks within the project)
        :return: list of Task object
        """
        return cls.__get_tasks(project_name=project_name, task_name=task_name)
    ...
    @classmethod
    def __get_tasks(cls, project_name=None, task_name=None):
        if project_name:
            res = cls._send(
                cls._get_default_session(),
                projects.GetAllRequest(
