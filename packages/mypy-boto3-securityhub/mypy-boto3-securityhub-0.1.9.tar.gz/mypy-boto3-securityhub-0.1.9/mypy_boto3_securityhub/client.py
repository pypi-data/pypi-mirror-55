...
class Client(BaseClient):
    ...
    def batch_disable_standards(
        ...
        """
        Disables the standards specified by the provided ``StandardsSubscriptionArns`` . For more information, see `Standards Supported in AWS Security Hub <https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-standards.html>`__ .
    ...
    def batch_enable_standards(
        ...
        """
        Enables the standards specified by the provided ``standardsArn`` . In this release, only CIS AWS Foundations standards are supported. For more information, see `Standards Supported in AWS Security Hub <https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-standards.html>`__ .
    ...
    def batch_import_findings(
        ...
        **Request Syntax**
        ...
        :param Findings: **[REQUIRED]**
          ...
          A list of findings to import. To successfully import a finding, it must follow the `AWS Security Finding Format <https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-findings-format.html>`__ .
