...
__last_update__="Sat Oct 26 2019"
__license__="""
...
hard_dependencies = ('numpy', 'scipy', 'matplotlib', 'pandas','sklearn', 'statsmodels', 'pyodbc', 'sqlalchemy', 'mltk', 'sqlalchemy', 'snowflake') #,'re', 'tensorflow', 'catboost') #'tensorflow'
