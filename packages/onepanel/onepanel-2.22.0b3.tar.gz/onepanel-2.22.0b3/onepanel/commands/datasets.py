...
@click.option('-p', '--public', type=bool, required=False, help='Make dataset public.')
@click.pass_context
@login_required
...
@click.argument('public', type=bool, help='Make dataset public.')
@click.pass_context
@login_required
def datasets_create(ctx, name, public=None):
    vc = ctx.obj['vc']
