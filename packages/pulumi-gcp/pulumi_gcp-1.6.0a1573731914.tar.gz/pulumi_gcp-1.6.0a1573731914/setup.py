...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.6.0-alpha.1573731914+g7041f5e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.6.0-alpha.1573731914+g7041f5e`
                """)
            else:
                raise
