...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.5.0-alpha.1573081226+g6e9df3e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.5.0-alpha.1573081226+g6e9df3e`
                """)
            else:
                raise
