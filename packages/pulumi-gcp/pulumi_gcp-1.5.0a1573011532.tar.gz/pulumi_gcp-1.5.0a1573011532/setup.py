...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.5.0-alpha.1573011532+g24ee09c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.5.0-alpha.1573011532+g24ee09c`
                """)
            else:
                raise
