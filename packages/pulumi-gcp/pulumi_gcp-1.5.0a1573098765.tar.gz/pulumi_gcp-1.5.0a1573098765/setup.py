...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.5.0-alpha.1573098765+gd8dce8a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.5.0-alpha.1573098765+gd8dce8a`
                """)
            else:
                raise
