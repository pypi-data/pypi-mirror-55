...
class BertService():
    def __init__(self,
        ...
        self.vocab_dict = {
            'bert_chinese_L-12_H-768_A-12': py_path + '/vocab/chinese_vocab.txt',
            'bert_uncased_L-12_H-768_A-12': py_path + '/vocab/uncased_vocab.txt',
            'bert_uncased_L-24_H-1024_A-16': py_path + '/vocab/uncased_vocab.txt',
            'bert_cased_L-12_H-768_A-12': py_path + '/vocab/cased_vocab.txt',
            'bert_cased_L-24_H-1024_A-16': py_path + '/vocab/cased_vocab.txt',
            'bert_multi_cased_L-12_H-768_A-12': py_path + '/vocab/multi_cased_vocab.txt'
        }
