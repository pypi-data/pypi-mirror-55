...
const string DICT_PATH =  string("./cppjieba_py/cppjieba/dict/jieba.dict.utf8");
const string HMM_PATH =  string("./cppjieba_py/cppjieba/dict/hmm_model.utf8");
const string IDF_PATH =  string("./cppjieba_py/cppjieba/dict/idf.utf8");
const string STOP_WORD_PATH =  string("./cppjieba_py/cppjieba/dict/stop_words.utf8");
