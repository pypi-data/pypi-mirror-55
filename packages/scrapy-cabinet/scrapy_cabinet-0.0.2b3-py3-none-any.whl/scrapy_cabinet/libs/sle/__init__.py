...
class SmartListInfoExtractor(object):
    ...
    def __init__(self, key_map: Dict, list_key: str = "", time_key: str = "", title_key: str = "", url_key: str = ""):
    ...
    def extract(self, html: Union[AnyStr, HtmlElement]):
        ...
        for index, i in enumerate(list):
            ...
            result.append({
                self.key_map['url']: self.url_extractor.extractor(i),
                self.key_map['title']: self.title_extractor.extractor(i),
                self.key_map['time']: self.time_extractor.extractor(i)
            })
