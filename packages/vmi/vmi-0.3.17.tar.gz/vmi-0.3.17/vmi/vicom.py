...
# def pickle_SeriesData(instance: SeriesData):
#     files = {pathlib.Path(f).name: pathlib.Path(f).read_bytes() for f in instance.filenames()}
#     return unpickle_SeriesData, (ary,)
#
#
# def unpickle_SeriesData(ary):
#     instance = SeriesData(ary=ary)
#     return instance
#
#
# copyreg.pickle(SeriesData, pickle_SeriesData)
