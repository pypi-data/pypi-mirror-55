...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ
    def create_application_snapshot(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def delete_application_cloud_watch_logging_option(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def delete_application_input_processing_configuration(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def delete_application_output(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def delete_application_reference_data_source(self) -> None:
        pass

    # pylint: disable=arguments-differ
    def delete_application_snapshot(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def describe_application_snapshot(self) -> None:
        pass
    ...
    # pylint: disable=arguments-differ
    def list_application_snapshots(self) -> None:
        pass
