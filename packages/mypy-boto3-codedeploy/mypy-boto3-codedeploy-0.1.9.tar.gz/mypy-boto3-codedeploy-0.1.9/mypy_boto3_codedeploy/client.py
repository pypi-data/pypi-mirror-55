                ...
                - **lambdaTarget** *(dict) --*
                  ...
                  - **lambdaFunctionInfo** *(dict) --*
                    ...
                    - **functionAlias** *(string) --*
                      ...
                      The alias of a Lambda function. For more information, see `Introduction to AWS Lambda Aliases <https://docs.aws.amazon.com/lambda/latest/dg/aliases-intro.html>`__ .
