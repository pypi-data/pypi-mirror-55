...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancingv2-targets", "1.16.2", __name__, "aws-elasticloadbalancingv2-targets@1.16.2.jsii.tgz")
