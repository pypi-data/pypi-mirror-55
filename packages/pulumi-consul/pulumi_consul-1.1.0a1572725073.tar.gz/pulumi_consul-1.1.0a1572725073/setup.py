...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v1.1.0-alpha.1572725073+g00d6ef2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v1.1.0-alpha.1572725073+g00d6ef2`
                """)
            else:
                raise
