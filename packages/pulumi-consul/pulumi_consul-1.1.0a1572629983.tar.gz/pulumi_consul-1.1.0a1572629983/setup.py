...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v1.1.0-alpha.1572629983+gb1752c6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v1.1.0-alpha.1572629983+gb1752c6`
                """)
            else:
                raise
