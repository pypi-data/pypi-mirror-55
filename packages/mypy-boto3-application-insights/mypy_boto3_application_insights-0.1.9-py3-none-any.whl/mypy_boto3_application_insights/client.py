    ...
    def update_component_configuration(
        ...
        **Request Syntax**
        ...
        :param ComponentConfiguration:
          ...
          The configuration settings of the component. The value is the escaped JSON of the configuration. For more information about the JSON format, see `Working with JSON <https://docs.aws.amazon.com/sdk-for-javascript/v2/developer-guide/working-with-json.html>`__ . You can send a request to ``DescribeComponentConfigurationRecommendation`` to see the recommended configuration for a component.
