...
TEST_CMIP6OUTPUT_HFDS_WITH_NLON_NLAT_FILE = join(
    TEST_DATA_CMIP6OUTPUT_DIR,
    "CMIP6",
    "GeoMIP",
    "NCAR",
...
@pytest.fixture
def test_cmip6_output_hfds_with_nlon_nlat_file():
    return TEST_CMIP6OUTPUT_HFDS_WITH_NLON_NLAT_FILE
...
def test_cmip6_stitch_output(test_data_root_dir):
    return join(test_data_root_dir, "expected-stitch-output", "cmip6output", "CMIP6")
