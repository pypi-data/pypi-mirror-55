...
from timeaxis.timeaxiscore import SECONDS_TO_MICROSECONDS_FACTOR, TimeAxis, RollingWindowTimeAxisBuilder, \
    WeeklyTimeAxisBuilder, MonthlyTimeAxisBuilder, TimeAxisBuilderFromDataTicks
...
class TestFixedIntervalTimeAxisBuilder(TestCase):
    ...
    def test_creation_01(self):
        ...
        ta = TimeAxis.builder("fixed_interval")\
            .set_start(start)\
            .set_end(end)\
...
class TestWeeklyTimeAxisBuilder(TestCase):
    ...
    def test_creation_01(self):
        ta = TimeAxis.builder("weekly_time_axis")\
            .set_start_date(date(2019, 1, 1))\
    ...
    def test_creation_02(self):
        ...
        # properly
        with self.assertRaises(ValueError):
            TimeAxis.builder("weekly_time_axis") \
                .set_start_date(date(2019, 1, 1)) \
                .set_end_date(date(2019, 1, 7)) \
                .build()
