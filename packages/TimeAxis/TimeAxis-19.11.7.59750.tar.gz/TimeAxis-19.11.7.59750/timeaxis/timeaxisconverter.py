...
from timeaxis.timeaxiscore import TimeAxis
...
class TimeAxisConverter:
    def __init__(self, **kwargs) -> None:
        if ("from_time_axis" in kwargs) and ("to_time_axis" in kwargs):
            ...
            if not (isinstance(from_ta, TimeAxis) and isinstance(to_ta, TimeAxis)):
    ...
    @staticmethod
    def _get_coverage_csr_matrix(from_ta: TimeAxis, to_ta: TimeAxis) -> csr_matrix:
