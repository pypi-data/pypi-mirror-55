...
_has_spyder3 = os_support.has_spyder3()
...
class NodeView(BaseNodeView):
    ...
    def _edit_node_requested(self):
        ...
        if settings.instance()['Gui/system_editor'] or not oss.has_spyder():
    ...
    def contextMenuEvent(self, event):
        ...
        if not _has_spyder3:
            ...
            self._debug_action.setText('Debug (Spyder 3 not installed)')
