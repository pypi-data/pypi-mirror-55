...
def send_stats():
    ...
    return (preferences.GeneralSettingsWidget.send_stats_label.replace(
        '\n', ' '),
            send_stats)
...
def setup(close_signal):
    ...
    if unconfigured_opts:
        ...
        if dialog.exec_() == QtWidgets.QDialog.Accepted:
            settings_['configured_version'] = Gui.version.version
            widget.save()
