...
session_temp_files_remove_unused = 'Remove unused files'

(session_temp_files_keep,
 session_temp_files_remove_flow,
 session_temp_files_remove_application) = session_temp_files_choice
...
class Properties:
    ...
    def sessions_folder(self):
        ...
        node_dict = {'parameters': {
            'temp_folder': {'type': 'string', 'value': temp_folder}}}
        node_dict = environment_variables.node_dict_copy_with_vars_substituted(
            node_dict)
        expanded_temp_folder = node_dict['parameters']['temp_folder']['value']
        return expanded_temp_folder
    ...
    def session_temp_files(self):
        res = self['session_temp_files']
        if res == session_temp_files_remove_unused:
            res = session_temp_files_remove_flow
        return res
...
permanent_defaults = {
    ...
    'session_temp_files': session_temp_files_remove_flow,
    'save_session': False,
    'session_files': [],
